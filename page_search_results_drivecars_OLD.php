...
if ( empty($driveBodyType))
{
    ...
    $rentCarResult = $db->query("SELECT * FROM pay_as_you_drive WHERE bodyTypeID  = ?s ", $driveBodyType);
}
            ...
            <div class="col-md-8-5 ">
                <div class="theme-search-results-item theme-search-results-item-">
                    <div class="theme-search-results-item-preview">
                        ...
                        <div class="row row-col-static" id="sticky-parent" data-gutter="20">
                            ...
                            <div class="col-md-6 ">
                                ...
                                <ul class="theme-search-results-item-car-list summary-txt">
                                    <li>
                                        <i class="fa fa-map-marker fa-lg loc-icons"></i> <?php echo getLocationFromID( $drivePickupLocation ); ?>
                                    </li>
                                    <br>
                                    <li>
                                        <i class="fa fa-calendar fa-lg loc-icons"></i> <?php echo date( 'F d, Y', strtotime( $drivePickupDate ) ); ?>
                                    </li>
                                    <br>
                                    <li>
                                        <i class="fa fa-clock-o fa-lg loc-icons"></i> <?php echo date( 'h:i A', strtotime( $drivePickupDate ) ); ?>
                                    </li>
                                    <br>
                            ...
                            <div class="col-md-6 ">
                                ...
                                <ul class="theme-search-results-item-car-list summary-txt">
                                    <li>
                                        <i class="fa fa-map-marker fa-lg loc-icons"></i> <?php echo getLocationFromID( $driveDropLocation ); ?>
                                    </li>
                                    <br>
                                    <li>
                                        <i class="fa fa-calendar fa-lg loc-icons"></i> <?php echo date( 'F d, Y', strtotime( $driveDropDate ) ); ?>
                                    </li>
                                    <br>
                                    <li>
                                        <i class="fa fa-clock-o fa-lg loc-icons"></i> <?php echo date( 'h:i A', strtotime( $driveDropDate ) ); ?>
                                    </li>
                                    <br>
                        ...
                        $startDateTimeStamp = strtotime( $drivePickupDate );
                        $endDateTimeStamp   = strtotime( $driveDropDate );
                ...
                <div class="theme-search-results">
                    <form name="rentcarsStep1" method="post" role="form" action="/book-pay-as-you-drive">
                        <input type="hidden" name="drivePickupLocation2" id="drivePickupLocation2" value="<?php echo $drivePickupLocation; ?>"/>
                        <input type="hidden" name="driveDropLocation2" id="driveDropLocation2" value="<?php echo $driveDropLocation; ?>"/>
                        <input type="hidden" name="drivePickupDate2" id="drivePickupDate2" value="<?php echo $drivePickupDate; ?>"/>
                        <input type="hidden" name="driveDropDate2" id="driveDropDate2" value="<?php echo $driveDropDate; ?>"/>
                        <input type="hidden" name="driveBodyType2" id="driveBodyType2" value="<?php echo $driveBodyType; ?>"/>
                        <input type="hidden" name="driveTotalDays2" id="driveTotalDays2" value="<?php echo $totalDays; ?>"/>
                        ...
                        <div class="_mob-h">
                            ...
                            <div class="theme-search-results-item theme-search-results-item-">
                                <div class="theme-search-results-item-preview products-grid" id="payAsYouDriveCarItemsContainer">
                                    ...
                                    //                                    $rentCarResult = $db->query( "SELECT * FROM pay_as_you_drive WHERE active = 1 $queryAppendcar ORDER BY payDriveCarID DESC limit 0,3" );

                                    //                                    $rentCarResult = $db->query( "SELECT * FROM pay_as_you_drive WHERE active = 1 $queryAppendcar ORDER BY payDriveCarID DESC");
                                    $rentCarResult = $db->query( "SELECT * FROM pay_as_you_drive WHERE active = 1 $queryAppendcar ORDER BY s1DailyAED ASC");
                                    $totalItems    = mysqli_num_rows( $rentCarResult );


                                    $rentCarResult = $db->query( "SELECT * FROM pay_as_you_drive WHERE active = 1 $queryAppendcar ORDER BY s1DailyAED ASC limit 0,?i", $itemsPerPage );
                                            ...
                                            <div class="col-md-5 ">
                                                ...
                                                <div class="theme-search-results-item-book">
                                                    <div class="theme-search-results-item-price">
                                                        ...
                                                        {
                                                            ?>
                                                            <button class="btn btn-primary-inverse btn-block theme-search-results-item-price-btn" name="btnBookWeekly" disabled>Book Weekly</button>
                                                            <?php
                                                        }
                                                        ?>
                                                    </div>
                                                ...
                                                <div class="theme-search-results-item-book">
                                                    <div class="theme-search-results-item-price">
                                                        ...
                                                        } else
                                                        {
                                                            ...
                                                            ?>
                                                            <button class="btn btn-primary-inverse btn-block theme-search-results-item-price-btn" disabled>Book Monthly</button>
                                                            <?php
                                                        }
...
<script>
    $(document).ready(function () {
        ...
        function loadMoreFromServer() {
            ...
            $.ajax({
                type: 'POST', url: 'fetchPayAsYouDrive.php',
                data: {
                    'start': start,
                    'limit': limit,
