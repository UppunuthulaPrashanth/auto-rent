                    ...
                    <div class="">
                        ...
                        <div class="theme-hero-text theme-hero-text-white">
                            ...
                            <div class="breadcrumb-margins">
                                ...
                                <h1 class="theme-hero-text-title _mb-20 theme-hero-text-title-sm">Pay as you Drive</h1>
...
<div class="theme-page-section theme-page-section-gray pay-as-you-drive">
...
WHERE pay_as_you_drive.active = 1 GROUP BY pay_as_you_drive.bodyTypeID" );
                                ...
                                <button class="modify-search-btn theme-search-area-submit _mt-0 _tt-uc theme-search-area-submit-curved theme-search-area-submit-sm theme-search-area-submit-white theme-search-area-submit-primary" id="btnDriveSearch" name="btnDriveSearch" type="submit">Modify Search</button>
