...
//    echo "SUCCESS|" ."Verified";
    if ($_SERVER['REQUEST_METHOD'] == 'POST')
    {
        ...
        $result = $db->query("INSERT INTO inb_corporate_solutions (fullName, companyName, email, phone, vehicleInterestedIn, noOfVehicles, vehicleCategory, specificRequirement)
        ...
        $notificationType = 9; // this is for solution Form
