    ...
    while ( $rentCarRow = mysqli_fetch_assoc( $rentCarResult ) )
    {
        ...
        <div class="row" data-gutter="20">
            ...
            <div class="col-md-5 ">
                ...
                <center>
                    <a style="margin-left: 82px" class="btn btn-primary-invert btn-shadow text-upcase" href="pay-as-you-drive-enquiry/<?php echo $rentCarRow['slug']?>">
                        Enquire Now
                    </a>
                </center>
            </div>
