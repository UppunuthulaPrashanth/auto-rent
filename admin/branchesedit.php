...
class cbranches_edit extends cbranches {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// locationID
			$this->locationID->SetDbValueDef($rsnew, $this->locationID->CurrentValue, NULL, $this->locationID->ReadOnly);
...
fbranchesedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fbranchesedit.Lists["x_locationID"] = {"LinkField":"x_locationID","Ajax":true,"AutoFill":false,"DisplayFields":["x_locationName","","",""],"ParentFields":[],"ChildFields":["x_regionID"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"mtr_locations"};
fbranchesedit.Lists["x_locationID"].Data = "<?php echo $branches_edit->locationID->LookupFilterQuery(FALSE, "edit") ?>";
fbranchesedit.Lists["x_regionID"] = {"LinkField":"x_regionID","Ajax":true,"AutoFill":false,"DisplayFields":["x_regionName","","",""],"ParentFields":["x_locationID"],"ChildFields":[],"FilterFields":["x_locationID"],"Options":[],"Template":"","LinkTable":"region"};
fbranchesedit.Lists["x_regionID"].Data = "<?php echo $branches_edit->regionID->LookupFilterQuery(FALSE, "edit") ?>";
fbranchesedit.Lists["x_active"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fbranchesedit.Lists["x_active"].Options = <?php echo json_encode($branches_edit->active->Options()) ?>;
...
<input type="hidden" name="modal" value="<?php echo intval($branches_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($branches->branchID->Visible) { // branchID ?>
	<div id="r_branchID" class="form-group">
		<label id="elh_branches_branchID" class="<?php echo $branches_edit->LeftColumnClass ?>"><?php echo $branches->branchID->FldCaption() ?></label>
...
<p class="form-control-static"><?php echo $branches->branchID->EditValue ?></p></span>
</span>
<input type="hidden" data-table="branches" data-field="x_branchID" name="x_branchID" id="x_branchID" value="<?php echo ew_HtmlEncode($branches->branchID->CurrentValue) ?>">
...
<?php if ($branches->locationID->Visible) { // locationID ?>
	<div id="r_locationID" class="form-group">
		<label id="elh_branches_locationID" for="x_locationID" class="<?php echo $branches_edit->LeftColumnClass ?>"><?php echo $branches->locationID->FldCaption() ?></label>
		<div class="<?php echo $branches_edit->RightColumnClass ?>"><div<?php echo $branches->locationID->CellAttributes() ?>>
...
<?php if ($branches->regionID->Visible) { // regionID ?>
	<div id="r_regionID" class="form-group">
		<label id="elh_branches_regionID" for="x_regionID" class="<?php echo $branches_edit->LeftColumnClass ?>"><?php echo $branches->regionID->FldCaption() ?></label>
		<div class="<?php echo $branches_edit->RightColumnClass ?>"><div<?php echo $branches->regionID->CellAttributes() ?>>
...
<?php if ($branches->branchName->Visible) { // branchName ?>
	<div id="r_branchName" class="form-group">
		<label id="elh_branches_branchName" for="x_branchName" class="<?php echo $branches_edit->LeftColumnClass ?>"><?php echo $branches->branchName->FldCaption() ?></label>
		<div class="<?php echo $branches_edit->RightColumnClass ?>"><div<?php echo $branches->branchName->CellAttributes() ?>>
...
<?php if ($branches->address->Visible) { // address ?>
	<div id="r_address" class="form-group">
		<label id="elh_branches_address" for="x_address" class="<?php echo $branches_edit->LeftColumnClass ?>"><?php echo $branches->address->FldCaption() ?></label>
		<div class="<?php echo $branches_edit->RightColumnClass ?>"><div<?php echo $branches->address->CellAttributes() ?>>
...
<?php if ($branches->phone->Visible) { // phone ?>
	<div id="r_phone" class="form-group">
		<label id="elh_branches_phone" for="x_phone" class="<?php echo $branches_edit->LeftColumnClass ?>"><?php echo $branches->phone->FldCaption() ?></label>
		<div class="<?php echo $branches_edit->RightColumnClass ?>"><div<?php echo $branches->phone->CellAttributes() ?>>
...
<?php if ($branches->fax->Visible) { // fax ?>
	<div id="r_fax" class="form-group">
		<label id="elh_branches_fax" for="x_fax" class="<?php echo $branches_edit->LeftColumnClass ?>"><?php echo $branches->fax->FldCaption() ?></label>
		<div class="<?php echo $branches_edit->RightColumnClass ?>"><div<?php echo $branches->fax->CellAttributes() ?>>
...
<?php if ($branches->_email->Visible) { // email ?>
	<div id="r__email" class="form-group">
		<label id="elh_branches__email" for="x__email" class="<?php echo $branches_edit->LeftColumnClass ?>"><?php echo $branches->_email->FldCaption() ?></label>
		<div class="<?php echo $branches_edit->RightColumnClass ?>"><div<?php echo $branches->_email->CellAttributes() ?>>
...
<?php if ($branches->map->Visible) { // map ?>
	<div id="r_map" class="form-group">
		<label id="elh_branches_map" for="x_map" class="<?php echo $branches_edit->LeftColumnClass ?>"><?php echo $branches->map->FldCaption() ?></label>
		<div class="<?php echo $branches_edit->RightColumnClass ?>"><div<?php echo $branches->map->CellAttributes() ?>>
...
<?php if ($branches->so->Visible) { // so ?>
	<div id="r_so" class="form-group">
		<label id="elh_branches_so" for="x_so" class="<?php echo $branches_edit->LeftColumnClass ?>"><?php echo $branches->so->FldCaption() ?></label>
		<div class="<?php echo $branches_edit->RightColumnClass ?>"><div<?php echo $branches->so->CellAttributes() ?>>
...
<?php if ($branches->active->Visible) { // active ?>
	<div id="r_active" class="form-group">
		<label id="elh_branches_active" for="x_active" class="<?php echo $branches_edit->LeftColumnClass ?>"><?php echo $branches->active->FldCaption() ?></label>
		<div class="<?php echo $branches_edit->RightColumnClass ?>"><div<?php echo $branches->active->CellAttributes() ?>>
