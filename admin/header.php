...
<?php } ?>
<link href="phpcss/phpcrossroads.css" rel="stylesheet" type="text/css">
...
<?php } ?>
<link rel="shortcut icon" type="image/x-icon" href="<?php echo $EW_RELATIVE_PATH ?>iconCrossroads.ico"><link rel="icon" type="image/x-icon" href="<?php echo $EW_RELATIVE_PATH ?>iconCrossroads.ico">
<meta name="generator" content="PHPMaker v2018.0.3">
</head>
...
<div class="wrapper ewLayout">
	...
	<header class="main-header">
		<div class="logo">
			...
			<span class="logo-lg"><img src="<?php echo $EW_RELATIVE_PATH ?>phpimages/logoCrossroads.png" alt=""></span>
		</div>
		<!-- Header Navbar -->
