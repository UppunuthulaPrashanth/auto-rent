...
$inb_corporate_solutions_edit = NULL; // Initialize page object first

class cinb_corporate_solutions_edit extends cinb_corporate_solutions {
	...
	// Page object name
	var $PageObjName = 'inb_corporate_solutions_edit';
...
// Create page object
if (!isset($inb_corporate_solutions_edit)) $inb_corporate_solutions_edit = new cinb_corporate_solutions_edit();

// Page init
$inb_corporate_solutions_edit->Page_Init();

// Page main
$inb_corporate_solutions_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$inb_corporate_solutions_edit->Page_Render();
?>
...
var CurrentForm = finb_corporate_solutionsedit = new ew_Form("finb_corporate_solutionsedit", "edit");

// Validate form
finb_corporate_solutionsedit.Validate = function() {
...
finb_corporate_solutionsedit.Form_CustomValidate = 
...
finb_corporate_solutionsedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
finb_corporate_solutionsedit.Lists["x_vehicleCategory[]"] = {"LinkField":"x_bodyTypeID","Ajax":true,"AutoFill":false,"DisplayFields":["x_bodytype","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"mtr_bodytype"};
finb_corporate_solutionsedit.Lists["x_vehicleCategory[]"].Data = "<?php echo $inb_corporate_solutions_edit->vehicleCategory->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php $inb_corporate_solutions_edit->ShowPageHeader(); ?>
<?php
$inb_corporate_solutions_edit->ShowMessage();
?>
<form name="finb_corporate_solutionsedit" id="finb_corporate_solutionsedit" class="<?php echo $inb_corporate_solutions_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($inb_corporate_solutions_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $inb_corporate_solutions_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="inb_corporate_solutions">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($inb_corporate_solutions_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($inb_corporate_solutions->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_inb_corporate_solutions_id" class="<?php echo $inb_corporate_solutions_edit->LeftColumnClass ?>"><?php echo $inb_corporate_solutions->id->FldCaption() ?></label>
		<div class="<?php echo $inb_corporate_solutions_edit->RightColumnClass ?>"><div<?php echo $inb_corporate_solutions->id->CellAttributes() ?>>
<span id="el_inb_corporate_solutions_id">
<span<?php echo $inb_corporate_solutions->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $inb_corporate_solutions->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="inb_corporate_solutions" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($inb_corporate_solutions->id->CurrentValue) ?>">
<?php echo $inb_corporate_solutions->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($inb_corporate_solutions->fullname->Visible) { // fullname ?>
	<div id="r_fullname" class="form-group">
		<label id="elh_inb_corporate_solutions_fullname" for="x_fullname" class="<?php echo $inb_corporate_solutions_edit->LeftColumnClass ?>"><?php echo $inb_corporate_solutions->fullname->FldCaption() ?></label>
		<div class="<?php echo $inb_corporate_solutions_edit->RightColumnClass ?>"><div<?php echo $inb_corporate_solutions->fullname->CellAttributes() ?>>
...
<?php if ($inb_corporate_solutions->companyName->Visible) { // companyName ?>
	<div id="r_companyName" class="form-group">
		<label id="elh_inb_corporate_solutions_companyName" for="x_companyName" class="<?php echo $inb_corporate_solutions_edit->LeftColumnClass ?>"><?php echo $inb_corporate_solutions->companyName->FldCaption() ?></label>
		<div class="<?php echo $inb_corporate_solutions_edit->RightColumnClass ?>"><div<?php echo $inb_corporate_solutions->companyName->CellAttributes() ?>>
...
<?php if ($inb_corporate_solutions->_email->Visible) { // email ?>
	<div id="r__email" class="form-group">
		<label id="elh_inb_corporate_solutions__email" for="x__email" class="<?php echo $inb_corporate_solutions_edit->LeftColumnClass ?>"><?php echo $inb_corporate_solutions->_email->FldCaption() ?></label>
		<div class="<?php echo $inb_corporate_solutions_edit->RightColumnClass ?>"><div<?php echo $inb_corporate_solutions->_email->CellAttributes() ?>>
...
<?php if ($inb_corporate_solutions->phone->Visible) { // phone ?>
	<div id="r_phone" class="form-group">
		<label id="elh_inb_corporate_solutions_phone" for="x_phone" class="<?php echo $inb_corporate_solutions_edit->LeftColumnClass ?>"><?php echo $inb_corporate_solutions->phone->FldCaption() ?></label>
		<div class="<?php echo $inb_corporate_solutions_edit->RightColumnClass ?>"><div<?php echo $inb_corporate_solutions->phone->CellAttributes() ?>>
...
<?php if ($inb_corporate_solutions->vehicleInterestedIn->Visible) { // vehicleInterestedIn ?>
	<div id="r_vehicleInterestedIn" class="form-group">
		<label id="elh_inb_corporate_solutions_vehicleInterestedIn" for="x_vehicleInterestedIn" class="<?php echo $inb_corporate_solutions_edit->LeftColumnClass ?>"><?php echo $inb_corporate_solutions->vehicleInterestedIn->FldCaption() ?></label>
		<div class="<?php echo $inb_corporate_solutions_edit->RightColumnClass ?>"><div<?php echo $inb_corporate_solutions->vehicleInterestedIn->CellAttributes() ?>>
...
<?php if ($inb_corporate_solutions->noOfVehicles->Visible) { // noOfVehicles ?>
	<div id="r_noOfVehicles" class="form-group">
		<label id="elh_inb_corporate_solutions_noOfVehicles" for="x_noOfVehicles" class="<?php echo $inb_corporate_solutions_edit->LeftColumnClass ?>"><?php echo $inb_corporate_solutions->noOfVehicles->FldCaption() ?></label>
		<div class="<?php echo $inb_corporate_solutions_edit->RightColumnClass ?>"><div<?php echo $inb_corporate_solutions->noOfVehicles->CellAttributes() ?>>
...
<?php if ($inb_corporate_solutions->vehicleCategory->Visible) { // vehicleCategory ?>
	<div id="r_vehicleCategory" class="form-group">
		<label id="elh_inb_corporate_solutions_vehicleCategory" class="<?php echo $inb_corporate_solutions_edit->LeftColumnClass ?>"><?php echo $inb_corporate_solutions->vehicleCategory->FldCaption() ?></label>
		<div class="<?php echo $inb_corporate_solutions_edit->RightColumnClass ?>"><div<?php echo $inb_corporate_solutions->vehicleCategory->CellAttributes() ?>>
...
<?php if ($inb_corporate_solutions->specificRequirement->Visible) { // specificRequirement ?>
	<div id="r_specificRequirement" class="form-group">
		<label id="elh_inb_corporate_solutions_specificRequirement" class="<?php echo $inb_corporate_solutions_edit->LeftColumnClass ?>"><?php echo $inb_corporate_solutions->specificRequirement->FldCaption() ?></label>
		<div class="<?php echo $inb_corporate_solutions_edit->RightColumnClass ?>"><div<?php echo $inb_corporate_solutions->specificRequirement->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateEditor("finb_corporate_solutionsedit", "x_specificRequirement", 35, 4, <?php echo ($inb_corporate_solutions->specificRequirement->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php if ($inb_corporate_solutions->dateCreated->Visible) { // dateCreated ?>
	<div id="r_dateCreated" class="form-group">
		<label id="elh_inb_corporate_solutions_dateCreated" for="x_dateCreated" class="<?php echo $inb_corporate_solutions_edit->LeftColumnClass ?>"><?php echo $inb_corporate_solutions->dateCreated->FldCaption() ?></label>
		<div class="<?php echo $inb_corporate_solutions_edit->RightColumnClass ?>"><div<?php echo $inb_corporate_solutions->dateCreated->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("finb_corporate_solutionsedit", "x_dateCreated", {"ignoreReadonly":true,"useCurrent":false,"format":7});
</script>
<?php } ?>
</span>
...
<?php if (!$inb_corporate_solutions_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $inb_corporate_solutions_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $inb_corporate_solutions_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
finb_corporate_solutionsedit.Init();
</script>
<?php
$inb_corporate_solutions_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$inb_corporate_solutions_edit->Page_Terminate();
?>
