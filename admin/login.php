...
class clogin extends ccms_users {
	...
	function __construct() {
		...
		if (!isset($GLOBALS["cms_users"])) $GLOBALS["cms_users"] = &$this;
	...
	function User_LoggingIn($usr, &$pwd) {
		echo "<script>console.log('Login function called')</script>";
...
<p class="login-box-msg"><?php echo $Language->Phrase("Login") ?></p>
	<div class="form-group">
		<input type="text" value="a" name="type" hidden id="typ">
