...
class cnews_edit extends cnews {
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			...
			// Load key from Form
			if ($objForm->HasValue("x_newsID")) {
				$this->newsID->setFormValue($objForm->GetValue("x_newsID"));
			}
		} else {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// postDate
			$this->postDate->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->postDate->CurrentValue, 7), NULL, $this->postDate->ReadOnly);
...
// Multi-Page
fnewsedit.MultiPage = new ew_MultiPage("fnewsedit");

// Dynamic selection lists
fnewsedit.Lists["x_active"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fnewsedit.Lists["x_active"].Options = <?php echo json_encode($news_edit->active->Options()) ?>;
...
<div class="nav-tabs-custom" id="news_edit"><!-- multi-page .nav-tabs-custom -->
	<ul class="nav<?php echo $news_edit->MultiPages->NavStyle() ?>">
		<li<?php echo $news_edit->MultiPages->TabStyle("1") ?>><a href="#tab_news1" data-toggle="tab"><?php echo $news->PageCaption(1) ?></a></li>
		<li<?php echo $news_edit->MultiPages->TabStyle("2") ?>><a href="#tab_news2" data-toggle="tab"><?php echo $news->PageCaption(2) ?></a></li>
		<li<?php echo $news_edit->MultiPages->TabStyle("3") ?>><a href="#tab_news3" data-toggle="tab"><?php echo $news->PageCaption(3) ?></a></li>
	</ul>
	<div class="tab-content"><!-- multi-page .nav-tabs-custom .tab-content -->
		<div class="tab-pane<?php echo $news_edit->MultiPages->PageStyle("1") ?>" id="tab_news1"><!-- multi-page .tab-pane -->
<div class="ewEditDiv"><!-- page* -->
<?php if ($news->newsID->Visible) { // newsID ?>
	<div id="r_newsID" class="form-group">
		<label id="elh_news_newsID" class="<?php echo $news_edit->LeftColumnClass ?>"><?php echo $news->newsID->FldCaption() ?></label>
...
<p class="form-control-static"><?php echo $news->newsID->EditValue ?></p></span>
</span>
<input type="hidden" data-table="news" data-field="x_newsID" data-page="1" name="x_newsID" id="x_newsID" value="<?php echo ew_HtmlEncode($news->newsID->CurrentValue) ?>">
<?php echo $news->newsID->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($news->title->Visible) { // title ?>
	<div id="r_title" class="form-group">
		<label id="elh_news_title" for="x_title" class="<?php echo $news_edit->LeftColumnClass ?>"><?php echo $news->title->FldCaption() ?></label>
...
<?php if ($news->slug->Visible) { // slug ?>
	<div id="r_slug" class="form-group">
		<label id="elh_news_slug" for="x_slug" class="<?php echo $news_edit->LeftColumnClass ?>"><?php echo $news->slug->FldCaption() ?></label>
		<div class="<?php echo $news_edit->RightColumnClass ?>"><div<?php echo $news->slug->CellAttributes() ?>>
...
<?php if ($news->summary->Visible) { // summary ?>
	<div id="r_summary" class="form-group">
		<label id="elh_news_summary" for="x_summary" class="<?php echo $news_edit->LeftColumnClass ?>"><?php echo $news->summary->FldCaption() ?></label>
		<div class="<?php echo $news_edit->RightColumnClass ?>"><div<?php echo $news->summary->CellAttributes() ?>>
...
<?php if ($news->postDate->Visible) { // postDate ?>
	<div id="r_postDate" class="form-group">
		<label id="elh_news_postDate" for="x_postDate" class="<?php echo $news_edit->LeftColumnClass ?>"><?php echo $news->postDate->FldCaption() ?></label>
		<div class="<?php echo $news_edit->RightColumnClass ?>"><div<?php echo $news->postDate->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fnewsedit", "x_postDate", {"ignoreReadonly":true,"useCurrent":false,"format":7});
</script>
<?php } ?>
</span>
...
<?php if ($news->active->Visible) { // active ?>
	<div id="r_active" class="form-group">
		<label id="elh_news_active" for="x_active" class="<?php echo $news_edit->LeftColumnClass ?>"><?php echo $news->active->FldCaption() ?></label>
		<div class="<?php echo $news_edit->RightColumnClass ?>"><div<?php echo $news->active->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $news_edit->MultiPages->PageStyle("2") ?>" id="tab_news2"><!-- multi-page .tab-pane -->
<div class="ewEditDiv"><!-- page* -->
<?php if ($news->_thumbnail->Visible) { // thumbnail ?>
	<div id="r__thumbnail" class="form-group">
		<label id="elh_news__thumbnail" class="<?php echo $news_edit->LeftColumnClass ?>"><?php echo $news->_thumbnail->FldCaption() ?></label>
...
<?php if ($news->largeImage->Visible) { // largeImage ?>
	<div id="r_largeImage" class="form-group">
		<label id="elh_news_largeImage" class="<?php echo $news_edit->LeftColumnClass ?>"><?php echo $news->largeImage->FldCaption() ?></label>
		<div class="<?php echo $news_edit->RightColumnClass ?>"><div<?php echo $news->largeImage->CellAttributes() ?>>
...
<?php if ($news->homeImage->Visible) { // homeImage ?>
	<div id="r_homeImage" class="form-group">
		<label id="elh_news_homeImage" class="<?php echo $news_edit->LeftColumnClass ?>"><?php echo $news->homeImage->FldCaption() ?></label>
		<div class="<?php echo $news_edit->RightColumnClass ?>"><div<?php echo $news->homeImage->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $news_edit->MultiPages->PageStyle("3") ?>" id="tab_news3"><!-- multi-page .tab-pane -->
<div class="ewEditDiv"><!-- page* -->
<?php if ($news->description->Visible) { // description ?>
	<div id="r_description" class="form-group">
		<label id="elh_news_description" class="<?php echo $news_edit->LeftColumnClass ?>"><?php echo $news->description->FldCaption() ?></label>
...
<script type="text/javascript">
ew_CreateEditor("fnewsedit", "x_description", 35, 4, <?php echo ($news->description->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
