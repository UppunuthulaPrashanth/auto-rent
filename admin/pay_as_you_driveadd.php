...
$pay_as_you_drive_add = NULL; // Initialize page object first

class cpay_as_you_drive_add extends cpay_as_you_drive {
	...
	// Page object name
	var $PageObjName = 'pay_as_you_drive_add';
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["payDriveCarID"] != "") {
				...
				$this->setKey("payDriveCarID", $this->payDriveCarID->CurrentValue); // Set up key
			} else {
				$this->setKey("payDriveCarID", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "pay_as_you_driveview.php")
	...
	function LoadDefaultValues() {
		...
		$this->s1DailyAED->CurrentValue = NULL;
		$this->s1DailyAED->OldValue = $this->s1DailyAED->CurrentValue;
		$this->s1DailyKM->CurrentValue = NULL;
		$this->s1DailyKM->OldValue = $this->s1DailyKM->CurrentValue;
		$this->s2DailyAED->CurrentValue = NULL;
		$this->s2DailyAED->OldValue = $this->s2DailyAED->CurrentValue;
		$this->s2DailyKM->CurrentValue = NULL;
		$this->s2DailyKM->OldValue = $this->s2DailyKM->CurrentValue;
		$this->s3DailyAED->CurrentValue = NULL;
		$this->s3DailyAED->OldValue = $this->s3DailyAED->CurrentValue;
		$this->s3DailyKM->CurrentValue = NULL;
		$this->s3DailyKM->OldValue = $this->s3DailyKM->CurrentValue;
		$this->s4DailyAED->CurrentValue = NULL;
		$this->s4DailyAED->OldValue = $this->s4DailyAED->CurrentValue;
		$this->s4DailyKM->CurrentValue = NULL;
		$this->s4DailyKM->OldValue = $this->s4DailyKM->CurrentValue;
		$this->s5DailyAED->CurrentValue = NULL;
		$this->s5DailyAED->OldValue = $this->s5DailyAED->CurrentValue;
		$this->s5DailyKM->CurrentValue = NULL;
		$this->s5DailyKM->OldValue = $this->s5DailyKM->CurrentValue;
		$this->s1WeeklyAED->CurrentValue = NULL;
		$this->s1WeeklyAED->OldValue = $this->s1WeeklyAED->CurrentValue;
		$this->s1WeeklyKM->CurrentValue = NULL;
		$this->s1WeeklyKM->OldValue = $this->s1WeeklyKM->CurrentValue;
		$this->s2WeeklyAED->CurrentValue = NULL;
		$this->s2WeeklyAED->OldValue = $this->s2WeeklyAED->CurrentValue;
		$this->s2WeeklyKM->CurrentValue = NULL;
		$this->s2WeeklyKM->OldValue = $this->s2WeeklyKM->CurrentValue;
		$this->s3WeeklyAED->CurrentValue = NULL;
		$this->s3WeeklyAED->OldValue = $this->s3WeeklyAED->CurrentValue;
		$this->s3WeeklyKM->CurrentValue = NULL;
		$this->s3WeeklyKM->OldValue = $this->s3WeeklyKM->CurrentValue;
		$this->s4WeeklyAED->CurrentValue = NULL;
		$this->s4WeeklyAED->OldValue = $this->s4WeeklyAED->CurrentValue;
		$this->s4WeeklyKM->CurrentValue = NULL;
		$this->s4WeeklyKM->OldValue = $this->s4WeeklyKM->CurrentValue;
		$this->s5WeeklyAED->CurrentValue = NULL;
		$this->s5WeeklyAED->OldValue = $this->s5WeeklyAED->CurrentValue;
		$this->s5WeeklyKM->CurrentValue = NULL;
		$this->s5WeeklyKM->OldValue = $this->s5WeeklyKM->CurrentValue;
		$this->s1MonthlyAED->CurrentValue = NULL;
		$this->s1MonthlyAED->OldValue = $this->s1MonthlyAED->CurrentValue;
		$this->s1MonthlyKM->CurrentValue = NULL;
		$this->s1MonthlyKM->OldValue = $this->s1MonthlyKM->CurrentValue;
		$this->s2MonthlyAED->CurrentValue = NULL;
		$this->s2MonthlyAED->OldValue = $this->s2MonthlyAED->CurrentValue;
		$this->s2MonthlyKM->CurrentValue = NULL;
		$this->s2MonthlyKM->OldValue = $this->s2MonthlyKM->CurrentValue;
		$this->s3MonthlyAED->CurrentValue = NULL;
		$this->s3MonthlyAED->OldValue = $this->s3MonthlyAED->CurrentValue;
		$this->s3MonthlyKM->CurrentValue = NULL;
		$this->s3MonthlyKM->OldValue = $this->s3MonthlyKM->CurrentValue;
		$this->s4MonthlyAED->CurrentValue = NULL;
		$this->s4MonthlyAED->OldValue = $this->s4MonthlyAED->CurrentValue;
		$this->s4MonthlyKM->CurrentValue = NULL;
		$this->s4MonthlyKM->OldValue = $this->s4MonthlyKM->CurrentValue;
		$this->s5MonthlyAED->CurrentValue = NULL;
		$this->s5MonthlyAED->OldValue = $this->s5MonthlyAED->CurrentValue;
		$this->s5MonthlyKM->CurrentValue = NULL;
		$this->s5MonthlyKM->OldValue = $this->s5MonthlyKM->CurrentValue;
		...
		$this->addon01KM->CurrentValue = NULL;
		$this->addon01KM->OldValue = $this->addon01KM->CurrentValue;
		$this->addon01Price->CurrentValue = NULL;
		$this->addon01Price->OldValue = $this->addon01Price->CurrentValue;
		$this->addon02KM->CurrentValue = NULL;
		$this->addon02KM->OldValue = $this->addon02KM->CurrentValue;
		$this->addon02Price->CurrentValue = NULL;
		$this->addon02Price->OldValue = $this->addon02Price->CurrentValue;
		$this->addon03KM->CurrentValue = NULL;
		$this->addon03KM->OldValue = $this->addon03KM->CurrentValue;
		$this->addon03Price->CurrentValue = NULL;
		$this->addon03Price->OldValue = $this->addon03Price->CurrentValue;
		$this->addon04KM->CurrentValue = NULL;
		$this->addon04KM->OldValue = $this->addon04KM->CurrentValue;
		$this->addon04Price->CurrentValue = NULL;
		$this->addon04Price->OldValue = $this->addon04Price->CurrentValue;
		$this->addon05KM->CurrentValue = NULL;
		$this->addon05KM->OldValue = $this->addon05KM->CurrentValue;
		$this->addon05Price->CurrentValue = NULL;
		$this->addon05Price->OldValue = $this->addon05Price->CurrentValue;
	}
	...
	function NewRow() {
		...
		$row['s1DailyAED'] = $this->s1DailyAED->CurrentValue;
		$row['s1DailyKM'] = $this->s1DailyKM->CurrentValue;
		$row['s2DailyAED'] = $this->s2DailyAED->CurrentValue;
		$row['s2DailyKM'] = $this->s2DailyKM->CurrentValue;
		$row['s3DailyAED'] = $this->s3DailyAED->CurrentValue;
		$row['s3DailyKM'] = $this->s3DailyKM->CurrentValue;
		$row['s4DailyAED'] = $this->s4DailyAED->CurrentValue;
		$row['s4DailyKM'] = $this->s4DailyKM->CurrentValue;
		$row['s5DailyAED'] = $this->s5DailyAED->CurrentValue;
		$row['s5DailyKM'] = $this->s5DailyKM->CurrentValue;
		$row['s1WeeklyAED'] = $this->s1WeeklyAED->CurrentValue;
		$row['s1WeeklyKM'] = $this->s1WeeklyKM->CurrentValue;
		$row['s2WeeklyAED'] = $this->s2WeeklyAED->CurrentValue;
		$row['s2WeeklyKM'] = $this->s2WeeklyKM->CurrentValue;
		$row['s3WeeklyAED'] = $this->s3WeeklyAED->CurrentValue;
		$row['s3WeeklyKM'] = $this->s3WeeklyKM->CurrentValue;
		$row['s4WeeklyAED'] = $this->s4WeeklyAED->CurrentValue;
		$row['s4WeeklyKM'] = $this->s4WeeklyKM->CurrentValue;
		$row['s5WeeklyAED'] = $this->s5WeeklyAED->CurrentValue;
		$row['s5WeeklyKM'] = $this->s5WeeklyKM->CurrentValue;
		$row['s1MonthlyAED'] = $this->s1MonthlyAED->CurrentValue;
		$row['s1MonthlyKM'] = $this->s1MonthlyKM->CurrentValue;
		$row['s2MonthlyAED'] = $this->s2MonthlyAED->CurrentValue;
		$row['s2MonthlyKM'] = $this->s2MonthlyKM->CurrentValue;
		$row['s3MonthlyAED'] = $this->s3MonthlyAED->CurrentValue;
		$row['s3MonthlyKM'] = $this->s3MonthlyKM->CurrentValue;
		$row['s4MonthlyAED'] = $this->s4MonthlyAED->CurrentValue;
		$row['s4MonthlyKM'] = $this->s4MonthlyKM->CurrentValue;
		$row['s5MonthlyAED'] = $this->s5MonthlyAED->CurrentValue;
		$row['s5MonthlyKM'] = $this->s5MonthlyKM->CurrentValue;
		...
		$row['addon01KM'] = $this->addon01KM->CurrentValue;
		$row['addon01Price'] = $this->addon01Price->CurrentValue;
		$row['addon02KM'] = $this->addon02KM->CurrentValue;
		$row['addon02Price'] = $this->addon02Price->CurrentValue;
		$row['addon03KM'] = $this->addon03KM->CurrentValue;
		$row['addon03Price'] = $this->addon03Price->CurrentValue;
		$row['addon04KM'] = $this->addon04KM->CurrentValue;
		$row['addon04Price'] = $this->addon04Price->CurrentValue;
		$row['addon05KM'] = $this->addon05KM->CurrentValue;
		$row['addon05Price'] = $this->addon05Price->CurrentValue;
		return $row;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// s1DailyAED
		$this->s1DailyAED->SetDbValueDef($rsnew, $this->s1DailyAED->CurrentValue, NULL, FALSE);

		// s1DailyKM
		$this->s1DailyKM->SetDbValueDef($rsnew, $this->s1DailyKM->CurrentValue, NULL, FALSE);

		// s2DailyAED
		$this->s2DailyAED->SetDbValueDef($rsnew, $this->s2DailyAED->CurrentValue, NULL, FALSE);

		// s2DailyKM
		$this->s2DailyKM->SetDbValueDef($rsnew, $this->s2DailyKM->CurrentValue, NULL, FALSE);

		// s3DailyAED
		$this->s3DailyAED->SetDbValueDef($rsnew, $this->s3DailyAED->CurrentValue, NULL, FALSE);

		// s3DailyKM
		$this->s3DailyKM->SetDbValueDef($rsnew, $this->s3DailyKM->CurrentValue, NULL, FALSE);

		// s4DailyAED
		$this->s4DailyAED->SetDbValueDef($rsnew, $this->s4DailyAED->CurrentValue, NULL, FALSE);

		// s4DailyKM
		$this->s4DailyKM->SetDbValueDef($rsnew, $this->s4DailyKM->CurrentValue, NULL, FALSE);

		// s5DailyAED
		$this->s5DailyAED->SetDbValueDef($rsnew, $this->s5DailyAED->CurrentValue, NULL, FALSE);

		// s5DailyKM
		$this->s5DailyKM->SetDbValueDef($rsnew, $this->s5DailyKM->CurrentValue, NULL, FALSE);

		// s1WeeklyAED
		$this->s1WeeklyAED->SetDbValueDef($rsnew, $this->s1WeeklyAED->CurrentValue, NULL, FALSE);

		// s1WeeklyKM
		$this->s1WeeklyKM->SetDbValueDef($rsnew, $this->s1WeeklyKM->CurrentValue, NULL, FALSE);

		// s2WeeklyAED
		$this->s2WeeklyAED->SetDbValueDef($rsnew, $this->s2WeeklyAED->CurrentValue, NULL, FALSE);

		// s2WeeklyKM
		$this->s2WeeklyKM->SetDbValueDef($rsnew, $this->s2WeeklyKM->CurrentValue, NULL, FALSE);

		// s3WeeklyAED
		$this->s3WeeklyAED->SetDbValueDef($rsnew, $this->s3WeeklyAED->CurrentValue, NULL, FALSE);

		// s3WeeklyKM
		$this->s3WeeklyKM->SetDbValueDef($rsnew, $this->s3WeeklyKM->CurrentValue, NULL, FALSE);

		// s4WeeklyAED
		$this->s4WeeklyAED->SetDbValueDef($rsnew, $this->s4WeeklyAED->CurrentValue, NULL, FALSE);

		// s4WeeklyKM
		$this->s4WeeklyKM->SetDbValueDef($rsnew, $this->s4WeeklyKM->CurrentValue, NULL, FALSE);

		// s5WeeklyAED
		$this->s5WeeklyAED->SetDbValueDef($rsnew, $this->s5WeeklyAED->CurrentValue, NULL, FALSE);

		// s5WeeklyKM
		$this->s5WeeklyKM->SetDbValueDef($rsnew, $this->s5WeeklyKM->CurrentValue, NULL, FALSE);

		// s1MonthlyAED
		$this->s1MonthlyAED->SetDbValueDef($rsnew, $this->s1MonthlyAED->CurrentValue, NULL, FALSE);

		// s1MonthlyKM
		$this->s1MonthlyKM->SetDbValueDef($rsnew, $this->s1MonthlyKM->CurrentValue, NULL, FALSE);

		// s2MonthlyAED
		$this->s2MonthlyAED->SetDbValueDef($rsnew, $this->s2MonthlyAED->CurrentValue, NULL, FALSE);

		// s2MonthlyKM
		$this->s2MonthlyKM->SetDbValueDef($rsnew, $this->s2MonthlyKM->CurrentValue, NULL, FALSE);

		// s3MonthlyAED
		$this->s3MonthlyAED->SetDbValueDef($rsnew, $this->s3MonthlyAED->CurrentValue, NULL, FALSE);

		// s3MonthlyKM
		$this->s3MonthlyKM->SetDbValueDef($rsnew, $this->s3MonthlyKM->CurrentValue, NULL, FALSE);

		// s4MonthlyAED
		$this->s4MonthlyAED->SetDbValueDef($rsnew, $this->s4MonthlyAED->CurrentValue, NULL, FALSE);

		// s4MonthlyKM
		$this->s4MonthlyKM->SetDbValueDef($rsnew, $this->s4MonthlyKM->CurrentValue, NULL, FALSE);

		// s5MonthlyAED
		$this->s5MonthlyAED->SetDbValueDef($rsnew, $this->s5MonthlyAED->CurrentValue, NULL, FALSE);

		// s5MonthlyKM
		$this->s5MonthlyKM->SetDbValueDef($rsnew, $this->s5MonthlyKM->CurrentValue, NULL, FALSE);
		...
		// addon01KM
		$this->addon01KM->SetDbValueDef($rsnew, $this->addon01KM->CurrentValue, NULL, FALSE);

		// addon01Price
		$this->addon01Price->SetDbValueDef($rsnew, $this->addon01Price->CurrentValue, NULL, FALSE);

		// addon02KM
		$this->addon02KM->SetDbValueDef($rsnew, $this->addon02KM->CurrentValue, NULL, FALSE);

		// addon02Price
		$this->addon02Price->SetDbValueDef($rsnew, $this->addon02Price->CurrentValue, NULL, FALSE);

		// addon03KM
		$this->addon03KM->SetDbValueDef($rsnew, $this->addon03KM->CurrentValue, NULL, FALSE);

		// addon03Price
		$this->addon03Price->SetDbValueDef($rsnew, $this->addon03Price->CurrentValue, NULL, FALSE);

		// addon04KM
		$this->addon04KM->SetDbValueDef($rsnew, $this->addon04KM->CurrentValue, NULL, FALSE);

		// addon04Price
		$this->addon04Price->SetDbValueDef($rsnew, $this->addon04Price->CurrentValue, NULL, FALSE);

		// addon05KM
		$this->addon05KM->SetDbValueDef($rsnew, $this->addon05KM->CurrentValue, NULL, FALSE);

		// addon05Price
		$this->addon05Price->SetDbValueDef($rsnew, $this->addon05Price->CurrentValue, NULL, FALSE);
		if ($this->image->Visible && !$this->image->Upload->KeepFile) {
			$this->image->UploadPath = 'uploads/rentlease';
...
// Create page object
if (!isset($pay_as_you_drive_add)) $pay_as_you_drive_add = new cpay_as_you_drive_add();

// Page init
$pay_as_you_drive_add->Page_Init();

// Page main
$pay_as_you_drive_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$pay_as_you_drive_add->Page_Render();
?>
...
var CurrentForm = fpay_as_you_driveadd = new ew_Form("fpay_as_you_driveadd", "add");

// Validate form
fpay_as_you_driveadd.Validate = function() {
...
fpay_as_you_driveadd.Form_CustomValidate = 
...
fpay_as_you_driveadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Multi-Page
fpay_as_you_driveadd.MultiPage = new ew_MultiPage("fpay_as_you_driveadd");

// Dynamic selection lists
fpay_as_you_driveadd.Lists["x_bodyTypeID"] = {"LinkField":"x_bodyTypeID","Ajax":true,"AutoFill":false,"DisplayFields":["x_bodytype","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"mtr_bodytype"};
fpay_as_you_driveadd.Lists["x_bodyTypeID"].Data = "<?php echo $pay_as_you_drive_add->bodyTypeID->LookupFilterQuery(FALSE, "add") ?>";
fpay_as_you_driveadd.Lists["x_extraFeatures[]"] = {"LinkField":"x_featureID","Ajax":true,"AutoFill":false,"DisplayFields":["x_extraFeatures","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"mtr_extra_features"};
fpay_as_you_driveadd.Lists["x_extraFeatures[]"].Data = "<?php echo $pay_as_you_drive_add->extraFeatures->LookupFilterQuery(FALSE, "add") ?>";
fpay_as_you_driveadd.Lists["x_transmissionID"] = {"LinkField":"x_transmissionID","Ajax":true,"AutoFill":false,"DisplayFields":["x_transmission","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"mtr_transmission"};
fpay_as_you_driveadd.Lists["x_transmissionID"].Data = "<?php echo $pay_as_you_drive_add->transmissionID->LookupFilterQuery(FALSE, "add") ?>";
fpay_as_you_driveadd.Lists["x_ac[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fpay_as_you_driveadd.Lists["x_ac[]"].Options = <?php echo json_encode($pay_as_you_drive_add->ac->Options()) ?>;
fpay_as_you_driveadd.Lists["x_active"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fpay_as_you_driveadd.Lists["x_active"].Options = <?php echo json_encode($pay_as_you_drive_add->active->Options()) ?>;
...
<?php $pay_as_you_drive_add->ShowPageHeader(); ?>
<?php
$pay_as_you_drive_add->ShowMessage();
?>
<form name="fpay_as_you_driveadd" id="fpay_as_you_driveadd" class="<?php echo $pay_as_you_drive_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($pay_as_you_drive_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $pay_as_you_drive_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="pay_as_you_drive">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($pay_as_you_drive_add->IsModal) ?>">
<div class="ewMultiPage"><!-- multi-page -->
<div class="nav-tabs-custom" id="pay_as_you_drive_add"><!-- multi-page .nav-tabs-custom -->
	<ul class="nav<?php echo $pay_as_you_drive_add->MultiPages->NavStyle() ?>">
		<li<?php echo $pay_as_you_drive_add->MultiPages->TabStyle("1") ?>><a href="#tab_pay_as_you_drive1" data-toggle="tab"><?php echo $pay_as_you_drive->PageCaption(1) ?></a></li>
		<li<?php echo $pay_as_you_drive_add->MultiPages->TabStyle("2") ?>><a href="#tab_pay_as_you_drive2" data-toggle="tab"><?php echo $pay_as_you_drive->PageCaption(2) ?></a></li>
		<li<?php echo $pay_as_you_drive_add->MultiPages->TabStyle("3") ?>><a href="#tab_pay_as_you_drive3" data-toggle="tab"><?php echo $pay_as_you_drive->PageCaption(3) ?></a></li>
		<li<?php echo $pay_as_you_drive_add->MultiPages->TabStyle("4") ?>><a href="#tab_pay_as_you_drive4" data-toggle="tab"><?php echo $pay_as_you_drive->PageCaption(4) ?></a></li>
		<li<?php echo $pay_as_you_drive_add->MultiPages->TabStyle("5") ?>><a href="#tab_pay_as_you_drive5" data-toggle="tab"><?php echo $pay_as_you_drive->PageCaption(5) ?></a></li>
		<li<?php echo $pay_as_you_drive_add->MultiPages->TabStyle("6") ?>><a href="#tab_pay_as_you_drive6" data-toggle="tab"><?php echo $pay_as_you_drive->PageCaption(6) ?></a></li>
	</ul>
	<div class="tab-content"><!-- multi-page .nav-tabs-custom .tab-content -->
		<div class="tab-pane<?php echo $pay_as_you_drive_add->MultiPages->PageStyle("1") ?>" id="tab_pay_as_you_drive1"><!-- multi-page .tab-pane -->
<div class="ewAddDiv"><!-- page* -->
<?php if ($pay_as_you_drive->bodyTypeID->Visible) { // bodyTypeID ?>
	<div id="r_bodyTypeID" class="form-group">
		<label id="elh_pay_as_you_drive_bodyTypeID" for="x_bodyTypeID" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->bodyTypeID->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->bodyTypeID->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->carTitle->Visible) { // carTitle ?>
	<div id="r_carTitle" class="form-group">
		<label id="elh_pay_as_you_drive_carTitle" for="x_carTitle" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->carTitle->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->carTitle->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->slug->Visible) { // slug ?>
	<div id="r_slug" class="form-group">
		<label id="elh_pay_as_you_drive_slug" for="x_slug" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->slug->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->slug->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->image->Visible) { // image ?>
	<div id="r_image" class="form-group">
		<label id="elh_pay_as_you_drive_image" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->image->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->image->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->extraFeatures->Visible) { // extraFeatures ?>
	<div id="r_extraFeatures" class="form-group">
		<label id="elh_pay_as_you_drive_extraFeatures" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->extraFeatures->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->extraFeatures->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->noOfSeats->Visible) { // noOfSeats ?>
	<div id="r_noOfSeats" class="form-group">
		<label id="elh_pay_as_you_drive_noOfSeats" for="x_noOfSeats" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->noOfSeats->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->noOfSeats->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->luggage->Visible) { // luggage ?>
	<div id="r_luggage" class="form-group">
		<label id="elh_pay_as_you_drive_luggage" for="x_luggage" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->luggage->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->luggage->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->transmissionID->Visible) { // transmissionID ?>
	<div id="r_transmissionID" class="form-group">
		<label id="elh_pay_as_you_drive_transmissionID" for="x_transmissionID" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->transmissionID->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->transmissionID->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->ac->Visible) { // ac ?>
	<div id="r_ac" class="form-group">
		<label id="elh_pay_as_you_drive_ac" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->ac->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->ac->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->noOfDoors->Visible) { // noOfDoors ?>
	<div id="r_noOfDoors" class="form-group">
		<label id="elh_pay_as_you_drive_noOfDoors" for="x_noOfDoors" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->noOfDoors->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->noOfDoors->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->active->Visible) { // active ?>
	<div id="r_active" class="form-group">
		<label id="elh_pay_as_you_drive_active" for="x_active" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->active->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->active->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $pay_as_you_drive_add->MultiPages->PageStyle("2") ?>" id="tab_pay_as_you_drive2"><!-- multi-page .tab-pane -->
<div class="ewAddDiv"><!-- page* -->
<?php if ($pay_as_you_drive->s1DailyAED->Visible) { // s1DailyAED ?>
	<div id="r_s1DailyAED" class="form-group">
		<label id="elh_pay_as_you_drive_s1DailyAED" for="x_s1DailyAED" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->s1DailyAED->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->s1DailyAED->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->s1DailyKM->Visible) { // s1DailyKM ?>
	<div id="r_s1DailyKM" class="form-group">
		<label id="elh_pay_as_you_drive_s1DailyKM" for="x_s1DailyKM" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->s1DailyKM->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->s1DailyKM->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->s2DailyAED->Visible) { // s2DailyAED ?>
	<div id="r_s2DailyAED" class="form-group">
		<label id="elh_pay_as_you_drive_s2DailyAED" for="x_s2DailyAED" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->s2DailyAED->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->s2DailyAED->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->s2DailyKM->Visible) { // s2DailyKM ?>
	<div id="r_s2DailyKM" class="form-group">
		<label id="elh_pay_as_you_drive_s2DailyKM" for="x_s2DailyKM" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->s2DailyKM->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->s2DailyKM->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->s3DailyAED->Visible) { // s3DailyAED ?>
	<div id="r_s3DailyAED" class="form-group">
		<label id="elh_pay_as_you_drive_s3DailyAED" for="x_s3DailyAED" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->s3DailyAED->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->s3DailyAED->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->s3DailyKM->Visible) { // s3DailyKM ?>
	<div id="r_s3DailyKM" class="form-group">
		<label id="elh_pay_as_you_drive_s3DailyKM" for="x_s3DailyKM" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->s3DailyKM->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->s3DailyKM->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->s4DailyAED->Visible) { // s4DailyAED ?>
	<div id="r_s4DailyAED" class="form-group">
		<label id="elh_pay_as_you_drive_s4DailyAED" for="x_s4DailyAED" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->s4DailyAED->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->s4DailyAED->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->s4DailyKM->Visible) { // s4DailyKM ?>
	<div id="r_s4DailyKM" class="form-group">
		<label id="elh_pay_as_you_drive_s4DailyKM" for="x_s4DailyKM" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->s4DailyKM->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->s4DailyKM->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->s5DailyAED->Visible) { // s5DailyAED ?>
	<div id="r_s5DailyAED" class="form-group">
		<label id="elh_pay_as_you_drive_s5DailyAED" for="x_s5DailyAED" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->s5DailyAED->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->s5DailyAED->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->s5DailyKM->Visible) { // s5DailyKM ?>
	<div id="r_s5DailyKM" class="form-group">
		<label id="elh_pay_as_you_drive_s5DailyKM" for="x_s5DailyKM" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->s5DailyKM->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->s5DailyKM->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $pay_as_you_drive_add->MultiPages->PageStyle("3") ?>" id="tab_pay_as_you_drive3"><!-- multi-page .tab-pane -->
<div class="ewAddDiv"><!-- page* -->
<?php if ($pay_as_you_drive->s1WeeklyAED->Visible) { // s1WeeklyAED ?>
	<div id="r_s1WeeklyAED" class="form-group">
		<label id="elh_pay_as_you_drive_s1WeeklyAED" for="x_s1WeeklyAED" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->s1WeeklyAED->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->s1WeeklyAED->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->s1WeeklyKM->Visible) { // s1WeeklyKM ?>
	<div id="r_s1WeeklyKM" class="form-group">
		<label id="elh_pay_as_you_drive_s1WeeklyKM" for="x_s1WeeklyKM" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->s1WeeklyKM->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->s1WeeklyKM->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->s2WeeklyAED->Visible) { // s2WeeklyAED ?>
	<div id="r_s2WeeklyAED" class="form-group">
		<label id="elh_pay_as_you_drive_s2WeeklyAED" for="x_s2WeeklyAED" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->s2WeeklyAED->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->s2WeeklyAED->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->s2WeeklyKM->Visible) { // s2WeeklyKM ?>
	<div id="r_s2WeeklyKM" class="form-group">
		<label id="elh_pay_as_you_drive_s2WeeklyKM" for="x_s2WeeklyKM" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->s2WeeklyKM->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->s2WeeklyKM->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->s3WeeklyAED->Visible) { // s3WeeklyAED ?>
	<div id="r_s3WeeklyAED" class="form-group">
		<label id="elh_pay_as_you_drive_s3WeeklyAED" for="x_s3WeeklyAED" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->s3WeeklyAED->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->s3WeeklyAED->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->s3WeeklyKM->Visible) { // s3WeeklyKM ?>
	<div id="r_s3WeeklyKM" class="form-group">
		<label id="elh_pay_as_you_drive_s3WeeklyKM" for="x_s3WeeklyKM" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->s3WeeklyKM->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->s3WeeklyKM->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->s4WeeklyAED->Visible) { // s4WeeklyAED ?>
	<div id="r_s4WeeklyAED" class="form-group">
		<label id="elh_pay_as_you_drive_s4WeeklyAED" for="x_s4WeeklyAED" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->s4WeeklyAED->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->s4WeeklyAED->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->s4WeeklyKM->Visible) { // s4WeeklyKM ?>
	<div id="r_s4WeeklyKM" class="form-group">
		<label id="elh_pay_as_you_drive_s4WeeklyKM" for="x_s4WeeklyKM" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->s4WeeklyKM->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->s4WeeklyKM->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->s5WeeklyAED->Visible) { // s5WeeklyAED ?>
	<div id="r_s5WeeklyAED" class="form-group">
		<label id="elh_pay_as_you_drive_s5WeeklyAED" for="x_s5WeeklyAED" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->s5WeeklyAED->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->s5WeeklyAED->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->s5WeeklyKM->Visible) { // s5WeeklyKM ?>
	<div id="r_s5WeeklyKM" class="form-group">
		<label id="elh_pay_as_you_drive_s5WeeklyKM" for="x_s5WeeklyKM" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->s5WeeklyKM->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->s5WeeklyKM->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $pay_as_you_drive_add->MultiPages->PageStyle("4") ?>" id="tab_pay_as_you_drive4"><!-- multi-page .tab-pane -->
<div class="ewAddDiv"><!-- page* -->
<?php if ($pay_as_you_drive->s1MonthlyAED->Visible) { // s1MonthlyAED ?>
	<div id="r_s1MonthlyAED" class="form-group">
		<label id="elh_pay_as_you_drive_s1MonthlyAED" for="x_s1MonthlyAED" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->s1MonthlyAED->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->s1MonthlyAED->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->s1MonthlyKM->Visible) { // s1MonthlyKM ?>
	<div id="r_s1MonthlyKM" class="form-group">
		<label id="elh_pay_as_you_drive_s1MonthlyKM" for="x_s1MonthlyKM" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->s1MonthlyKM->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->s1MonthlyKM->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->s2MonthlyAED->Visible) { // s2MonthlyAED ?>
	<div id="r_s2MonthlyAED" class="form-group">
		<label id="elh_pay_as_you_drive_s2MonthlyAED" for="x_s2MonthlyAED" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->s2MonthlyAED->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->s2MonthlyAED->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->s2MonthlyKM->Visible) { // s2MonthlyKM ?>
	<div id="r_s2MonthlyKM" class="form-group">
		<label id="elh_pay_as_you_drive_s2MonthlyKM" for="x_s2MonthlyKM" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->s2MonthlyKM->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->s2MonthlyKM->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->s3MonthlyAED->Visible) { // s3MonthlyAED ?>
	<div id="r_s3MonthlyAED" class="form-group">
		<label id="elh_pay_as_you_drive_s3MonthlyAED" for="x_s3MonthlyAED" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->s3MonthlyAED->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->s3MonthlyAED->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->s3MonthlyKM->Visible) { // s3MonthlyKM ?>
	<div id="r_s3MonthlyKM" class="form-group">
		<label id="elh_pay_as_you_drive_s3MonthlyKM" for="x_s3MonthlyKM" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->s3MonthlyKM->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->s3MonthlyKM->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->s4MonthlyAED->Visible) { // s4MonthlyAED ?>
	<div id="r_s4MonthlyAED" class="form-group">
		<label id="elh_pay_as_you_drive_s4MonthlyAED" for="x_s4MonthlyAED" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->s4MonthlyAED->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->s4MonthlyAED->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->s4MonthlyKM->Visible) { // s4MonthlyKM ?>
	<div id="r_s4MonthlyKM" class="form-group">
		<label id="elh_pay_as_you_drive_s4MonthlyKM" for="x_s4MonthlyKM" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->s4MonthlyKM->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->s4MonthlyKM->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->s5MonthlyAED->Visible) { // s5MonthlyAED ?>
	<div id="r_s5MonthlyAED" class="form-group">
		<label id="elh_pay_as_you_drive_s5MonthlyAED" for="x_s5MonthlyAED" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->s5MonthlyAED->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->s5MonthlyAED->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->s5MonthlyKM->Visible) { // s5MonthlyKM ?>
	<div id="r_s5MonthlyKM" class="form-group">
		<label id="elh_pay_as_you_drive_s5MonthlyKM" for="x_s5MonthlyKM" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->s5MonthlyKM->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->s5MonthlyKM->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $pay_as_you_drive_add->MultiPages->PageStyle("5") ?>" id="tab_pay_as_you_drive5"><!-- multi-page .tab-pane -->
<div class="ewAddDiv"><!-- page* -->
<?php if ($pay_as_you_drive->phase1OrangeCard->Visible) { // phase1OrangeCard ?>
	<div id="r_phase1OrangeCard" class="form-group">
		<label id="elh_pay_as_you_drive_phase1OrangeCard" for="x_phase1OrangeCard" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->phase1OrangeCard->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->phase1OrangeCard->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->phase1GPS->Visible) { // phase1GPS ?>
	<div id="r_phase1GPS" class="form-group">
		<label id="elh_pay_as_you_drive_phase1GPS" for="x_phase1GPS" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->phase1GPS->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->phase1GPS->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->phase1DeliveryCharges->Visible) { // phase1DeliveryCharges ?>
	<div id="r_phase1DeliveryCharges" class="form-group">
		<label id="elh_pay_as_you_drive_phase1DeliveryCharges" for="x_phase1DeliveryCharges" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->phase1DeliveryCharges->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->phase1DeliveryCharges->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->phase1CollectionCharges->Visible) { // phase1CollectionCharges ?>
	<div id="r_phase1CollectionCharges" class="form-group">
		<label id="elh_pay_as_you_drive_phase1CollectionCharges" for="x_phase1CollectionCharges" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->phase1CollectionCharges->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->phase1CollectionCharges->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $pay_as_you_drive_add->MultiPages->PageStyle("6") ?>" id="tab_pay_as_you_drive6"><!-- multi-page .tab-pane -->
<div class="ewAddDiv"><!-- page* -->
<?php if ($pay_as_you_drive->addon01KM->Visible) { // addon01KM ?>
	<div id="r_addon01KM" class="form-group">
		<label id="elh_pay_as_you_drive_addon01KM" for="x_addon01KM" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->addon01KM->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->addon01KM->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->addon01Price->Visible) { // addon01Price ?>
	<div id="r_addon01Price" class="form-group">
		<label id="elh_pay_as_you_drive_addon01Price" for="x_addon01Price" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->addon01Price->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->addon01Price->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->addon02KM->Visible) { // addon02KM ?>
	<div id="r_addon02KM" class="form-group">
		<label id="elh_pay_as_you_drive_addon02KM" for="x_addon02KM" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->addon02KM->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->addon02KM->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->addon02Price->Visible) { // addon02Price ?>
	<div id="r_addon02Price" class="form-group">
		<label id="elh_pay_as_you_drive_addon02Price" for="x_addon02Price" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->addon02Price->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->addon02Price->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->addon03KM->Visible) { // addon03KM ?>
	<div id="r_addon03KM" class="form-group">
		<label id="elh_pay_as_you_drive_addon03KM" for="x_addon03KM" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->addon03KM->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->addon03KM->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->addon03Price->Visible) { // addon03Price ?>
	<div id="r_addon03Price" class="form-group">
		<label id="elh_pay_as_you_drive_addon03Price" for="x_addon03Price" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->addon03Price->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->addon03Price->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->addon04KM->Visible) { // addon04KM ?>
	<div id="r_addon04KM" class="form-group">
		<label id="elh_pay_as_you_drive_addon04KM" for="x_addon04KM" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->addon04KM->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->addon04KM->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->addon04Price->Visible) { // addon04Price ?>
	<div id="r_addon04Price" class="form-group">
		<label id="elh_pay_as_you_drive_addon04Price" for="x_addon04Price" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->addon04Price->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->addon04Price->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->addon05KM->Visible) { // addon05KM ?>
	<div id="r_addon05KM" class="form-group">
		<label id="elh_pay_as_you_drive_addon05KM" for="x_addon05KM" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->addon05KM->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->addon05KM->CellAttributes() ?>>
...
<?php if ($pay_as_you_drive->addon05Price->Visible) { // addon05Price ?>
	<div id="r_addon05Price" class="form-group">
		<label id="elh_pay_as_you_drive_addon05Price" for="x_addon05Price" class="<?php echo $pay_as_you_drive_add->LeftColumnClass ?>"><?php echo $pay_as_you_drive->addon05Price->FldCaption() ?></label>
		<div class="<?php echo $pay_as_you_drive_add->RightColumnClass ?>"><div<?php echo $pay_as_you_drive->addon05Price->CellAttributes() ?>>
...
<?php if (!$pay_as_you_drive_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $pay_as_you_drive_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $pay_as_you_drive_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fpay_as_you_driveadd.Init();
</script>
<?php
$pay_as_you_drive_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$pay_as_you_drive_add->Page_Terminate();
?>
