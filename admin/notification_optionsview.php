...
$notification_options_view = NULL; // Initialize page object first

class cnotification_options_view extends cnotification_options {
	...
	// Page object name
	var $PageObjName = 'notification_options_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "notification_optionslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "notification_optionslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "notification_optionslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($notification_options_view)) $notification_options_view = new cnotification_options_view();

// Page init
$notification_options_view->Page_Init();

// Page main
$notification_options_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$notification_options_view->Page_Render();
?>
...
var CurrentForm = fnotification_optionsview = new ew_Form("fnotification_optionsview", "view");

// Form_CustomValidate event
fnotification_optionsview.Form_CustomValidate = 
...
fnotification_optionsview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php if ($notification_options->Export == "") { ?>
<div class="ewToolbar">
<?php $notification_options_view->ExportOptions->Render("body") ?>
<?php
	foreach ($notification_options_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php } ?>
<?php $notification_options_view->ShowPageHeader(); ?>
<?php
$notification_options_view->ShowMessage();
?>
<form name="fnotification_optionsview" id="fnotification_optionsview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($notification_options_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $notification_options_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="notification_options">
<input type="hidden" name="modal" value="<?php echo intval($notification_options_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($notification_options->id->Visible) { // id ?>
	<tr id="r_id">
		<td class="col-sm-2"><span id="elh_notification_options_id"><?php echo $notification_options->id->FldCaption() ?></span></td>
...
<?php echo $notification_options->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($notification_options->notificationType->Visible) { // notificationType ?>
	<tr id="r_notificationType">
		<td class="col-sm-2"><span id="elh_notification_options_notificationType"><?php echo $notification_options->notificationType->FldCaption() ?></span></td>
...
<?php echo $notification_options->notificationType->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($notification_options->emailOutboundName->Visible) { // emailOutboundName ?>
	<tr id="r_emailOutboundName">
		<td class="col-sm-2"><span id="elh_notification_options_emailOutboundName"><?php echo $notification_options->emailOutboundName->FldCaption() ?></span></td>
...
<?php echo $notification_options->emailOutboundName->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($notification_options->emailOutbound->Visible) { // emailOutbound ?>
	<tr id="r_emailOutbound">
		<td class="col-sm-2"><span id="elh_notification_options_emailOutbound"><?php echo $notification_options->emailOutbound->FldCaption() ?></span></td>
...
<?php echo $notification_options->emailOutbound->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($notification_options->autorespondSubject->Visible) { // autorespondSubject ?>
	<tr id="r_autorespondSubject">
		<td class="col-sm-2"><span id="elh_notification_options_autorespondSubject"><?php echo $notification_options->autorespondSubject->FldCaption() ?></span></td>
...
<?php echo $notification_options->autorespondSubject->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($notification_options->autorespondMessage->Visible) { // autorespondMessage ?>
	<tr id="r_autorespondMessage">
		<td class="col-sm-2"><span id="elh_notification_options_autorespondMessage"><?php echo $notification_options->autorespondMessage->FldCaption() ?></span></td>
		<td data-name="autorespondMessage"<?php echo $notification_options->autorespondMessage->CellAttributes() ?>>
<span id="el_notification_options_autorespondMessage">
<span<?php echo $notification_options->autorespondMessage->ViewAttributes() ?>>
<?php echo $notification_options->autorespondMessage->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($notification_options->int_notificationSubject->Visible) { // int_notificationSubject ?>
	<tr id="r_int_notificationSubject">
		<td class="col-sm-2"><span id="elh_notification_options_int_notificationSubject"><?php echo $notification_options->int_notificationSubject->FldCaption() ?></span></td>
...
<?php echo $notification_options->int_notificationSubject->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($notification_options->int_notificationMessage->Visible) { // int_notificationMessage ?>
	<tr id="r_int_notificationMessage">
		<td class="col-sm-2"><span id="elh_notification_options_int_notificationMessage"><?php echo $notification_options->int_notificationMessage->FldCaption() ?></span></td>
		<td data-name="int_notificationMessage"<?php echo $notification_options->int_notificationMessage->CellAttributes() ?>>
<span id="el_notification_options_int_notificationMessage">
<span<?php echo $notification_options->int_notificationMessage->ViewAttributes() ?>>
<?php echo $notification_options->int_notificationMessage->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($notification_options->resultPageMessage->Visible) { // resultPageMessage ?>
	<tr id="r_resultPageMessage">
		<td class="col-sm-2"><span id="elh_notification_options_resultPageMessage"><?php echo $notification_options->resultPageMessage->FldCaption() ?></span></td>
		<td data-name="resultPageMessage"<?php echo $notification_options->resultPageMessage->CellAttributes() ?>>
<span id="el_notification_options_resultPageMessage">
<span<?php echo $notification_options->resultPageMessage->ViewAttributes() ?>>
<?php echo $notification_options->resultPageMessage->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($notification_options->Export == "") { ?>
<script type="text/javascript">
fnotification_optionsview.Init();
</script>
<?php } ?>
<?php
$notification_options_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($notification_options->Export == "") { ?>
...
<?php
$notification_options_view->Page_Terminate();
?>
