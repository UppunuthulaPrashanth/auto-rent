...
$mtr_model_add = NULL; // Initialize page object first

class cmtr_model_add extends cmtr_model {
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["modelID"] != "") {
				...
				$this->setKey("modelID", $this->modelID->CurrentValue); // Set up key
			} else {
				$this->setKey("modelID", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "mtr_modelview.php")
...
// Create page object
if (!isset($mtr_model_add)) $mtr_model_add = new cmtr_model_add();

// Page init
$mtr_model_add->Page_Init();

// Page main
$mtr_model_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$mtr_model_add->Page_Render();
?>
...
var CurrentForm = fmtr_modeladd = new ew_Form("fmtr_modeladd", "add");

// Validate form
fmtr_modeladd.Validate = function() {
...
fmtr_modeladd.Form_CustomValidate = 
...
fmtr_modeladd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fmtr_modeladd.Lists["x_makeID"] = {"LinkField":"x_makeID","Ajax":true,"AutoFill":false,"DisplayFields":["x_make","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"mtr_make"};
fmtr_modeladd.Lists["x_makeID"].Data = "<?php echo $mtr_model_add->makeID->LookupFilterQuery(FALSE, "add") ?>";
fmtr_modeladd.Lists["x_bodyTypeID"] = {"LinkField":"x_bodyTypeID","Ajax":true,"AutoFill":false,"DisplayFields":["x_bodytype","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"mtr_bodytype"};
fmtr_modeladd.Lists["x_bodyTypeID"].Data = "<?php echo $mtr_model_add->bodyTypeID->LookupFilterQuery(FALSE, "add") ?>";
fmtr_modeladd.Lists["x_active"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmtr_modeladd.Lists["x_active"].Options = <?php echo json_encode($mtr_model_add->active->Options()) ?>;
...
<?php $mtr_model_add->ShowPageHeader(); ?>
<?php
$mtr_model_add->ShowMessage();
?>
<form name="fmtr_modeladd" id="fmtr_modeladd" class="<?php echo $mtr_model_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($mtr_model_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $mtr_model_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="mtr_model">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($mtr_model_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($mtr_model->makeID->Visible) { // makeID ?>
	<div id="r_makeID" class="form-group">
		<label id="elh_mtr_model_makeID" for="x_makeID" class="<?php echo $mtr_model_add->LeftColumnClass ?>"><?php echo $mtr_model->makeID->FldCaption() ?></label>
		<div class="<?php echo $mtr_model_add->RightColumnClass ?>"><div<?php echo $mtr_model->makeID->CellAttributes() ?>>
...
<?php if ($mtr_model->bodyTypeID->Visible) { // bodyTypeID ?>
	<div id="r_bodyTypeID" class="form-group">
		<label id="elh_mtr_model_bodyTypeID" for="x_bodyTypeID" class="<?php echo $mtr_model_add->LeftColumnClass ?>"><?php echo $mtr_model->bodyTypeID->FldCaption() ?></label>
		<div class="<?php echo $mtr_model_add->RightColumnClass ?>"><div<?php echo $mtr_model->bodyTypeID->CellAttributes() ?>>
...
<?php if ($mtr_model->model->Visible) { // model ?>
	<div id="r_model" class="form-group">
		<label id="elh_mtr_model_model" for="x_model" class="<?php echo $mtr_model_add->LeftColumnClass ?>"><?php echo $mtr_model->model->FldCaption() ?></label>
		<div class="<?php echo $mtr_model_add->RightColumnClass ?>"><div<?php echo $mtr_model->model->CellAttributes() ?>>
...
<?php if ($mtr_model->so->Visible) { // so ?>
	<div id="r_so" class="form-group">
		<label id="elh_mtr_model_so" for="x_so" class="<?php echo $mtr_model_add->LeftColumnClass ?>"><?php echo $mtr_model->so->FldCaption() ?></label>
		<div class="<?php echo $mtr_model_add->RightColumnClass ?>"><div<?php echo $mtr_model->so->CellAttributes() ?>>
...
<?php if ($mtr_model->active->Visible) { // active ?>
	<div id="r_active" class="form-group">
		<label id="elh_mtr_model_active" for="x_active" class="<?php echo $mtr_model_add->LeftColumnClass ?>"><?php echo $mtr_model->active->FldCaption() ?></label>
		<div class="<?php echo $mtr_model_add->RightColumnClass ?>"><div<?php echo $mtr_model->active->CellAttributes() ?>>
...
<?php if (!$mtr_model_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $mtr_model_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $mtr_model_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
