...
$inb_leasecars_enquiry = NULL;

//
// Table class for inb_leasecars_enquiry
//
class cinb_leasecars_enquiry extends cTable {
	var $id;
	var $selectedType;
	var $vehicleID;
	...
	function __construct() {
		...
		$this->TableVar = 'inb_leasecars_enquiry';
		$this->TableName = 'inb_leasecars_enquiry';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`inb_leasecars_enquiry`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('inb_leasecars_enquiry', 'inb_leasecars_enquiry', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// selectedType
		$this->selectedType = new cField('inb_leasecars_enquiry', 'inb_leasecars_enquiry', 'x_selectedType', 'selectedType', '`selectedType`', '`selectedType`', 200, -1, FALSE, '`selectedType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->selectedType->Sortable = TRUE; // Allow sort
		$this->fields['selectedType'] = &$this->selectedType;

		// vehicleID
		$this->vehicleID = new cField('inb_leasecars_enquiry', 'inb_leasecars_enquiry', 'x_vehicleID', 'vehicleID', '`vehicleID`', '`vehicleID`', 200, -1, FALSE, '`vehicleID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->vehicleID->Sortable = TRUE; // Allow sort
		$this->fields['vehicleID'] = &$this->vehicleID;

		// individualFirstName
		$this->individualFirstName = new cField('inb_leasecars_enquiry', 'inb_leasecars_enquiry', 'x_individualFirstName', 'individualFirstName', '`individualFirstName`', '`individualFirstName`', 200, -1, FALSE, '`individualFirstName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->individualFirstName->Sortable = TRUE; // Allow sort
		$this->fields['individualFirstName'] = &$this->individualFirstName;

		// corporateCompanyName
		$this->corporateCompanyName = new cField('inb_leasecars_enquiry', 'inb_leasecars_enquiry', 'x_corporateCompanyName', 'corporateCompanyName', '`corporateCompanyName`', '`corporateCompanyName`', 200, -1, FALSE, '`corporateCompanyName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->corporateCompanyName->Sortable = TRUE; // Allow sort
		$this->fields['corporateCompanyName'] = &$this->corporateCompanyName;

		// corporateFullName
		$this->corporateFullName = new cField('inb_leasecars_enquiry', 'inb_leasecars_enquiry', 'x_corporateFullName', 'corporateFullName', '`corporateFullName`', '`corporateFullName`', 200, -1, FALSE, '`corporateFullName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->corporateFullName->Sortable = TRUE; // Allow sort
		$this->fields['corporateFullName'] = &$this->corporateFullName;

		// individualLastName
		$this->individualLastName = new cField('inb_leasecars_enquiry', 'inb_leasecars_enquiry', 'x_individualLastName', 'individualLastName', '`individualLastName`', '`individualLastName`', 200, -1, FALSE, '`individualLastName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->corporateNoOfVehicle = new cField('inb_leasecars_enquiry', 'inb_leasecars_enquiry', 'x_corporateNoOfVehicle', 'corporateNoOfVehicle', '`corporateNoOfVehicle`', '`corporateNoOfVehicle`', 200, -1, FALSE, '`corporateNoOfVehicle`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->corporateNoOfVehicle->Sortable = TRUE; // Allow sort
		$this->fields['corporateNoOfVehicle'] = &$this->corporateNoOfVehicle;

		// email
		$this->_email = new cField('inb_leasecars_enquiry', 'inb_leasecars_enquiry', 'x__email', 'email', '`email`', '`email`', 200, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_email->Sortable = TRUE; // Allow sort
		$this->fields['email'] = &$this->_email;

		// phone
		$this->phone = new cField('inb_leasecars_enquiry', 'inb_leasecars_enquiry', 'x_phone', 'phone', '`phone`', '`phone`', 200, -1, FALSE, '`phone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->phone->Sortable = TRUE; // Allow sort
		$this->fields['phone'] = &$this->phone;

		// country
		$this->country = new cField('inb_leasecars_enquiry', 'inb_leasecars_enquiry', 'x_country', 'country', '`country`', '`country`', 200, -1, FALSE, '`country`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->country->Sortable = TRUE; // Allow sort
		$this->fields['country'] = &$this->country;

		// city
		$this->city = new cField('inb_leasecars_enquiry', 'inb_leasecars_enquiry', 'x_city', 'city', '`city`', '`city`', 200, -1, FALSE, '`city`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->city->Sortable = TRUE; // Allow sort
		$this->fields['city'] = &$this->city;

		// individualSpecificRequirement
		$this->individualSpecificRequirement = new cField('inb_leasecars_enquiry', 'inb_leasecars_enquiry', 'x_individualSpecificRequirement', 'individualSpecificRequirement', '`individualSpecificRequirement`', '`individualSpecificRequirement`', 201, -1, FALSE, '`individualSpecificRequirement`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		...
		$this->corporateSpecificRequirement = new cField('inb_leasecars_enquiry', 'inb_leasecars_enquiry', 'x_corporateSpecificRequirement', 'corporateSpecificRequirement', '`corporateSpecificRequirement`', '`corporateSpecificRequirement`', 201, -1, FALSE, '`corporateSpecificRequirement`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		...
		// dateCreated
		$this->dateCreated = new cField('inb_leasecars_enquiry', 'inb_leasecars_enquiry', 'x_dateCreated', 'dateCreated', '`dateCreated`', ew_CastDateFieldForLike('`dateCreated`', 7, "DB"), 135, 7, FALSE, '`dateCreated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`inb_leasecars_enquiry`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "inb_leasecars_enquirylist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "inb_leasecars_enquiryedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "inb_leasecars_enquiryadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("inb_leasecars_enquiryview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("inb_leasecars_enquiryview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "inb_leasecars_enquiryadd.php?" . $this->UrlParm($parm);
		else
			$url = "inb_leasecars_enquiryadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("inb_leasecars_enquiryedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("inb_leasecars_enquiryadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("inb_leasecars_enquirydelete.php", $this->UrlParm());
	}
	...
	function LoadListRowValues(&$rs) {
		...
		$this->vehicleID->setDbValue($rs->fields('vehicleID'));
	...
	function RenderEditRow() {
		...
		$this->vehicleID->EditValue = $this->vehicleID->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->vehicleID->Exportable) $Doc->ExportCaption($this->vehicleID);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->vehicleID->Exportable) $Doc->ExportField($this->vehicleID);
