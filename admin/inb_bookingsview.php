...
$inb_bookings_view = NULL; // Initialize page object first

class cinb_bookings_view extends cinb_bookings {
	...
	// Page object name
	var $PageObjName = 'inb_bookings_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["bookingID"] <> "") {
				...
				$sReturnUrl = "inb_bookingslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "inb_bookingslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "inb_bookingslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($inb_bookings_view)) $inb_bookings_view = new cinb_bookings_view();

// Page init
$inb_bookings_view->Page_Init();

// Page main
$inb_bookings_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$inb_bookings_view->Page_Render();
?>
...
var CurrentForm = finb_bookingsview = new ew_Form("finb_bookingsview", "view");

// Form_CustomValidate event
finb_bookingsview.Form_CustomValidate = 
...
finb_bookingsview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Multi-Page
finb_bookingsview.MultiPage = new ew_MultiPage("finb_bookingsview");

// Dynamic selection lists
finb_bookingsview.Lists["x__userID"] = {"LinkField":"x__userID","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstName","x_lastName","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
finb_bookingsview.Lists["x__userID"].Data = "<?php echo $inb_bookings_view->_userID->LookupFilterQuery(FALSE, "view") ?>";
finb_bookingsview.Lists["x_rentLeaseCarID"] = {"LinkField":"x_rentLeaseCarID","Ajax":true,"AutoFill":false,"DisplayFields":["x_carTitle","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"rent_lease_cars"};
finb_bookingsview.Lists["x_rentLeaseCarID"].Data = "<?php echo $inb_bookings_view->rentLeaseCarID->LookupFilterQuery(FALSE, "view") ?>";
finb_bookingsview.Lists["x_pickUpLocation"] = {"LinkField":"x_pdLocationID","Ajax":true,"AutoFill":false,"DisplayFields":["x_location","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"pickup_drop_locations"};
finb_bookingsview.Lists["x_pickUpLocation"].Data = "<?php echo $inb_bookings_view->pickUpLocation->LookupFilterQuery(FALSE, "view") ?>";
finb_bookingsview.Lists["x_dropLocation"] = {"LinkField":"x_pdLocationID","Ajax":true,"AutoFill":false,"DisplayFields":["x_location","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"pickup_drop_locations"};
finb_bookingsview.Lists["x_dropLocation"].Data = "<?php echo $inb_bookings_view->dropLocation->LookupFilterQuery(FALSE, "view") ?>";
finb_bookingsview.Lists["x_paymentMethod"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
finb_bookingsview.Lists["x_paymentMethod"].Options = <?php echo json_encode($inb_bookings_view->paymentMethod->Options()) ?>;
...
<?php if ($inb_bookings->Export == "") { ?>
<div class="ewToolbar">
<?php $inb_bookings_view->ExportOptions->Render("body") ?>
<?php
	foreach ($inb_bookings_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php } ?>
<?php $inb_bookings_view->ShowPageHeader(); ?>
<?php
$inb_bookings_view->ShowMessage();
?>
<form name="finb_bookingsview" id="finb_bookingsview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($inb_bookings_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $inb_bookings_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="inb_bookings">
<input type="hidden" name="modal" value="<?php echo intval($inb_bookings_view->IsModal) ?>">
<?php if ($inb_bookings->Export == "") { ?>
<div class="ewMultiPage">
<div class="nav-tabs-custom" id="inb_bookings_view">
	<ul class="nav<?php echo $inb_bookings_view->MultiPages->NavStyle() ?>">
		<li<?php echo $inb_bookings_view->MultiPages->TabStyle("1") ?>><a href="#tab_inb_bookings1" data-toggle="tab"><?php echo $inb_bookings->PageCaption(1) ?></a></li>
		<li<?php echo $inb_bookings_view->MultiPages->TabStyle("2") ?>><a href="#tab_inb_bookings2" data-toggle="tab"><?php echo $inb_bookings->PageCaption(2) ?></a></li>
	</ul>
	<div class="tab-content">
<?php } ?>
<?php if ($inb_bookings->Export == "") { ?>
		<div class="tab-pane<?php echo $inb_bookings_view->MultiPages->PageStyle("1") ?>" id="tab_inb_bookings1">
<?php } ?>
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($inb_bookings->bookingID->Visible) { // bookingID ?>
	<tr id="r_bookingID">
		<td class="col-sm-2"><span id="elh_inb_bookings_bookingID"><?php echo $inb_bookings->bookingID->FldCaption() ?></span></td>
		<td data-name="bookingID"<?php echo $inb_bookings->bookingID->CellAttributes() ?>>
<span id="el_inb_bookings_bookingID" data-page="1">
<span<?php echo $inb_bookings->bookingID->ViewAttributes() ?>>
<?php echo $inb_bookings->bookingID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($inb_bookings->bookingNumber->Visible) { // bookingNumber ?>
	<tr id="r_bookingNumber">
		<td class="col-sm-2"><span id="elh_inb_bookings_bookingNumber"><?php echo $inb_bookings->bookingNumber->FldCaption() ?></span></td>
		<td data-name="bookingNumber"<?php echo $inb_bookings->bookingNumber->CellAttributes() ?>>
<span id="el_inb_bookings_bookingNumber" data-page="1">
<span<?php echo $inb_bookings->bookingNumber->ViewAttributes() ?>>
<?php echo $inb_bookings->bookingNumber->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($inb_bookings->_userID->Visible) { // userID ?>
	<tr id="r__userID">
		<td class="col-sm-2"><span id="elh_inb_bookings__userID"><?php echo $inb_bookings->_userID->FldCaption() ?></span></td>
		<td data-name="_userID"<?php echo $inb_bookings->_userID->CellAttributes() ?>>
<span id="el_inb_bookings__userID" data-page="1">
<span<?php echo $inb_bookings->_userID->ViewAttributes() ?>>
<?php echo $inb_bookings->_userID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($inb_bookings->rentLeaseCarID->Visible) { // rentLeaseCarID ?>
	<tr id="r_rentLeaseCarID">
		<td class="col-sm-2"><span id="elh_inb_bookings_rentLeaseCarID"><?php echo $inb_bookings->rentLeaseCarID->FldCaption() ?></span></td>
		<td data-name="rentLeaseCarID"<?php echo $inb_bookings->rentLeaseCarID->CellAttributes() ?>>
<span id="el_inb_bookings_rentLeaseCarID" data-page="1">
<span<?php echo $inb_bookings->rentLeaseCarID->ViewAttributes() ?>>
<?php echo $inb_bookings->rentLeaseCarID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($inb_bookings->pickUpLocation->Visible) { // pickUpLocation ?>
	<tr id="r_pickUpLocation">
		<td class="col-sm-2"><span id="elh_inb_bookings_pickUpLocation"><?php echo $inb_bookings->pickUpLocation->FldCaption() ?></span></td>
		<td data-name="pickUpLocation"<?php echo $inb_bookings->pickUpLocation->CellAttributes() ?>>
<span id="el_inb_bookings_pickUpLocation" data-page="1">
<span<?php echo $inb_bookings->pickUpLocation->ViewAttributes() ?>>
<?php echo $inb_bookings->pickUpLocation->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($inb_bookings->dropLocation->Visible) { // dropLocation ?>
	<tr id="r_dropLocation">
		<td class="col-sm-2"><span id="elh_inb_bookings_dropLocation"><?php echo $inb_bookings->dropLocation->FldCaption() ?></span></td>
		<td data-name="dropLocation"<?php echo $inb_bookings->dropLocation->CellAttributes() ?>>
<span id="el_inb_bookings_dropLocation" data-page="1">
<span<?php echo $inb_bookings->dropLocation->ViewAttributes() ?>>
<?php echo $inb_bookings->dropLocation->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($inb_bookings->pickUpDate->Visible) { // pickUpDate ?>
	<tr id="r_pickUpDate">
		<td class="col-sm-2"><span id="elh_inb_bookings_pickUpDate"><?php echo $inb_bookings->pickUpDate->FldCaption() ?></span></td>
		<td data-name="pickUpDate"<?php echo $inb_bookings->pickUpDate->CellAttributes() ?>>
<span id="el_inb_bookings_pickUpDate" data-page="1">
<span<?php echo $inb_bookings->pickUpDate->ViewAttributes() ?>>
<?php echo $inb_bookings->pickUpDate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($inb_bookings->dropDate->Visible) { // dropDate ?>
	<tr id="r_dropDate">
		<td class="col-sm-2"><span id="elh_inb_bookings_dropDate"><?php echo $inb_bookings->dropDate->FldCaption() ?></span></td>
		<td data-name="dropDate"<?php echo $inb_bookings->dropDate->CellAttributes() ?>>
<span id="el_inb_bookings_dropDate" data-page="1">
<span<?php echo $inb_bookings->dropDate->ViewAttributes() ?>>
<?php echo $inb_bookings->dropDate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($inb_bookings->noOfDays->Visible) { // noOfDays ?>
	<tr id="r_noOfDays">
		<td class="col-sm-2"><span id="elh_inb_bookings_noOfDays"><?php echo $inb_bookings->noOfDays->FldCaption() ?></span></td>
		<td data-name="noOfDays"<?php echo $inb_bookings->noOfDays->CellAttributes() ?>>
<span id="el_inb_bookings_noOfDays" data-page="1">
<span<?php echo $inb_bookings->noOfDays->ViewAttributes() ?>>
<?php echo $inb_bookings->noOfDays->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($inb_bookings->bookingTerm->Visible) { // bookingTerm ?>
	<tr id="r_bookingTerm">
		<td class="col-sm-2"><span id="elh_inb_bookings_bookingTerm"><?php echo $inb_bookings->bookingTerm->FldCaption() ?></span></td>
		<td data-name="bookingTerm"<?php echo $inb_bookings->bookingTerm->CellAttributes() ?>>
<span id="el_inb_bookings_bookingTerm" data-page="1">
<span<?php echo $inb_bookings->bookingTerm->ViewAttributes() ?>>
<?php echo $inb_bookings->bookingTerm->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($inb_bookings->rentalAmount->Visible) { // rentalAmount ?>
	<tr id="r_rentalAmount">
		<td class="col-sm-2"><span id="elh_inb_bookings_rentalAmount"><?php echo $inb_bookings->rentalAmount->FldCaption() ?></span></td>
		<td data-name="rentalAmount"<?php echo $inb_bookings->rentalAmount->CellAttributes() ?>>
<span id="el_inb_bookings_rentalAmount" data-page="1">
<span<?php echo $inb_bookings->rentalAmount->ViewAttributes() ?>>
<?php echo $inb_bookings->rentalAmount->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($inb_bookings->vat->Visible) { // vat ?>
	<tr id="r_vat">
		<td class="col-sm-2"><span id="elh_inb_bookings_vat"><?php echo $inb_bookings->vat->FldCaption() ?></span></td>
		<td data-name="vat"<?php echo $inb_bookings->vat->CellAttributes() ?>>
<span id="el_inb_bookings_vat" data-page="1">
<span<?php echo $inb_bookings->vat->ViewAttributes() ?>>
<?php echo $inb_bookings->vat->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($inb_bookings->grandTotal->Visible) { // grandTotal ?>
	<tr id="r_grandTotal">
		<td class="col-sm-2"><span id="elh_inb_bookings_grandTotal"><?php echo $inb_bookings->grandTotal->FldCaption() ?></span></td>
		<td data-name="grandTotal"<?php echo $inb_bookings->grandTotal->CellAttributes() ?>>
<span id="el_inb_bookings_grandTotal" data-page="1">
<span<?php echo $inb_bookings->grandTotal->ViewAttributes() ?>>
<?php echo $inb_bookings->grandTotal->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($inb_bookings->totalAmount->Visible) { // totalAmount ?>
	<tr id="r_totalAmount">
		<td class="col-sm-2"><span id="elh_inb_bookings_totalAmount"><?php echo $inb_bookings->totalAmount->FldCaption() ?></span></td>
		<td data-name="totalAmount"<?php echo $inb_bookings->totalAmount->CellAttributes() ?>>
<span id="el_inb_bookings_totalAmount" data-page="1">
<span<?php echo $inb_bookings->totalAmount->ViewAttributes() ?>>
<?php echo $inb_bookings->totalAmount->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($inb_bookings->deliveryAddress->Visible) { // deliveryAddress ?>
	<tr id="r_deliveryAddress">
		<td class="col-sm-2"><span id="elh_inb_bookings_deliveryAddress"><?php echo $inb_bookings->deliveryAddress->FldCaption() ?></span></td>
		<td data-name="deliveryAddress"<?php echo $inb_bookings->deliveryAddress->CellAttributes() ?>>
<span id="el_inb_bookings_deliveryAddress" data-page="1">
<span<?php echo $inb_bookings->deliveryAddress->ViewAttributes() ?>>
<?php echo $inb_bookings->deliveryAddress->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($inb_bookings->paymentMethod->Visible) { // paymentMethod ?>
	<tr id="r_paymentMethod">
		<td class="col-sm-2"><span id="elh_inb_bookings_paymentMethod"><?php echo $inb_bookings->paymentMethod->FldCaption() ?></span></td>
		<td data-name="paymentMethod"<?php echo $inb_bookings->paymentMethod->CellAttributes() ?>>
<span id="el_inb_bookings_paymentMethod" data-page="1">
<span<?php echo $inb_bookings->paymentMethod->ViewAttributes() ?>>
<?php echo $inb_bookings->paymentMethod->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($inb_bookings->dateCreated->Visible) { // dateCreated ?>
	<tr id="r_dateCreated">
		<td class="col-sm-2"><span id="elh_inb_bookings_dateCreated"><?php echo $inb_bookings->dateCreated->FldCaption() ?></span></td>
		<td data-name="dateCreated"<?php echo $inb_bookings->dateCreated->CellAttributes() ?>>
<span id="el_inb_bookings_dateCreated" data-page="1">
<span<?php echo $inb_bookings->dateCreated->ViewAttributes() ?>>
<?php echo $inb_bookings->dateCreated->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php } ?>
<?php if ($inb_bookings->Export == "") { ?>
		<div class="tab-pane<?php echo $inb_bookings_view->MultiPages->PageStyle("2") ?>" id="tab_inb_bookings2">
<?php } ?>
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($inb_bookings->orangeCard->Visible) { // orangeCard ?>
	<tr id="r_orangeCard">
		<td class="col-sm-2"><span id="elh_inb_bookings_orangeCard"><?php echo $inb_bookings->orangeCard->FldCaption() ?></span></td>
		<td data-name="orangeCard"<?php echo $inb_bookings->orangeCard->CellAttributes() ?>>
<span id="el_inb_bookings_orangeCard" data-page="2">
<span<?php echo $inb_bookings->orangeCard->ViewAttributes() ?>>
<?php echo $inb_bookings->orangeCard->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($inb_bookings->gps->Visible) { // gps ?>
	<tr id="r_gps">
		<td class="col-sm-2"><span id="elh_inb_bookings_gps"><?php echo $inb_bookings->gps->FldCaption() ?></span></td>
		<td data-name="gps"<?php echo $inb_bookings->gps->CellAttributes() ?>>
<span id="el_inb_bookings_gps" data-page="2">
<span<?php echo $inb_bookings->gps->ViewAttributes() ?>>
<?php echo $inb_bookings->gps->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($inb_bookings->deliveryCharge->Visible) { // deliveryCharge ?>
	<tr id="r_deliveryCharge">
		<td class="col-sm-2"><span id="elh_inb_bookings_deliveryCharge"><?php echo $inb_bookings->deliveryCharge->FldCaption() ?></span></td>
		<td data-name="deliveryCharge"<?php echo $inb_bookings->deliveryCharge->CellAttributes() ?>>
<span id="el_inb_bookings_deliveryCharge" data-page="2">
<span<?php echo $inb_bookings->deliveryCharge->ViewAttributes() ?>>
<?php echo $inb_bookings->deliveryCharge->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($inb_bookings->collectionCharge->Visible) { // collectionCharge ?>
	<tr id="r_collectionCharge">
		<td class="col-sm-2"><span id="elh_inb_bookings_collectionCharge"><?php echo $inb_bookings->collectionCharge->FldCaption() ?></span></td>
		<td data-name="collectionCharge"<?php echo $inb_bookings->collectionCharge->CellAttributes() ?>>
<span id="el_inb_bookings_collectionCharge" data-page="2">
<span<?php echo $inb_bookings->collectionCharge->ViewAttributes() ?>>
<?php echo $inb_bookings->collectionCharge->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($inb_bookings->Export == "") { ?>
<script type="text/javascript">
finb_bookingsview.Init();
</script>
<?php } ?>
<?php
$inb_bookings_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($inb_bookings->Export == "") { ?>
...
<?php
$inb_bookings_view->Page_Terminate();
?>
