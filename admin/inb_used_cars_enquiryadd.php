...
$inb_used_cars_enquiry_add = NULL; // Initialize page object first

class cinb_used_cars_enquiry_add extends cinb_used_cars_enquiry {
	...
	// Page object name
	var $PageObjName = 'inb_used_cars_enquiry_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "inb_used_cars_enquiryview.php")
	...
	function LoadDefaultValues() {
		...
		$this->carUsedType->CurrentValue = NULL;
		$this->carUsedType->OldValue = $this->carUsedType->CurrentValue;
		$this->carName->CurrentValue = NULL;
		$this->carName->OldValue = $this->carName->CurrentValue;
		$this->price->CurrentValue = NULL;
		$this->price->OldValue = $this->price->CurrentValue;
		$this->kilometer->CurrentValue = NULL;
		$this->kilometer->OldValue = $this->kilometer->CurrentValue;
		$this->regionalSpec->CurrentValue = NULL;
		$this->regionalSpec->OldValue = $this->regionalSpec->CurrentValue;
		$this->transmission->CurrentValue = NULL;
		$this->transmission->OldValue = $this->transmission->CurrentValue;
		$this->fuel->CurrentValue = NULL;
		$this->fuel->OldValue = $this->fuel->CurrentValue;
	...
	function NewRow() {
		...
		$row['carUsedType'] = $this->carUsedType->CurrentValue;
		$row['carName'] = $this->carName->CurrentValue;
		$row['price'] = $this->price->CurrentValue;
		$row['kilometer'] = $this->kilometer->CurrentValue;
		$row['regionalSpec'] = $this->regionalSpec->CurrentValue;
		$row['transmission'] = $this->transmission->CurrentValue;
		$row['fuel'] = $this->fuel->CurrentValue;
		$row['newsletter'] = $this->newsletter->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// carUsedType
		$this->carUsedType->SetDbValueDef($rsnew, $this->carUsedType->CurrentValue, NULL, FALSE);

		// carName
		$this->carName->SetDbValueDef($rsnew, $this->carName->CurrentValue, NULL, FALSE);

		// price
		$this->price->SetDbValueDef($rsnew, $this->price->CurrentValue, NULL, FALSE);

		// kilometer
		$this->kilometer->SetDbValueDef($rsnew, $this->kilometer->CurrentValue, NULL, FALSE);

		// regionalSpec
		$this->regionalSpec->SetDbValueDef($rsnew, $this->regionalSpec->CurrentValue, NULL, FALSE);

		// transmission
		$this->transmission->SetDbValueDef($rsnew, $this->transmission->CurrentValue, NULL, FALSE);

		// fuel
		$this->fuel->SetDbValueDef($rsnew, $this->fuel->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($inb_used_cars_enquiry_add)) $inb_used_cars_enquiry_add = new cinb_used_cars_enquiry_add();

// Page init
$inb_used_cars_enquiry_add->Page_Init();

// Page main
$inb_used_cars_enquiry_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$inb_used_cars_enquiry_add->Page_Render();
?>
...
var CurrentForm = finb_used_cars_enquiryadd = new ew_Form("finb_used_cars_enquiryadd", "add");

// Validate form
finb_used_cars_enquiryadd.Validate = function() {
...
finb_used_cars_enquiryadd.Form_CustomValidate = 
...
finb_used_cars_enquiryadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Multi-Page
finb_used_cars_enquiryadd.MultiPage = new ew_MultiPage("finb_used_cars_enquiryadd");
...
<?php $inb_used_cars_enquiry_add->ShowPageHeader(); ?>
<?php
$inb_used_cars_enquiry_add->ShowMessage();
?>
<form name="finb_used_cars_enquiryadd" id="finb_used_cars_enquiryadd" class="<?php echo $inb_used_cars_enquiry_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($inb_used_cars_enquiry_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $inb_used_cars_enquiry_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="inb_used_cars_enquiry">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($inb_used_cars_enquiry_add->IsModal) ?>">
<div class="ewMultiPage"><!-- multi-page -->
<div class="nav-tabs-custom" id="inb_used_cars_enquiry_add"><!-- multi-page .nav-tabs-custom -->
	<ul class="nav<?php echo $inb_used_cars_enquiry_add->MultiPages->NavStyle() ?>">
		<li<?php echo $inb_used_cars_enquiry_add->MultiPages->TabStyle("1") ?>><a href="#tab_inb_used_cars_enquiry1" data-toggle="tab"><?php echo $inb_used_cars_enquiry->PageCaption(1) ?></a></li>
		<li<?php echo $inb_used_cars_enquiry_add->MultiPages->TabStyle("2") ?>><a href="#tab_inb_used_cars_enquiry2" data-toggle="tab"><?php echo $inb_used_cars_enquiry->PageCaption(2) ?></a></li>
	</ul>
	<div class="tab-content"><!-- multi-page .nav-tabs-custom .tab-content -->
		<div class="tab-pane<?php echo $inb_used_cars_enquiry_add->MultiPages->PageStyle("1") ?>" id="tab_inb_used_cars_enquiry1"><!-- multi-page .tab-pane -->
<div class="ewAddDiv"><!-- page* -->
<?php if ($inb_used_cars_enquiry->firstName->Visible) { // firstName ?>
	<div id="r_firstName" class="form-group">
		<label id="elh_inb_used_cars_enquiry_firstName" for="x_firstName" class="<?php echo $inb_used_cars_enquiry_add->LeftColumnClass ?>"><?php echo $inb_used_cars_enquiry->firstName->FldCaption() ?></label>
		<div class="<?php echo $inb_used_cars_enquiry_add->RightColumnClass ?>"><div<?php echo $inb_used_cars_enquiry->firstName->CellAttributes() ?>>
...
<?php if ($inb_used_cars_enquiry->lastName->Visible) { // lastName ?>
	<div id="r_lastName" class="form-group">
		<label id="elh_inb_used_cars_enquiry_lastName" for="x_lastName" class="<?php echo $inb_used_cars_enquiry_add->LeftColumnClass ?>"><?php echo $inb_used_cars_enquiry->lastName->FldCaption() ?></label>
		<div class="<?php echo $inb_used_cars_enquiry_add->RightColumnClass ?>"><div<?php echo $inb_used_cars_enquiry->lastName->CellAttributes() ?>>
...
<?php if ($inb_used_cars_enquiry->_email->Visible) { // email ?>
	<div id="r__email" class="form-group">
		<label id="elh_inb_used_cars_enquiry__email" for="x__email" class="<?php echo $inb_used_cars_enquiry_add->LeftColumnClass ?>"><?php echo $inb_used_cars_enquiry->_email->FldCaption() ?></label>
		<div class="<?php echo $inb_used_cars_enquiry_add->RightColumnClass ?>"><div<?php echo $inb_used_cars_enquiry->_email->CellAttributes() ?>>
...
<?php if ($inb_used_cars_enquiry->mobileNumber->Visible) { // mobileNumber ?>
	<div id="r_mobileNumber" class="form-group">
		<label id="elh_inb_used_cars_enquiry_mobileNumber" for="x_mobileNumber" class="<?php echo $inb_used_cars_enquiry_add->LeftColumnClass ?>"><?php echo $inb_used_cars_enquiry->mobileNumber->FldCaption() ?></label>
		<div class="<?php echo $inb_used_cars_enquiry_add->RightColumnClass ?>"><div<?php echo $inb_used_cars_enquiry->mobileNumber->CellAttributes() ?>>
...
<?php if ($inb_used_cars_enquiry->country->Visible) { // country ?>
	<div id="r_country" class="form-group">
		<label id="elh_inb_used_cars_enquiry_country" for="x_country" class="<?php echo $inb_used_cars_enquiry_add->LeftColumnClass ?>"><?php echo $inb_used_cars_enquiry->country->FldCaption() ?></label>
		<div class="<?php echo $inb_used_cars_enquiry_add->RightColumnClass ?>"><div<?php echo $inb_used_cars_enquiry->country->CellAttributes() ?>>
...
<?php if ($inb_used_cars_enquiry->city->Visible) { // city ?>
	<div id="r_city" class="form-group">
		<label id="elh_inb_used_cars_enquiry_city" for="x_city" class="<?php echo $inb_used_cars_enquiry_add->LeftColumnClass ?>"><?php echo $inb_used_cars_enquiry->city->FldCaption() ?></label>
		<div class="<?php echo $inb_used_cars_enquiry_add->RightColumnClass ?>"><div<?php echo $inb_used_cars_enquiry->city->CellAttributes() ?>>
...
<?php if ($inb_used_cars_enquiry->nationality->Visible) { // nationality ?>
	<div id="r_nationality" class="form-group">
		<label id="elh_inb_used_cars_enquiry_nationality" for="x_nationality" class="<?php echo $inb_used_cars_enquiry_add->LeftColumnClass ?>"><?php echo $inb_used_cars_enquiry->nationality->FldCaption() ?></label>
		<div class="<?php echo $inb_used_cars_enquiry_add->RightColumnClass ?>"><div<?php echo $inb_used_cars_enquiry->nationality->CellAttributes() ?>>
...
<?php if ($inb_used_cars_enquiry->address->Visible) { // address ?>
	<div id="r_address" class="form-group">
		<label id="elh_inb_used_cars_enquiry_address" for="x_address" class="<?php echo $inb_used_cars_enquiry_add->LeftColumnClass ?>"><?php echo $inb_used_cars_enquiry->address->FldCaption() ?></label>
		<div class="<?php echo $inb_used_cars_enquiry_add->RightColumnClass ?>"><div<?php echo $inb_used_cars_enquiry->address->CellAttributes() ?>>
...
<?php if ($inb_used_cars_enquiry->message->Visible) { // message ?>
	<div id="r_message" class="form-group">
		<label id="elh_inb_used_cars_enquiry_message" class="<?php echo $inb_used_cars_enquiry_add->LeftColumnClass ?>"><?php echo $inb_used_cars_enquiry->message->FldCaption() ?></label>
		<div class="<?php echo $inb_used_cars_enquiry_add->RightColumnClass ?>"><div<?php echo $inb_used_cars_enquiry->message->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateEditor("finb_used_cars_enquiryadd", "x_message", 35, 4, <?php echo ($inb_used_cars_enquiry->message->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php if ($inb_used_cars_enquiry->newsletter->Visible) { // newsletter ?>
	<div id="r_newsletter" class="form-group">
		<label id="elh_inb_used_cars_enquiry_newsletter" for="x_newsletter" class="<?php echo $inb_used_cars_enquiry_add->LeftColumnClass ?>"><?php echo $inb_used_cars_enquiry->newsletter->FldCaption() ?></label>
		<div class="<?php echo $inb_used_cars_enquiry_add->RightColumnClass ?>"><div<?php echo $inb_used_cars_enquiry->newsletter->CellAttributes() ?>>
...
<?php if ($inb_used_cars_enquiry->dateCreated->Visible) { // dateCreated ?>
	<div id="r_dateCreated" class="form-group">
		<label id="elh_inb_used_cars_enquiry_dateCreated" for="x_dateCreated" class="<?php echo $inb_used_cars_enquiry_add->LeftColumnClass ?>"><?php echo $inb_used_cars_enquiry->dateCreated->FldCaption() ?></label>
		<div class="<?php echo $inb_used_cars_enquiry_add->RightColumnClass ?>"><div<?php echo $inb_used_cars_enquiry->dateCreated->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("finb_used_cars_enquiryadd", "x_dateCreated", {"ignoreReadonly":true,"useCurrent":false,"format":7});
</script>
<?php } ?>
</span>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $inb_used_cars_enquiry_add->MultiPages->PageStyle("2") ?>" id="tab_inb_used_cars_enquiry2"><!-- multi-page .tab-pane -->
<div class="ewAddDiv"><!-- page* -->
<?php if ($inb_used_cars_enquiry->carUsedType->Visible) { // carUsedType ?>
	<div id="r_carUsedType" class="form-group">
		<label id="elh_inb_used_cars_enquiry_carUsedType" for="x_carUsedType" class="<?php echo $inb_used_cars_enquiry_add->LeftColumnClass ?>"><?php echo $inb_used_cars_enquiry->carUsedType->FldCaption() ?></label>
		<div class="<?php echo $inb_used_cars_enquiry_add->RightColumnClass ?>"><div<?php echo $inb_used_cars_enquiry->carUsedType->CellAttributes() ?>>
...
<?php if ($inb_used_cars_enquiry->carName->Visible) { // carName ?>
	<div id="r_carName" class="form-group">
		<label id="elh_inb_used_cars_enquiry_carName" for="x_carName" class="<?php echo $inb_used_cars_enquiry_add->LeftColumnClass ?>"><?php echo $inb_used_cars_enquiry->carName->FldCaption() ?></label>
		<div class="<?php echo $inb_used_cars_enquiry_add->RightColumnClass ?>"><div<?php echo $inb_used_cars_enquiry->carName->CellAttributes() ?>>
...
<?php if ($inb_used_cars_enquiry->price->Visible) { // price ?>
	<div id="r_price" class="form-group">
		<label id="elh_inb_used_cars_enquiry_price" for="x_price" class="<?php echo $inb_used_cars_enquiry_add->LeftColumnClass ?>"><?php echo $inb_used_cars_enquiry->price->FldCaption() ?></label>
		<div class="<?php echo $inb_used_cars_enquiry_add->RightColumnClass ?>"><div<?php echo $inb_used_cars_enquiry->price->CellAttributes() ?>>
...
<?php if ($inb_used_cars_enquiry->kilometer->Visible) { // kilometer ?>
	<div id="r_kilometer" class="form-group">
		<label id="elh_inb_used_cars_enquiry_kilometer" for="x_kilometer" class="<?php echo $inb_used_cars_enquiry_add->LeftColumnClass ?>"><?php echo $inb_used_cars_enquiry->kilometer->FldCaption() ?></label>
		<div class="<?php echo $inb_used_cars_enquiry_add->RightColumnClass ?>"><div<?php echo $inb_used_cars_enquiry->kilometer->CellAttributes() ?>>
...
<?php if ($inb_used_cars_enquiry->regionalSpec->Visible) { // regionalSpec ?>
	<div id="r_regionalSpec" class="form-group">
		<label id="elh_inb_used_cars_enquiry_regionalSpec" for="x_regionalSpec" class="<?php echo $inb_used_cars_enquiry_add->LeftColumnClass ?>"><?php echo $inb_used_cars_enquiry->regionalSpec->FldCaption() ?></label>
		<div class="<?php echo $inb_used_cars_enquiry_add->RightColumnClass ?>"><div<?php echo $inb_used_cars_enquiry->regionalSpec->CellAttributes() ?>>
...
<?php if ($inb_used_cars_enquiry->transmission->Visible) { // transmission ?>
	<div id="r_transmission" class="form-group">
		<label id="elh_inb_used_cars_enquiry_transmission" for="x_transmission" class="<?php echo $inb_used_cars_enquiry_add->LeftColumnClass ?>"><?php echo $inb_used_cars_enquiry->transmission->FldCaption() ?></label>
		<div class="<?php echo $inb_used_cars_enquiry_add->RightColumnClass ?>"><div<?php echo $inb_used_cars_enquiry->transmission->CellAttributes() ?>>
...
<?php if ($inb_used_cars_enquiry->fuel->Visible) { // fuel ?>
	<div id="r_fuel" class="form-group">
		<label id="elh_inb_used_cars_enquiry_fuel" for="x_fuel" class="<?php echo $inb_used_cars_enquiry_add->LeftColumnClass ?>"><?php echo $inb_used_cars_enquiry->fuel->FldCaption() ?></label>
		<div class="<?php echo $inb_used_cars_enquiry_add->RightColumnClass ?>"><div<?php echo $inb_used_cars_enquiry->fuel->CellAttributes() ?>>
...
<?php if (!$inb_used_cars_enquiry_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $inb_used_cars_enquiry_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $inb_used_cars_enquiry_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
finb_used_cars_enquiryadd.Init();
</script>
<?php
$inb_used_cars_enquiry_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$inb_used_cars_enquiry_add->Page_Terminate();
?>
