...
<?php if ($inb_contactus->fullname->Visible) { // fullname ?>
	<div id="r_fullname" class="form-group">
		<label id="elh_inb_contactus_fullname" for="x_fullname" class="<?php echo $inb_contactus_add->LeftColumnClass ?>"><?php echo $inb_contactus->fullname->FldCaption() ?></label>
		<div class="<?php echo $inb_contactus_add->RightColumnClass ?>"><div<?php echo $inb_contactus->fullname->CellAttributes() ?>>
...
<?php if ($inb_contactus->address->Visible) { // address ?>
	<div id="r_address" class="form-group">
		<label id="elh_inb_contactus_address" for="x_address" class="<?php echo $inb_contactus_add->LeftColumnClass ?>"><?php echo $inb_contactus->address->FldCaption() ?></label>
		<div class="<?php echo $inb_contactus_add->RightColumnClass ?>"><div<?php echo $inb_contactus->address->CellAttributes() ?>>
...
<?php if ($inb_contactus->dateCreated->Visible) { // dateCreated ?>
	<div id="r_dateCreated" class="form-group">
		<label id="elh_inb_contactus_dateCreated" for="x_dateCreated" class="<?php echo $inb_contactus_add->LeftColumnClass ?>"><?php echo $inb_contactus->dateCreated->FldCaption() ?></label>
		<div class="<?php echo $inb_contactus_add->RightColumnClass ?>"><div<?php echo $inb_contactus->dateCreated->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("finb_contactusadd", "x_dateCreated", {"ignoreReadonly":true,"useCurrent":false,"format":7});
</script>
<?php } ?>
</span>
