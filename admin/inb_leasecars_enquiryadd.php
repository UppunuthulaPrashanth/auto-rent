...
$inb_leasecars_enquiry_add = NULL; // Initialize page object first

class cinb_leasecars_enquiry_add extends cinb_leasecars_enquiry {
	...
	// Page object name
	var $PageObjName = 'inb_leasecars_enquiry_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "inb_leasecars_enquiryview.php")
	...
	function LoadDefaultValues() {
		...
		$this->vehicleID->CurrentValue = NULL;
		$this->vehicleID->OldValue = $this->vehicleID->CurrentValue;
	...
	function NewRow() {
		...
		$row['vehicleID'] = $this->vehicleID->CurrentValue;
...
// Create page object
if (!isset($inb_leasecars_enquiry_add)) $inb_leasecars_enquiry_add = new cinb_leasecars_enquiry_add();

// Page init
$inb_leasecars_enquiry_add->Page_Init();

// Page main
$inb_leasecars_enquiry_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$inb_leasecars_enquiry_add->Page_Render();
?>
...
var CurrentForm = finb_leasecars_enquiryadd = new ew_Form("finb_leasecars_enquiryadd", "add");

// Validate form
finb_leasecars_enquiryadd.Validate = function() {
...
finb_leasecars_enquiryadd.Form_CustomValidate = 
...
finb_leasecars_enquiryadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Multi-Page
finb_leasecars_enquiryadd.MultiPage = new ew_MultiPage("finb_leasecars_enquiryadd");
...
<?php $inb_leasecars_enquiry_add->ShowPageHeader(); ?>
<?php
$inb_leasecars_enquiry_add->ShowMessage();
?>
<form name="finb_leasecars_enquiryadd" id="finb_leasecars_enquiryadd" class="<?php echo $inb_leasecars_enquiry_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($inb_leasecars_enquiry_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $inb_leasecars_enquiry_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="inb_leasecars_enquiry">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($inb_leasecars_enquiry_add->IsModal) ?>">
<div class="ewMultiPage"><!-- multi-page -->
<div class="nav-tabs-custom" id="inb_leasecars_enquiry_add"><!-- multi-page .nav-tabs-custom -->
	<ul class="nav<?php echo $inb_leasecars_enquiry_add->MultiPages->NavStyle() ?>">
		<li<?php echo $inb_leasecars_enquiry_add->MultiPages->TabStyle("1") ?>><a href="#tab_inb_leasecars_enquiry1" data-toggle="tab"><?php echo $inb_leasecars_enquiry->PageCaption(1) ?></a></li>
		<li<?php echo $inb_leasecars_enquiry_add->MultiPages->TabStyle("2") ?>><a href="#tab_inb_leasecars_enquiry2" data-toggle="tab"><?php echo $inb_leasecars_enquiry->PageCaption(2) ?></a></li>
		<li<?php echo $inb_leasecars_enquiry_add->MultiPages->TabStyle("3") ?>><a href="#tab_inb_leasecars_enquiry3" data-toggle="tab"><?php echo $inb_leasecars_enquiry->PageCaption(3) ?></a></li>
	</ul>
	<div class="tab-content"><!-- multi-page .nav-tabs-custom .tab-content -->
		<div class="tab-pane<?php echo $inb_leasecars_enquiry_add->MultiPages->PageStyle("1") ?>" id="tab_inb_leasecars_enquiry1"><!-- multi-page .tab-pane -->
<div class="ewAddDiv"><!-- page* -->
<?php if ($inb_leasecars_enquiry->selectedType->Visible) { // selectedType ?>
	<div id="r_selectedType" class="form-group">
		<label id="elh_inb_leasecars_enquiry_selectedType" for="x_selectedType" class="<?php echo $inb_leasecars_enquiry_add->LeftColumnClass ?>"><?php echo $inb_leasecars_enquiry->selectedType->FldCaption() ?></label>
		<div class="<?php echo $inb_leasecars_enquiry_add->RightColumnClass ?>"><div<?php echo $inb_leasecars_enquiry->selectedType->CellAttributes() ?>>
...
<?php if ($inb_leasecars_enquiry->vehicleID->Visible) { // vehicleID ?>
	<div id="r_vehicleID" class="form-group">
		<label id="elh_inb_leasecars_enquiry_vehicleID" for="x_vehicleID" class="<?php echo $inb_leasecars_enquiry_add->LeftColumnClass ?>"><?php echo $inb_leasecars_enquiry->vehicleID->FldCaption() ?></label>
		<div class="<?php echo $inb_leasecars_enquiry_add->RightColumnClass ?>"><div<?php echo $inb_leasecars_enquiry->vehicleID->CellAttributes() ?>>
...
<?php if ($inb_leasecars_enquiry->dateCreated->Visible) { // dateCreated ?>
	<div id="r_dateCreated" class="form-group">
		<label id="elh_inb_leasecars_enquiry_dateCreated" for="x_dateCreated" class="<?php echo $inb_leasecars_enquiry_add->LeftColumnClass ?>"><?php echo $inb_leasecars_enquiry->dateCreated->FldCaption() ?></label>
		<div class="<?php echo $inb_leasecars_enquiry_add->RightColumnClass ?>"><div<?php echo $inb_leasecars_enquiry->dateCreated->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("finb_leasecars_enquiryadd", "x_dateCreated", {"ignoreReadonly":true,"useCurrent":false,"format":7});
</script>
<?php } ?>
</span>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $inb_leasecars_enquiry_add->MultiPages->PageStyle("2") ?>" id="tab_inb_leasecars_enquiry2"><!-- multi-page .tab-pane -->
<div class="ewAddDiv"><!-- page* -->
<?php if ($inb_leasecars_enquiry->individualFirstName->Visible) { // individualFirstName ?>
	<div id="r_individualFirstName" class="form-group">
		<label id="elh_inb_leasecars_enquiry_individualFirstName" for="x_individualFirstName" class="<?php echo $inb_leasecars_enquiry_add->LeftColumnClass ?>"><?php echo $inb_leasecars_enquiry->individualFirstName->FldCaption() ?></label>
		<div class="<?php echo $inb_leasecars_enquiry_add->RightColumnClass ?>"><div<?php echo $inb_leasecars_enquiry->individualFirstName->CellAttributes() ?>>
...
<?php if ($inb_leasecars_enquiry->individualLastName->Visible) { // individualLastName ?>
	<div id="r_individualLastName" class="form-group">
		<label id="elh_inb_leasecars_enquiry_individualLastName" for="x_individualLastName" class="<?php echo $inb_leasecars_enquiry_add->LeftColumnClass ?>"><?php echo $inb_leasecars_enquiry->individualLastName->FldCaption() ?></label>
		<div class="<?php echo $inb_leasecars_enquiry_add->RightColumnClass ?>"><div<?php echo $inb_leasecars_enquiry->individualLastName->CellAttributes() ?>>
...
<?php if ($inb_leasecars_enquiry->_email->Visible) { // email ?>
	<div id="r__email" class="form-group">
		<label id="elh_inb_leasecars_enquiry__email" for="x__email" class="<?php echo $inb_leasecars_enquiry_add->LeftColumnClass ?>"><?php echo $inb_leasecars_enquiry->_email->FldCaption() ?></label>
		<div class="<?php echo $inb_leasecars_enquiry_add->RightColumnClass ?>"><div<?php echo $inb_leasecars_enquiry->_email->CellAttributes() ?>>
...
<?php if ($inb_leasecars_enquiry->phone->Visible) { // phone ?>
	<div id="r_phone" class="form-group">
		<label id="elh_inb_leasecars_enquiry_phone" for="x_phone" class="<?php echo $inb_leasecars_enquiry_add->LeftColumnClass ?>"><?php echo $inb_leasecars_enquiry->phone->FldCaption() ?></label>
		<div class="<?php echo $inb_leasecars_enquiry_add->RightColumnClass ?>"><div<?php echo $inb_leasecars_enquiry->phone->CellAttributes() ?>>
...
<?php if ($inb_leasecars_enquiry->country->Visible) { // country ?>
	<div id="r_country" class="form-group">
		<label id="elh_inb_leasecars_enquiry_country" for="x_country" class="<?php echo $inb_leasecars_enquiry_add->LeftColumnClass ?>"><?php echo $inb_leasecars_enquiry->country->FldCaption() ?></label>
		<div class="<?php echo $inb_leasecars_enquiry_add->RightColumnClass ?>"><div<?php echo $inb_leasecars_enquiry->country->CellAttributes() ?>>
...
<?php if ($inb_leasecars_enquiry->city->Visible) { // city ?>
	<div id="r_city" class="form-group">
		<label id="elh_inb_leasecars_enquiry_city" for="x_city" class="<?php echo $inb_leasecars_enquiry_add->LeftColumnClass ?>"><?php echo $inb_leasecars_enquiry->city->FldCaption() ?></label>
		<div class="<?php echo $inb_leasecars_enquiry_add->RightColumnClass ?>"><div<?php echo $inb_leasecars_enquiry->city->CellAttributes() ?>>
...
<?php if ($inb_leasecars_enquiry->individualSpecificRequirement->Visible) { // individualSpecificRequirement ?>
	<div id="r_individualSpecificRequirement" class="form-group">
		<label id="elh_inb_leasecars_enquiry_individualSpecificRequirement" for="x_individualSpecificRequirement" class="<?php echo $inb_leasecars_enquiry_add->LeftColumnClass ?>"><?php echo $inb_leasecars_enquiry->individualSpecificRequirement->FldCaption() ?></label>
		<div class="<?php echo $inb_leasecars_enquiry_add->RightColumnClass ?>"><div<?php echo $inb_leasecars_enquiry->individualSpecificRequirement->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $inb_leasecars_enquiry_add->MultiPages->PageStyle("3") ?>" id="tab_inb_leasecars_enquiry3"><!-- multi-page .tab-pane -->
<div class="ewAddDiv"><!-- page* -->
<?php if ($inb_leasecars_enquiry->corporateCompanyName->Visible) { // corporateCompanyName ?>
	<div id="r_corporateCompanyName" class="form-group">
		<label id="elh_inb_leasecars_enquiry_corporateCompanyName" for="x_corporateCompanyName" class="<?php echo $inb_leasecars_enquiry_add->LeftColumnClass ?>"><?php echo $inb_leasecars_enquiry->corporateCompanyName->FldCaption() ?></label>
		<div class="<?php echo $inb_leasecars_enquiry_add->RightColumnClass ?>"><div<?php echo $inb_leasecars_enquiry->corporateCompanyName->CellAttributes() ?>>
...
<?php if ($inb_leasecars_enquiry->corporateFullName->Visible) { // corporateFullName ?>
	<div id="r_corporateFullName" class="form-group">
		<label id="elh_inb_leasecars_enquiry_corporateFullName" for="x_corporateFullName" class="<?php echo $inb_leasecars_enquiry_add->LeftColumnClass ?>"><?php echo $inb_leasecars_enquiry->corporateFullName->FldCaption() ?></label>
		<div class="<?php echo $inb_leasecars_enquiry_add->RightColumnClass ?>"><div<?php echo $inb_leasecars_enquiry->corporateFullName->CellAttributes() ?>>
...
<?php if ($inb_leasecars_enquiry->corporateNoOfVehicle->Visible) { // corporateNoOfVehicle ?>
	<div id="r_corporateNoOfVehicle" class="form-group">
		<label id="elh_inb_leasecars_enquiry_corporateNoOfVehicle" for="x_corporateNoOfVehicle" class="<?php echo $inb_leasecars_enquiry_add->LeftColumnClass ?>"><?php echo $inb_leasecars_enquiry->corporateNoOfVehicle->FldCaption() ?></label>
		<div class="<?php echo $inb_leasecars_enquiry_add->RightColumnClass ?>"><div<?php echo $inb_leasecars_enquiry->corporateNoOfVehicle->CellAttributes() ?>>
...
<?php if ($inb_leasecars_enquiry->corporateSpecificRequirement->Visible) { // corporateSpecificRequirement ?>
	<div id="r_corporateSpecificRequirement" class="form-group">
		<label id="elh_inb_leasecars_enquiry_corporateSpecificRequirement" for="x_corporateSpecificRequirement" class="<?php echo $inb_leasecars_enquiry_add->LeftColumnClass ?>"><?php echo $inb_leasecars_enquiry->corporateSpecificRequirement->FldCaption() ?></label>
		<div class="<?php echo $inb_leasecars_enquiry_add->RightColumnClass ?>"><div<?php echo $inb_leasecars_enquiry->corporateSpecificRequirement->CellAttributes() ?>>
...
<?php if (!$inb_leasecars_enquiry_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $inb_leasecars_enquiry_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $inb_leasecars_enquiry_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
finb_leasecars_enquiryadd.Init();
</script>
<?php
$inb_leasecars_enquiry_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$inb_leasecars_enquiry_add->Page_Terminate();
?>
