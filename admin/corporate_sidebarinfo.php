...
$corporate_sidebar = NULL;

//
// Table class for corporate_sidebar
//
class ccorporate_sidebar extends cTable {
	var $id;
	var $title;
	var $summary;
	var $so;
	...
	function __construct() {
		...
		$this->TableVar = 'corporate_sidebar';
		$this->TableName = 'corporate_sidebar';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`corporate_sidebar`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('corporate_sidebar', 'corporate_sidebar', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// title
		$this->title = new cField('corporate_sidebar', 'corporate_sidebar', 'x_title', 'title', '`title`', '`title`', 200, -1, FALSE, '`title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->title->Sortable = TRUE; // Allow sort
		$this->fields['title'] = &$this->title;

		// summary
		$this->summary = new cField('corporate_sidebar', 'corporate_sidebar', 'x_summary', 'summary', '`summary`', '`summary`', 201, -1, FALSE, '`summary`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->summary->Sortable = TRUE; // Allow sort
		$this->fields['summary'] = &$this->summary;

		// so
		$this->so = new cField('corporate_sidebar', 'corporate_sidebar', 'x_so', 'so', '`so`', '`so`', 16, -1, FALSE, '`so`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->so->Sortable = TRUE; // Allow sort
		$this->so->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['so'] = &$this->so;

		// active
		$this->active = new cField('corporate_sidebar', 'corporate_sidebar', 'x_active', 'active', '`active`', '`active`', 16, -1, FALSE, '`active`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`corporate_sidebar`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "corporate_sidebarlist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "corporate_sidebaredit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "corporate_sidebaradd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("corporate_sidebarview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("corporate_sidebarview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "corporate_sidebaradd.php?" . $this->UrlParm($parm);
		else
			$url = "corporate_sidebaradd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("corporate_sidebaredit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("corporate_sidebaradd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("corporate_sidebardelete.php", $this->UrlParm());
	}
