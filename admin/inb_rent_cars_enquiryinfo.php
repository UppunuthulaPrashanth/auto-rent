...
$inb_rent_cars_enquiry = NULL;

//
// Table class for inb_rent_cars_enquiry
//
class cinb_rent_cars_enquiry extends cTable {
	var $enquiryID;
	var $carTitle;
	var $fullName;
	var $companyName;
	...
	function __construct() {
		...
		$this->TableVar = 'inb_rent_cars_enquiry';
		$this->TableName = 'inb_rent_cars_enquiry';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`inb_rent_cars_enquiry`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// enquiryID
		$this->enquiryID = new cField('inb_rent_cars_enquiry', 'inb_rent_cars_enquiry', 'x_enquiryID', 'enquiryID', '`enquiryID`', '`enquiryID`', 3, -1, FALSE, '`enquiryID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// carTitle
		$this->carTitle = new cField('inb_rent_cars_enquiry', 'inb_rent_cars_enquiry', 'x_carTitle', 'carTitle', '`carTitle`', '`carTitle`', 200, -1, FALSE, '`carTitle`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->carTitle->Sortable = TRUE; // Allow sort
		$this->fields['carTitle'] = &$this->carTitle;

		// fullName
		$this->fullName = new cField('inb_rent_cars_enquiry', 'inb_rent_cars_enquiry', 'x_fullName', 'fullName', '`fullName`', '`fullName`', 200, -1, FALSE, '`fullName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fullName->Sortable = TRUE; // Allow sort
		$this->fields['fullName'] = &$this->fullName;

		// companyName
		$this->companyName = new cField('inb_rent_cars_enquiry', 'inb_rent_cars_enquiry', 'x_companyName', 'companyName', '`companyName`', '`companyName`', 200, -1, FALSE, '`companyName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->companyName->Sortable = TRUE; // Allow sort
		$this->fields['companyName'] = &$this->companyName;

		// email
		$this->email = new cField('inb_rent_cars_enquiry', 'inb_rent_cars_enquiry', 'x_email', 'email', '`email`', '`email`', 200, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->email->Sortable = TRUE; // Allow sort
		$this->fields['email'] = &$this->email;

		// phone
		$this->phone = new cField('inb_rent_cars_enquiry', 'inb_rent_cars_enquiry', 'x_phone', 'phone', '`phone`', '`phone`', 200, -1, FALSE, '`phone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->phone->Sortable = TRUE; // Allow sort
		$this->fields['phone'] = &$this->phone;

		// specificRequirement
		$this->specificRequirement = new cField('inb_rent_cars_enquiry', 'inb_rent_cars_enquiry', 'x_specificRequirement', 'specificRequirement', '`specificRequirement`', '`specificRequirement`', 201, -1, FALSE, '`specificRequirement`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->specificRequirement->Sortable = TRUE; // Allow sort
		$this->fields['specificRequirement'] = &$this->specificRequirement;

		// dateCreted
		$this->dateCreted = new cField('inb_rent_cars_enquiry', 'inb_rent_cars_enquiry', 'x_dateCreted', 'dateCreted', '`dateCreted`', ew_CastDateFieldForLike('`dateCreted`', 7, "DB"), 135, 7, FALSE, '`dateCreted`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`inb_rent_cars_enquiry`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "inb_rent_cars_enquirylist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "inb_rent_cars_enquiryedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "inb_rent_cars_enquiryadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("inb_rent_cars_enquiryview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("inb_rent_cars_enquiryview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "inb_rent_cars_enquiryadd.php?" . $this->UrlParm($parm);
		else
			$url = "inb_rent_cars_enquiryadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("inb_rent_cars_enquiryedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("inb_rent_cars_enquiryadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("inb_rent_cars_enquirydelete.php", $this->UrlParm());
	}
