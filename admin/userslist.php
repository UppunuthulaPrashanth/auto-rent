...
class cusers_list extends cusers {
	...
	function GetFilterList() {
		...
		$sFilterList = ew_Concat($sFilterList, $this->emailID->AdvancedSearch->ToJson(), ","); // Field emailID
		$sFilterList = ew_Concat($sFilterList, $this->mobileNo->AdvancedSearch->ToJson(), ","); // Field mobileNo
		...
		$sFilterList = ew_Concat($sFilterList, $this->pincode->AdvancedSearch->ToJson(), ","); // Field pincode
		$sFilterList = ew_Concat($sFilterList, $this->emiratesID->AdvancedSearch->ToJson(), ","); // Field emiratesID
		$sFilterList = ew_Concat($sFilterList, $this->visaStatus->AdvancedSearch->ToJson(), ","); // Field visaStatus
		$sFilterList = ew_Concat($sFilterList, $this->licenseNumber->AdvancedSearch->ToJson(), ","); // Field licenseNumber
		$sFilterList = ew_Concat($sFilterList, $this->licenseExpiry->AdvancedSearch->ToJson(), ","); // Field licenseExpiry
		$sFilterList = ew_Concat($sFilterList, $this->licensePlaceOfIssue->AdvancedSearch->ToJson(), ","); // Field licensePlaceOfIssue
		$sFilterList = ew_Concat($sFilterList, $this->licenseAttachment->AdvancedSearch->ToJson(), ","); // Field licenseAttachment
		$sFilterList = ew_Concat($sFilterList, $this->passportNumber->AdvancedSearch->ToJson(), ","); // Field passportNumber
		$sFilterList = ew_Concat($sFilterList, $this->passportExpiry->AdvancedSearch->ToJson(), ","); // Field passportExpiry
		$sFilterList = ew_Concat($sFilterList, $this->passportPlaceOfIssue->AdvancedSearch->ToJson(), ","); // Field passportPlaceOfIssue
		$sFilterList = ew_Concat($sFilterList, $this->passportAttachment->AdvancedSearch->ToJson(), ","); // Field passportAttachment
		$sFilterList = ew_Concat($sFilterList, $this->signUpNewsletter->AdvancedSearch->ToJson(), ","); // Field signUpNewsletter
		$sFilterList = ew_Concat($sFilterList, $this->password->AdvancedSearch->ToJson(), ","); // Field password
		$sFilterList = ew_Concat($sFilterList, $this->currentCurrency->AdvancedSearch->ToJson(), ","); // Field currentCurrency
		$sFilterList = ew_Concat($sFilterList, $this->currentLanguage->AdvancedSearch->ToJson(), ","); // Field currentLanguage
	...
	function RestoreFilterList() {
		...
		// Field emiratesID
		$this->emiratesID->AdvancedSearch->SearchValue = @$filter["x_emiratesID"];
		$this->emiratesID->AdvancedSearch->SearchOperator = @$filter["z_emiratesID"];
		$this->emiratesID->AdvancedSearch->SearchCondition = @$filter["v_emiratesID"];
		$this->emiratesID->AdvancedSearch->SearchValue2 = @$filter["y_emiratesID"];
		$this->emiratesID->AdvancedSearch->SearchOperator2 = @$filter["w_emiratesID"];
		$this->emiratesID->AdvancedSearch->Save();

		// Field visaStatus
		$this->visaStatus->AdvancedSearch->SearchValue = @$filter["x_visaStatus"];
		$this->visaStatus->AdvancedSearch->SearchOperator = @$filter["z_visaStatus"];
		$this->visaStatus->AdvancedSearch->SearchCondition = @$filter["v_visaStatus"];
		$this->visaStatus->AdvancedSearch->SearchValue2 = @$filter["y_visaStatus"];
		$this->visaStatus->AdvancedSearch->SearchOperator2 = @$filter["w_visaStatus"];
		$this->visaStatus->AdvancedSearch->Save();

		// Field licenseNumber
		$this->licenseNumber->AdvancedSearch->SearchValue = @$filter["x_licenseNumber"];
		$this->licenseNumber->AdvancedSearch->SearchOperator = @$filter["z_licenseNumber"];
		$this->licenseNumber->AdvancedSearch->SearchCondition = @$filter["v_licenseNumber"];
		$this->licenseNumber->AdvancedSearch->SearchValue2 = @$filter["y_licenseNumber"];
		$this->licenseNumber->AdvancedSearch->SearchOperator2 = @$filter["w_licenseNumber"];
		$this->licenseNumber->AdvancedSearch->Save();

		// Field licenseExpiry
		$this->licenseExpiry->AdvancedSearch->SearchValue = @$filter["x_licenseExpiry"];
		$this->licenseExpiry->AdvancedSearch->SearchOperator = @$filter["z_licenseExpiry"];
		$this->licenseExpiry->AdvancedSearch->SearchCondition = @$filter["v_licenseExpiry"];
		$this->licenseExpiry->AdvancedSearch->SearchValue2 = @$filter["y_licenseExpiry"];
		$this->licenseExpiry->AdvancedSearch->SearchOperator2 = @$filter["w_licenseExpiry"];
		$this->licenseExpiry->AdvancedSearch->Save();

		// Field licensePlaceOfIssue
		$this->licensePlaceOfIssue->AdvancedSearch->SearchValue = @$filter["x_licensePlaceOfIssue"];
		$this->licensePlaceOfIssue->AdvancedSearch->SearchOperator = @$filter["z_licensePlaceOfIssue"];
		$this->licensePlaceOfIssue->AdvancedSearch->SearchCondition = @$filter["v_licensePlaceOfIssue"];
		$this->licensePlaceOfIssue->AdvancedSearch->SearchValue2 = @$filter["y_licensePlaceOfIssue"];
		$this->licensePlaceOfIssue->AdvancedSearch->SearchOperator2 = @$filter["w_licensePlaceOfIssue"];
		$this->licensePlaceOfIssue->AdvancedSearch->Save();

		// Field licenseAttachment
		$this->licenseAttachment->AdvancedSearch->SearchValue = @$filter["x_licenseAttachment"];
		$this->licenseAttachment->AdvancedSearch->SearchOperator = @$filter["z_licenseAttachment"];
		$this->licenseAttachment->AdvancedSearch->SearchCondition = @$filter["v_licenseAttachment"];
		$this->licenseAttachment->AdvancedSearch->SearchValue2 = @$filter["y_licenseAttachment"];
		$this->licenseAttachment->AdvancedSearch->SearchOperator2 = @$filter["w_licenseAttachment"];
		$this->licenseAttachment->AdvancedSearch->Save();
		...
		$this->passportExpiry->AdvancedSearch->SearchValue = @$filter["x_passportExpiry"];
		$this->passportExpiry->AdvancedSearch->SearchOperator = @$filter["z_passportExpiry"];
		$this->passportExpiry->AdvancedSearch->SearchCondition = @$filter["v_passportExpiry"];
		$this->passportExpiry->AdvancedSearch->SearchValue2 = @$filter["y_passportExpiry"];
		$this->passportExpiry->AdvancedSearch->SearchOperator2 = @$filter["w_passportExpiry"];
		$this->passportExpiry->AdvancedSearch->Save();

		// Field passportPlaceOfIssue
		$this->passportPlaceOfIssue->AdvancedSearch->SearchValue = @$filter["x_passportPlaceOfIssue"];
		$this->passportPlaceOfIssue->AdvancedSearch->SearchOperator = @$filter["z_passportPlaceOfIssue"];
		$this->passportPlaceOfIssue->AdvancedSearch->SearchCondition = @$filter["v_passportPlaceOfIssue"];
		$this->passportPlaceOfIssue->AdvancedSearch->SearchValue2 = @$filter["y_passportPlaceOfIssue"];
		$this->passportPlaceOfIssue->AdvancedSearch->SearchOperator2 = @$filter["w_passportPlaceOfIssue"];
		$this->passportPlaceOfIssue->AdvancedSearch->Save();

		// Field passportAttachment
		$this->passportAttachment->AdvancedSearch->SearchValue = @$filter["x_passportAttachment"];
		$this->passportAttachment->AdvancedSearch->SearchOperator = @$filter["z_passportAttachment"];
		$this->passportAttachment->AdvancedSearch->SearchCondition = @$filter["v_passportAttachment"];
		$this->passportAttachment->AdvancedSearch->SearchValue2 = @$filter["y_passportAttachment"];
		$this->passportAttachment->AdvancedSearch->SearchOperator2 = @$filter["w_passportAttachment"];
		$this->passportAttachment->AdvancedSearch->Save();

		// Field signUpNewsletter
		$this->signUpNewsletter->AdvancedSearch->SearchValue = @$filter["x_signUpNewsletter"];
		$this->signUpNewsletter->AdvancedSearch->SearchOperator = @$filter["z_signUpNewsletter"];
		$this->signUpNewsletter->AdvancedSearch->SearchCondition = @$filter["v_signUpNewsletter"];
		$this->signUpNewsletter->AdvancedSearch->SearchValue2 = @$filter["y_signUpNewsletter"];
		$this->signUpNewsletter->AdvancedSearch->SearchOperator2 = @$filter["w_signUpNewsletter"];
		$this->signUpNewsletter->AdvancedSearch->Save();
		...
		// Field currentCurrency
		$this->currentCurrency->AdvancedSearch->SearchValue = @$filter["x_currentCurrency"];
		$this->currentCurrency->AdvancedSearch->SearchOperator = @$filter["z_currentCurrency"];
		$this->currentCurrency->AdvancedSearch->SearchCondition = @$filter["v_currentCurrency"];
		$this->currentCurrency->AdvancedSearch->SearchValue2 = @$filter["y_currentCurrency"];
		$this->currentCurrency->AdvancedSearch->SearchOperator2 = @$filter["w_currentCurrency"];
		$this->currentCurrency->AdvancedSearch->Save();

		// Field currentLanguage
		$this->currentLanguage->AdvancedSearch->SearchValue = @$filter["x_currentLanguage"];
		$this->currentLanguage->AdvancedSearch->SearchOperator = @$filter["z_currentLanguage"];
		$this->currentLanguage->AdvancedSearch->SearchCondition = @$filter["v_currentLanguage"];
		$this->currentLanguage->AdvancedSearch->SearchValue2 = @$filter["y_currentLanguage"];
		$this->currentLanguage->AdvancedSearch->SearchOperator2 = @$filter["w_currentLanguage"];
		$this->currentLanguage->AdvancedSearch->Save();
	...
	function BasicSearchSQL($arKeywords, $type) {
		...
		$this->BuildBasicSearchSQL($sWhere, $this->emailID, $arKeywords, $type);
		...
		$this->BuildBasicSearchSQL($sWhere, $this->pincode, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->emiratesID, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->visaStatus, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->licenseNumber, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->licensePlaceOfIssue, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->licenseAttachment, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->passportNumber, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->passportPlaceOfIssue, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->passportAttachment, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->password, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->currentCurrency, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->currentLanguage, $arKeywords, $type);
		return $sWhere;
	}
	...
	function SetupSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->emailID); // emailID
			...
			$this->UpdateSort($this->emiratesID); // emiratesID
...
fuserslist.Lists["x_nationality"] = {"LinkField":"x_nationalityID","Ajax":true,"AutoFill":false,"DisplayFields":["x_nationalityName","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"mtr_nationality"};
fuserslist.Lists["x_nationality"].Data = "<?php echo $users_list->nationality->LookupFilterQuery(FALSE, "list") ?>";
...
<?php if ($users->_userID->Visible) { // userID ?>
	<?php if ($users->SortUrl($users->_userID) == "") { ?>
		<th data-name="_userID" class="<?php echo $users->_userID->HeaderCellClass() ?>"><div id="elh_users__userID" class="users__userID"><div class="ewTableHeaderCaption"><?php echo $users->_userID->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="_userID" class="<?php echo $users->_userID->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $users->SortUrl($users->_userID) ?>',1);"><div id="elh_users__userID" class="users__userID">
...
<?php if ($users->emailID->Visible) { // emailID ?>
	<?php if ($users->SortUrl($users->emailID) == "") { ?>
		<th data-name="emailID" class="<?php echo $users->emailID->HeaderCellClass() ?>"><div id="elh_users_emailID" class="users_emailID"><div class="ewTableHeaderCaption"><?php echo $users->emailID->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="emailID" class="<?php echo $users->emailID->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $users->SortUrl($users->emailID) ?>',1);"><div id="elh_users_emailID" class="users_emailID">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $users->emailID->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($users->emailID->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($users->emailID->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($users->mobileNo->Visible) { // mobileNo ?>
	<?php if ($users->SortUrl($users->mobileNo) == "") { ?>
		<th data-name="mobileNo" class="<?php echo $users->mobileNo->HeaderCellClass() ?>"><div id="elh_users_mobileNo" class="users_mobileNo"><div class="ewTableHeaderCaption"><?php echo $users->mobileNo->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="mobileNo" class="<?php echo $users->mobileNo->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $users->SortUrl($users->mobileNo) ?>',1);"><div id="elh_users_mobileNo" class="users_mobileNo">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $users->mobileNo->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($users->mobileNo->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($users->mobileNo->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($users->country->Visible) { // country ?>
	<?php if ($users->SortUrl($users->country) == "") { ?>
		<th data-name="country" class="<?php echo $users->country->HeaderCellClass() ?>"><div id="elh_users_country" class="users_country"><div class="ewTableHeaderCaption"><?php echo $users->country->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="country" class="<?php echo $users->country->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $users->SortUrl($users->country) ?>',1);"><div id="elh_users_country" class="users_country">
...
<?php if ($users->nationality->Visible) { // nationality ?>
	<?php if ($users->SortUrl($users->nationality) == "") { ?>
		<th data-name="nationality" class="<?php echo $users->nationality->HeaderCellClass() ?>"><div id="elh_users_nationality" class="users_nationality"><div class="ewTableHeaderCaption"><?php echo $users->nationality->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="nationality" class="<?php echo $users->nationality->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $users->SortUrl($users->nationality) ?>',1);"><div id="elh_users_nationality" class="users_nationality">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $users->nationality->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($users->nationality->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($users->nationality->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($users->emiratesID->Visible) { // emiratesID ?>
	<?php if ($users->SortUrl($users->emiratesID) == "") { ?>
		<th data-name="emiratesID" class="<?php echo $users->emiratesID->HeaderCellClass() ?>"><div id="elh_users_emiratesID" class="users_emiratesID"><div class="ewTableHeaderCaption"><?php echo $users->emiratesID->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="emiratesID" class="<?php echo $users->emiratesID->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $users->SortUrl($users->emiratesID) ?>',1);"><div id="elh_users_emiratesID" class="users_emiratesID">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $users->emiratesID->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($users->emiratesID->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($users->emiratesID->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($users->createdDate->Visible) { // createdDate ?>
	<?php if ($users->SortUrl($users->createdDate) == "") { ?>
		<th data-name="createdDate" class="<?php echo $users->createdDate->HeaderCellClass() ?>"><div id="elh_users_createdDate" class="users_createdDate"><div class="ewTableHeaderCaption"><?php echo $users->createdDate->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="createdDate" class="<?php echo $users->createdDate->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $users->SortUrl($users->createdDate) ?>',1);"><div id="elh_users_createdDate" class="users_createdDate">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $users->createdDate->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($users->createdDate->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($users->createdDate->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<span id="el<?php echo $users_list->RowCnt ?>_users_emailID" class="users_emailID">
...
<?php echo $users->emailID->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($users->mobileNo->Visible) { // mobileNo ?>
		<td data-name="mobileNo"<?php echo $users->mobileNo->CellAttributes() ?>>
<span id="el<?php echo $users_list->RowCnt ?>_users_mobileNo" class="users_mobileNo">
...
<span id="el<?php echo $users_list->RowCnt ?>_users_nationality" class="users_nationality">
...
<?php echo $users->nationality->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($users->emiratesID->Visible) { // emiratesID ?>
		<td data-name="emiratesID"<?php echo $users->emiratesID->CellAttributes() ?>>
<span id="el<?php echo $users_list->RowCnt ?>_users_emiratesID" class="users_emiratesID">
...
<?php echo $users->emiratesID->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($users->createdDate->Visible) { // createdDate ?>
		<td data-name="createdDate"<?php echo $users->createdDate->CellAttributes() ?>>
<span id="el<?php echo $users_list->RowCnt ?>_users_createdDate" class="users_createdDate">
