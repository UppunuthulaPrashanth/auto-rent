...
class cservices_list extends cservices {
	...
	function GetFilterList() {
		...
		$sFilterList = ew_Concat($sFilterList, $this->serviceSlug->AdvancedSearch->ToJson(), ","); // Field serviceSlug
	...
	function RestoreFilterList() {
		...
		// Field serviceSlug
		$this->serviceSlug->AdvancedSearch->SearchValue = @$filter["x_serviceSlug"];
		$this->serviceSlug->AdvancedSearch->SearchOperator = @$filter["z_serviceSlug"];
		$this->serviceSlug->AdvancedSearch->SearchCondition = @$filter["v_serviceSlug"];
		$this->serviceSlug->AdvancedSearch->SearchValue2 = @$filter["y_serviceSlug"];
		$this->serviceSlug->AdvancedSearch->SearchOperator2 = @$filter["w_serviceSlug"];
		$this->serviceSlug->AdvancedSearch->Save();
	...
	function BasicSearchSQL($arKeywords, $type) {
		...
		$this->BuildBasicSearchSQL($sWhere, $this->serviceSlug, $arKeywords, $type);
...
fserviceslist.Lists["x_serviceTypeID"] = {"LinkField":"x_serviceTypeID","Ajax":true,"AutoFill":false,"DisplayFields":["x_serviceTypeName","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"mtr_service_type"};
fserviceslist.Lists["x_serviceTypeID"].Data = "<?php echo $services_list->serviceTypeID->LookupFilterQuery(FALSE, "list") ?>";
...
<?php if ($services->serviceTypeID->Visible) { // serviceTypeID ?>
	<?php if ($services->SortUrl($services->serviceTypeID) == "") { ?>
		<th data-name="serviceTypeID" class="<?php echo $services->serviceTypeID->HeaderCellClass() ?>"><div id="elh_services_serviceTypeID" class="services_serviceTypeID"><div class="ewTableHeaderCaption"><?php echo $services->serviceTypeID->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="serviceTypeID" class="<?php echo $services->serviceTypeID->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $services->SortUrl($services->serviceTypeID) ?>',1);"><div id="elh_services_serviceTypeID" class="services_serviceTypeID">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $services->serviceTypeID->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($services->serviceTypeID->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($services->serviceTypeID->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($services->serviceName->Visible) { // serviceName ?>
	<?php if ($services->SortUrl($services->serviceName) == "") { ?>
		<th data-name="serviceName" class="<?php echo $services->serviceName->HeaderCellClass() ?>"><div id="elh_services_serviceName" class="services_serviceName"><div class="ewTableHeaderCaption"><?php echo $services->serviceName->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="serviceName" class="<?php echo $services->serviceName->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $services->SortUrl($services->serviceName) ?>',1);"><div id="elh_services_serviceName" class="services_serviceName">
...
<?php echo $services->serviceID->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($services->serviceTypeID->Visible) { // serviceTypeID ?>
		<td data-name="serviceTypeID"<?php echo $services->serviceTypeID->CellAttributes() ?>>
<span id="el<?php echo $services_list->RowCnt ?>_services_serviceTypeID" class="services_serviceTypeID">
