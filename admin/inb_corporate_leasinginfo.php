...
$inb_corporate_leasing = NULL;

//
// Table class for inb_corporate_leasing
//
class cinb_corporate_leasing extends cTable {
	var $id;
	var $fullname;
	var $companyName;
	var $_email;
	...
	function __construct() {
		...
		$this->TableVar = 'inb_corporate_leasing';
		$this->TableName = 'inb_corporate_leasing';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`inb_corporate_leasing`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('inb_corporate_leasing', 'inb_corporate_leasing', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// fullname
		$this->fullname = new cField('inb_corporate_leasing', 'inb_corporate_leasing', 'x_fullname', 'fullname', '`fullname`', '`fullname`', 200, -1, FALSE, '`fullname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fullname->Sortable = TRUE; // Allow sort
		$this->fields['fullname'] = &$this->fullname;

		// companyName
		$this->companyName = new cField('inb_corporate_leasing', 'inb_corporate_leasing', 'x_companyName', 'companyName', '`companyName`', '`companyName`', 200, -1, FALSE, '`companyName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->companyName->Sortable = TRUE; // Allow sort
		$this->fields['companyName'] = &$this->companyName;

		// email
		$this->_email = new cField('inb_corporate_leasing', 'inb_corporate_leasing', 'x__email', 'email', '`email`', '`email`', 200, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_email->Sortable = TRUE; // Allow sort
		$this->fields['email'] = &$this->_email;

		// phone
		$this->phone = new cField('inb_corporate_leasing', 'inb_corporate_leasing', 'x_phone', 'phone', '`phone`', '`phone`', 200, -1, FALSE, '`phone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->phone->Sortable = TRUE; // Allow sort
		$this->fields['phone'] = &$this->phone;

		// vehicleInterestedIn
		$this->vehicleInterestedIn = new cField('inb_corporate_leasing', 'inb_corporate_leasing', 'x_vehicleInterestedIn', 'vehicleInterestedIn', '`vehicleInterestedIn`', '`vehicleInterestedIn`', 200, -1, FALSE, '`vehicleInterestedIn`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->vehicleInterestedIn->Sortable = TRUE; // Allow sort
		$this->fields['vehicleInterestedIn'] = &$this->vehicleInterestedIn;

		// noOfVehicles
		$this->noOfVehicles = new cField('inb_corporate_leasing', 'inb_corporate_leasing', 'x_noOfVehicles', 'noOfVehicles', '`noOfVehicles`', '`noOfVehicles`', 200, -1, FALSE, '`noOfVehicles`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->noOfVehicles->Sortable = TRUE; // Allow sort
		$this->fields['noOfVehicles'] = &$this->noOfVehicles;

		// vehicleCategory
		$this->vehicleCategory = new cField('inb_corporate_leasing', 'inb_corporate_leasing', 'x_vehicleCategory', 'vehicleCategory', '`vehicleCategory`', '`vehicleCategory`', 200, -1, FALSE, '`vehicleCategory`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->vehicleCategory->Sortable = TRUE; // Allow sort
		$this->fields['vehicleCategory'] = &$this->vehicleCategory;

		// specificRequirement
		$this->specificRequirement = new cField('inb_corporate_leasing', 'inb_corporate_leasing', 'x_specificRequirement', 'specificRequirement', '`specificRequirement`', '`specificRequirement`', 201, -1, FALSE, '`specificRequirement`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->specificRequirement->Sortable = TRUE; // Allow sort
		$this->fields['specificRequirement'] = &$this->specificRequirement;

		// dateCreated
		$this->dateCreated = new cField('inb_corporate_leasing', 'inb_corporate_leasing', 'x_dateCreated', 'dateCreated', '`dateCreated`', ew_CastDateFieldForLike('`dateCreated`', 7, "DB"), 135, 7, FALSE, '`dateCreated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`inb_corporate_leasing`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "inb_corporate_leasinglist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "inb_corporate_leasingedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "inb_corporate_leasingadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("inb_corporate_leasingview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("inb_corporate_leasingview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "inb_corporate_leasingadd.php?" . $this->UrlParm($parm);
		else
			$url = "inb_corporate_leasingadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("inb_corporate_leasingedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("inb_corporate_leasingadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("inb_corporate_leasingdelete.php", $this->UrlParm());
	}
