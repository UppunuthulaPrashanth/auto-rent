...
$lease_cars_view = NULL; // Initialize page object first

class clease_cars_view extends clease_cars {
	...
	// Page object name
	var $PageObjName = 'lease_cars_view';
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["leaseCarID"] <> "") {
			$this->RecKey["leaseCarID"] = $_GET["leaseCarID"];
			$KeyUrl .= "&amp;leaseCarID=" . urlencode($this->RecKey["leaseCarID"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["leaseCarID"] <> "") {
				...
				$this->RecKey["leaseCarID"] = $this->leaseCarID->QueryStringValue;
			} elseif (@$_POST["leaseCarID"] <> "") {
				$this->leaseCarID->setFormValue($_POST["leaseCarID"]);
				$this->RecKey["leaseCarID"] = $this->leaseCarID->FormValue;
			} else {
				$sReturnUrl = "lease_carslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "lease_carslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "lease_carslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($lease_cars_view)) $lease_cars_view = new clease_cars_view();

// Page init
$lease_cars_view->Page_Init();

// Page main
$lease_cars_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$lease_cars_view->Page_Render();
?>
...
var CurrentForm = flease_carsview = new ew_Form("flease_carsview", "view");

// Form_CustomValidate event
flease_carsview.Form_CustomValidate = 
...
flease_carsview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
flease_carsview.Lists["x_makeID"] = {"LinkField":"x_makeID","Ajax":true,"AutoFill":false,"DisplayFields":["x_make","","",""],"ParentFields":[],"ChildFields":["x_modelID"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"mtr_make"};
flease_carsview.Lists["x_makeID"].Data = "<?php echo $lease_cars_view->makeID->LookupFilterQuery(FALSE, "view") ?>";
flease_carsview.Lists["x_modelID"] = {"LinkField":"x_modelID","Ajax":true,"AutoFill":false,"DisplayFields":["x_model","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"mtr_model"};
flease_carsview.Lists["x_modelID"].Data = "<?php echo $lease_cars_view->modelID->LookupFilterQuery(FALSE, "view") ?>";
flease_carsview.Lists["x_bodyTypeID"] = {"LinkField":"x_bodyTypeID","Ajax":true,"AutoFill":false,"DisplayFields":["x_bodytype","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"mtr_bodytype"};
flease_carsview.Lists["x_bodyTypeID"].Data = "<?php echo $lease_cars_view->bodyTypeID->LookupFilterQuery(FALSE, "view") ?>";
flease_carsview.Lists["x_extraFeatures[]"] = {"LinkField":"x_featureID","Ajax":true,"AutoFill":false,"DisplayFields":["x_extraFeatures","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"mtr_extra_features"};
flease_carsview.Lists["x_extraFeatures[]"].Data = "<?php echo $lease_cars_view->extraFeatures->LookupFilterQuery(FALSE, "view") ?>";
flease_carsview.Lists["x_transmissionID"] = {"LinkField":"x_transmissionID","Ajax":true,"AutoFill":false,"DisplayFields":["x_transmission","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"mtr_transmission"};
flease_carsview.Lists["x_transmissionID"].Data = "<?php echo $lease_cars_view->transmissionID->LookupFilterQuery(FALSE, "view") ?>";
flease_carsview.Lists["x_ac[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
flease_carsview.Lists["x_ac[]"].Options = <?php echo json_encode($lease_cars_view->ac->Options()) ?>;
flease_carsview.Lists["x_active"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
flease_carsview.Lists["x_active"].Options = <?php echo json_encode($lease_cars_view->active->Options()) ?>;
...
<?php if ($lease_cars->Export == "") { ?>
<div class="ewToolbar">
<?php $lease_cars_view->ExportOptions->Render("body") ?>
<?php
	foreach ($lease_cars_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php } ?>
<?php $lease_cars_view->ShowPageHeader(); ?>
<?php
$lease_cars_view->ShowMessage();
?>
<form name="flease_carsview" id="flease_carsview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($lease_cars_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $lease_cars_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="lease_cars">
<input type="hidden" name="modal" value="<?php echo intval($lease_cars_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($lease_cars->leaseCarID->Visible) { // leaseCarID ?>
	<tr id="r_leaseCarID">
		<td class="col-sm-2"><span id="elh_lease_cars_leaseCarID"><?php echo $lease_cars->leaseCarID->FldCaption() ?></span></td>
...
<?php echo $lease_cars->leaseCarID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lease_cars->makeID->Visible) { // makeID ?>
	<tr id="r_makeID">
		<td class="col-sm-2"><span id="elh_lease_cars_makeID"><?php echo $lease_cars->makeID->FldCaption() ?></span></td>
...
<?php echo $lease_cars->makeID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lease_cars->modelID->Visible) { // modelID ?>
	<tr id="r_modelID">
		<td class="col-sm-2"><span id="elh_lease_cars_modelID"><?php echo $lease_cars->modelID->FldCaption() ?></span></td>
...
<?php echo $lease_cars->modelID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lease_cars->bodyTypeID->Visible) { // bodyTypeID ?>
	<tr id="r_bodyTypeID">
		<td class="col-sm-2"><span id="elh_lease_cars_bodyTypeID"><?php echo $lease_cars->bodyTypeID->FldCaption() ?></span></td>
...
<?php echo $lease_cars->bodyTypeID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lease_cars->slug->Visible) { // slug ?>
	<tr id="r_slug">
		<td class="col-sm-2"><span id="elh_lease_cars_slug"><?php echo $lease_cars->slug->FldCaption() ?></span></td>
		<td data-name="slug"<?php echo $lease_cars->slug->CellAttributes() ?>>
<span id="el_lease_cars_slug">
<span<?php echo $lease_cars->slug->ViewAttributes() ?>>
<?php echo $lease_cars->slug->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lease_cars->image->Visible) { // image ?>
	<tr id="r_image">
		<td class="col-sm-2"><span id="elh_lease_cars_image"><?php echo $lease_cars->image->FldCaption() ?></span></td>
		<td data-name="image"<?php echo $lease_cars->image->CellAttributes() ?>>
<span id="el_lease_cars_image">
<span>
<?php echo ew_GetFileViewTag($lease_cars->image, $lease_cars->image->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($lease_cars->extraFeatures->Visible) { // extraFeatures ?>
	<tr id="r_extraFeatures">
		<td class="col-sm-2"><span id="elh_lease_cars_extraFeatures"><?php echo $lease_cars->extraFeatures->FldCaption() ?></span></td>
		<td data-name="extraFeatures"<?php echo $lease_cars->extraFeatures->CellAttributes() ?>>
<span id="el_lease_cars_extraFeatures">
<span<?php echo $lease_cars->extraFeatures->ViewAttributes() ?>>
<?php echo $lease_cars->extraFeatures->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lease_cars->noOfSeats->Visible) { // noOfSeats ?>
	<tr id="r_noOfSeats">
		<td class="col-sm-2"><span id="elh_lease_cars_noOfSeats"><?php echo $lease_cars->noOfSeats->FldCaption() ?></span></td>
		<td data-name="noOfSeats"<?php echo $lease_cars->noOfSeats->CellAttributes() ?>>
<span id="el_lease_cars_noOfSeats">
<span<?php echo $lease_cars->noOfSeats->ViewAttributes() ?>>
<?php echo $lease_cars->noOfSeats->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lease_cars->luggage->Visible) { // luggage ?>
	<tr id="r_luggage">
		<td class="col-sm-2"><span id="elh_lease_cars_luggage"><?php echo $lease_cars->luggage->FldCaption() ?></span></td>
		<td data-name="luggage"<?php echo $lease_cars->luggage->CellAttributes() ?>>
<span id="el_lease_cars_luggage">
<span<?php echo $lease_cars->luggage->ViewAttributes() ?>>
<?php echo $lease_cars->luggage->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lease_cars->transmissionID->Visible) { // transmissionID ?>
	<tr id="r_transmissionID">
		<td class="col-sm-2"><span id="elh_lease_cars_transmissionID"><?php echo $lease_cars->transmissionID->FldCaption() ?></span></td>
		<td data-name="transmissionID"<?php echo $lease_cars->transmissionID->CellAttributes() ?>>
<span id="el_lease_cars_transmissionID">
<span<?php echo $lease_cars->transmissionID->ViewAttributes() ?>>
<?php echo $lease_cars->transmissionID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lease_cars->ac->Visible) { // ac ?>
	<tr id="r_ac">
		<td class="col-sm-2"><span id="elh_lease_cars_ac"><?php echo $lease_cars->ac->FldCaption() ?></span></td>
		<td data-name="ac"<?php echo $lease_cars->ac->CellAttributes() ?>>
<span id="el_lease_cars_ac">
<span<?php echo $lease_cars->ac->ViewAttributes() ?>>
<?php if (ew_ConvertToBool($lease_cars->ac->CurrentValue)) { ?>
<input type="checkbox" value="<?php echo $lease_cars->ac->ViewValue ?>" disabled checked>
<?php } else { ?>
<input type="checkbox" value="<?php echo $lease_cars->ac->ViewValue ?>" disabled>
<?php } ?>
</span>
</span>
</td>
...
<?php if ($lease_cars->noOfDoors->Visible) { // noOfDoors ?>
	<tr id="r_noOfDoors">
		<td class="col-sm-2"><span id="elh_lease_cars_noOfDoors"><?php echo $lease_cars->noOfDoors->FldCaption() ?></span></td>
		<td data-name="noOfDoors"<?php echo $lease_cars->noOfDoors->CellAttributes() ?>>
<span id="el_lease_cars_noOfDoors">
<span<?php echo $lease_cars->noOfDoors->ViewAttributes() ?>>
<?php echo $lease_cars->noOfDoors->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lease_cars->monthlyAED->Visible) { // monthlyAED ?>
	<tr id="r_monthlyAED">
		<td class="col-sm-2"><span id="elh_lease_cars_monthlyAED"><?php echo $lease_cars->monthlyAED->FldCaption() ?></span></td>
...
<?php echo $lease_cars->monthlyAED->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lease_cars->deliveryAED->Visible) { // deliveryAED ?>
	<tr id="r_deliveryAED">
		<td class="col-sm-2"><span id="elh_lease_cars_deliveryAED"><?php echo $lease_cars->deliveryAED->FldCaption() ?></span></td>
		<td data-name="deliveryAED"<?php echo $lease_cars->deliveryAED->CellAttributes() ?>>
<span id="el_lease_cars_deliveryAED">
<span<?php echo $lease_cars->deliveryAED->ViewAttributes() ?>>
<?php echo $lease_cars->deliveryAED->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lease_cars->so->Visible) { // so ?>
	<tr id="r_so">
		<td class="col-sm-2"><span id="elh_lease_cars_so"><?php echo $lease_cars->so->FldCaption() ?></span></td>
		<td data-name="so"<?php echo $lease_cars->so->CellAttributes() ?>>
<span id="el_lease_cars_so">
<span<?php echo $lease_cars->so->ViewAttributes() ?>>
<?php echo $lease_cars->so->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lease_cars->active->Visible) { // active ?>
	<tr id="r_active">
		<td class="col-sm-2"><span id="elh_lease_cars_active"><?php echo $lease_cars->active->FldCaption() ?></span></td>
...
<?php echo $lease_cars->active->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($lease_cars->Export == "") { ?>
<script type="text/javascript">
flease_carsview.Init();
</script>
<?php } ?>
<?php
$lease_cars_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($lease_cars->Export == "") { ?>
...
<?php
$lease_cars_view->Page_Terminate();
?>
