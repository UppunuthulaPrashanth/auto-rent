...
class csliders_add extends csliders {
	...
	function LoadDefaultValues() {
		...
		$this->linkLabel->CurrentValue = NULL;
		$this->linkLabel->OldValue = $this->linkLabel->CurrentValue;
	...
	function NewRow() {
		...
		$row['linkLabel'] = $this->linkLabel->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// linkLabel
		$this->linkLabel->SetDbValueDef($rsnew, $this->linkLabel->CurrentValue, NULL, FALSE);
...
<?php if ($sliders->subTitle->Visible) { // subTitle ?>
	<div id="r_subTitle" class="form-group">
		<label id="elh_sliders_subTitle" for="x_subTitle" class="<?php echo $sliders_add->LeftColumnClass ?>"><?php echo $sliders->subTitle->FldCaption() ?></label>
		<div class="<?php echo $sliders_add->RightColumnClass ?>"><div<?php echo $sliders->subTitle->CellAttributes() ?>>
...
<?php if ($sliders->linkLabel->Visible) { // linkLabel ?>
	<div id="r_linkLabel" class="form-group">
		<label id="elh_sliders_linkLabel" for="x_linkLabel" class="<?php echo $sliders_add->LeftColumnClass ?>"><?php echo $sliders->linkLabel->FldCaption() ?></label>
		<div class="<?php echo $sliders_add->RightColumnClass ?>"><div<?php echo $sliders->linkLabel->CellAttributes() ?>>
...
<?php if ($sliders->linkTo->Visible) { // linkTo ?>
	<div id="r_linkTo" class="form-group">
		<label id="elh_sliders_linkTo" for="x_linkTo" class="<?php echo $sliders_add->LeftColumnClass ?>"><?php echo $sliders->linkTo->FldCaption() ?></label>
		<div class="<?php echo $sliders_add->RightColumnClass ?>"><div<?php echo $sliders->linkTo->CellAttributes() ?>>
