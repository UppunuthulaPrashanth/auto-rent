...
fservicesview.Lists["x_serviceTypeID"] = {"LinkField":"x_serviceTypeID","Ajax":true,"AutoFill":false,"DisplayFields":["x_serviceTypeName","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"mtr_service_type"};
fservicesview.Lists["x_serviceTypeID"].Data = "<?php echo $services_view->serviceTypeID->LookupFilterQuery(FALSE, "view") ?>";
...
<?php if ($services->serviceTypeID->Visible) { // serviceTypeID ?>
	<tr id="r_serviceTypeID">
		<td class="col-sm-2"><span id="elh_services_serviceTypeID"><?php echo $services->serviceTypeID->FldCaption() ?></span></td>
...
<?php echo $services->serviceTypeID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($services->serviceName->Visible) { // serviceName ?>
	<tr id="r_serviceName">
		<td class="col-sm-2"><span id="elh_services_serviceName"><?php echo $services->serviceName->FldCaption() ?></span></td>
...
<?php if ($services->serviceSlug->Visible) { // serviceSlug ?>
	<tr id="r_serviceSlug">
		<td class="col-sm-2"><span id="elh_services_serviceSlug"><?php echo $services->serviceSlug->FldCaption() ?></span></td>
		<td data-name="serviceSlug"<?php echo $services->serviceSlug->CellAttributes() ?>>
<span id="el_services_serviceSlug">
<span<?php echo $services->serviceSlug->ViewAttributes() ?>>
<?php echo $services->serviceSlug->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
