...
$inb_new_vehicle_enquiry_edit = NULL; // Initialize page object first

class cinb_new_vehicle_enquiry_edit extends cinb_new_vehicle_enquiry {
	...
	// Page object name
	var $PageObjName = 'inb_new_vehicle_enquiry_edit';
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// individualVehicle
			$this->individualVehicle->SetDbValueDef($rsnew, $this->individualVehicle->CurrentValue, NULL, $this->individualVehicle->ReadOnly);

			// corporateVehicle
			$this->corporateVehicle->SetDbValueDef($rsnew, $this->corporateVehicle->CurrentValue, NULL, $this->corporateVehicle->ReadOnly);
			...
			// dateCreated
			$this->dateCreated->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->dateCreated->CurrentValue, 0), NULL, $this->dateCreated->ReadOnly);
...
// Create page object
if (!isset($inb_new_vehicle_enquiry_edit)) $inb_new_vehicle_enquiry_edit = new cinb_new_vehicle_enquiry_edit();

// Page init
$inb_new_vehicle_enquiry_edit->Page_Init();

// Page main
$inb_new_vehicle_enquiry_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$inb_new_vehicle_enquiry_edit->Page_Render();
?>
...
var CurrentForm = finb_new_vehicle_enquiryedit = new ew_Form("finb_new_vehicle_enquiryedit", "edit");

// Validate form
finb_new_vehicle_enquiryedit.Validate = function() {
...
finb_new_vehicle_enquiryedit.Form_CustomValidate = 
...
finb_new_vehicle_enquiryedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Multi-Page
finb_new_vehicle_enquiryedit.MultiPage = new ew_MultiPage("finb_new_vehicle_enquiryedit");
...
<?php $inb_new_vehicle_enquiry_edit->ShowPageHeader(); ?>
<?php
$inb_new_vehicle_enquiry_edit->ShowMessage();
?>
<form name="finb_new_vehicle_enquiryedit" id="finb_new_vehicle_enquiryedit" class="<?php echo $inb_new_vehicle_enquiry_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($inb_new_vehicle_enquiry_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $inb_new_vehicle_enquiry_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="inb_new_vehicle_enquiry">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($inb_new_vehicle_enquiry_edit->IsModal) ?>">
<div class="ewMultiPage"><!-- multi-page -->
<div class="nav-tabs-custom" id="inb_new_vehicle_enquiry_edit"><!-- multi-page .nav-tabs-custom -->
	<ul class="nav<?php echo $inb_new_vehicle_enquiry_edit->MultiPages->NavStyle() ?>">
		<li<?php echo $inb_new_vehicle_enquiry_edit->MultiPages->TabStyle("1") ?>><a href="#tab_inb_new_vehicle_enquiry1" data-toggle="tab"><?php echo $inb_new_vehicle_enquiry->PageCaption(1) ?></a></li>
		<li<?php echo $inb_new_vehicle_enquiry_edit->MultiPages->TabStyle("2") ?>><a href="#tab_inb_new_vehicle_enquiry2" data-toggle="tab"><?php echo $inb_new_vehicle_enquiry->PageCaption(2) ?></a></li>
		<li<?php echo $inb_new_vehicle_enquiry_edit->MultiPages->TabStyle("3") ?>><a href="#tab_inb_new_vehicle_enquiry3" data-toggle="tab"><?php echo $inb_new_vehicle_enquiry->PageCaption(3) ?></a></li>
	</ul>
	<div class="tab-content"><!-- multi-page .nav-tabs-custom .tab-content -->
		<div class="tab-pane<?php echo $inb_new_vehicle_enquiry_edit->MultiPages->PageStyle("1") ?>" id="tab_inb_new_vehicle_enquiry1"><!-- multi-page .tab-pane -->
<div class="ewEditDiv"><!-- page* -->
<?php if ($inb_new_vehicle_enquiry->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_inb_new_vehicle_enquiry_id" class="<?php echo $inb_new_vehicle_enquiry_edit->LeftColumnClass ?>"><?php echo $inb_new_vehicle_enquiry->id->FldCaption() ?></label>
		<div class="<?php echo $inb_new_vehicle_enquiry_edit->RightColumnClass ?>"><div<?php echo $inb_new_vehicle_enquiry->id->CellAttributes() ?>>
<span id="el_inb_new_vehicle_enquiry_id">
<span<?php echo $inb_new_vehicle_enquiry->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $inb_new_vehicle_enquiry->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="inb_new_vehicle_enquiry" data-field="x_id" data-page="1" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($inb_new_vehicle_enquiry->id->CurrentValue) ?>">
<?php echo $inb_new_vehicle_enquiry->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($inb_new_vehicle_enquiry->selectedType->Visible) { // selectedType ?>
	<div id="r_selectedType" class="form-group">
		<label id="elh_inb_new_vehicle_enquiry_selectedType" for="x_selectedType" class="<?php echo $inb_new_vehicle_enquiry_edit->LeftColumnClass ?>"><?php echo $inb_new_vehicle_enquiry->selectedType->FldCaption() ?></label>
		<div class="<?php echo $inb_new_vehicle_enquiry_edit->RightColumnClass ?>"><div<?php echo $inb_new_vehicle_enquiry->selectedType->CellAttributes() ?>>
...
<?php if ($inb_new_vehicle_enquiry->dateCreated->Visible) { // dateCreated ?>
	<div id="r_dateCreated" class="form-group">
		<label id="elh_inb_new_vehicle_enquiry_dateCreated" for="x_dateCreated" class="<?php echo $inb_new_vehicle_enquiry_edit->LeftColumnClass ?>"><?php echo $inb_new_vehicle_enquiry->dateCreated->FldCaption() ?></label>
		<div class="<?php echo $inb_new_vehicle_enquiry_edit->RightColumnClass ?>"><div<?php echo $inb_new_vehicle_enquiry->dateCreated->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $inb_new_vehicle_enquiry_edit->MultiPages->PageStyle("2") ?>" id="tab_inb_new_vehicle_enquiry2"><!-- multi-page .tab-pane -->
<div class="ewEditDiv"><!-- page* -->
<?php if ($inb_new_vehicle_enquiry->individualFirstName->Visible) { // individualFirstName ?>
	<div id="r_individualFirstName" class="form-group">
		<label id="elh_inb_new_vehicle_enquiry_individualFirstName" for="x_individualFirstName" class="<?php echo $inb_new_vehicle_enquiry_edit->LeftColumnClass ?>"><?php echo $inb_new_vehicle_enquiry->individualFirstName->FldCaption() ?></label>
		<div class="<?php echo $inb_new_vehicle_enquiry_edit->RightColumnClass ?>"><div<?php echo $inb_new_vehicle_enquiry->individualFirstName->CellAttributes() ?>>
...
<?php if ($inb_new_vehicle_enquiry->individualLastName->Visible) { // individualLastName ?>
	<div id="r_individualLastName" class="form-group">
		<label id="elh_inb_new_vehicle_enquiry_individualLastName" for="x_individualLastName" class="<?php echo $inb_new_vehicle_enquiry_edit->LeftColumnClass ?>"><?php echo $inb_new_vehicle_enquiry->individualLastName->FldCaption() ?></label>
		<div class="<?php echo $inb_new_vehicle_enquiry_edit->RightColumnClass ?>"><div<?php echo $inb_new_vehicle_enquiry->individualLastName->CellAttributes() ?>>
...
<?php if ($inb_new_vehicle_enquiry->individualVehicle->Visible) { // individualVehicle ?>
	<div id="r_individualVehicle" class="form-group">
		<label id="elh_inb_new_vehicle_enquiry_individualVehicle" for="x_individualVehicle" class="<?php echo $inb_new_vehicle_enquiry_edit->LeftColumnClass ?>"><?php echo $inb_new_vehicle_enquiry->individualVehicle->FldCaption() ?></label>
		<div class="<?php echo $inb_new_vehicle_enquiry_edit->RightColumnClass ?>"><div<?php echo $inb_new_vehicle_enquiry->individualVehicle->CellAttributes() ?>>
...
<?php if ($inb_new_vehicle_enquiry->_email->Visible) { // email ?>
	<div id="r__email" class="form-group">
		<label id="elh_inb_new_vehicle_enquiry__email" for="x__email" class="<?php echo $inb_new_vehicle_enquiry_edit->LeftColumnClass ?>"><?php echo $inb_new_vehicle_enquiry->_email->FldCaption() ?></label>
		<div class="<?php echo $inb_new_vehicle_enquiry_edit->RightColumnClass ?>"><div<?php echo $inb_new_vehicle_enquiry->_email->CellAttributes() ?>>
...
<?php if ($inb_new_vehicle_enquiry->phone->Visible) { // phone ?>
	<div id="r_phone" class="form-group">
		<label id="elh_inb_new_vehicle_enquiry_phone" for="x_phone" class="<?php echo $inb_new_vehicle_enquiry_edit->LeftColumnClass ?>"><?php echo $inb_new_vehicle_enquiry->phone->FldCaption() ?></label>
		<div class="<?php echo $inb_new_vehicle_enquiry_edit->RightColumnClass ?>"><div<?php echo $inb_new_vehicle_enquiry->phone->CellAttributes() ?>>
...
<?php if ($inb_new_vehicle_enquiry->country->Visible) { // country ?>
	<div id="r_country" class="form-group">
		<label id="elh_inb_new_vehicle_enquiry_country" for="x_country" class="<?php echo $inb_new_vehicle_enquiry_edit->LeftColumnClass ?>"><?php echo $inb_new_vehicle_enquiry->country->FldCaption() ?></label>
		<div class="<?php echo $inb_new_vehicle_enquiry_edit->RightColumnClass ?>"><div<?php echo $inb_new_vehicle_enquiry->country->CellAttributes() ?>>
...
<?php if ($inb_new_vehicle_enquiry->city->Visible) { // city ?>
	<div id="r_city" class="form-group">
		<label id="elh_inb_new_vehicle_enquiry_city" for="x_city" class="<?php echo $inb_new_vehicle_enquiry_edit->LeftColumnClass ?>"><?php echo $inb_new_vehicle_enquiry->city->FldCaption() ?></label>
		<div class="<?php echo $inb_new_vehicle_enquiry_edit->RightColumnClass ?>"><div<?php echo $inb_new_vehicle_enquiry->city->CellAttributes() ?>>
...
<?php if ($inb_new_vehicle_enquiry->individualSpecificRequirement->Visible) { // individualSpecificRequirement ?>
	<div id="r_individualSpecificRequirement" class="form-group">
		<label id="elh_inb_new_vehicle_enquiry_individualSpecificRequirement" for="x_individualSpecificRequirement" class="<?php echo $inb_new_vehicle_enquiry_edit->LeftColumnClass ?>"><?php echo $inb_new_vehicle_enquiry->individualSpecificRequirement->FldCaption() ?></label>
		<div class="<?php echo $inb_new_vehicle_enquiry_edit->RightColumnClass ?>"><div<?php echo $inb_new_vehicle_enquiry->individualSpecificRequirement->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $inb_new_vehicle_enquiry_edit->MultiPages->PageStyle("3") ?>" id="tab_inb_new_vehicle_enquiry3"><!-- multi-page .tab-pane -->
<div class="ewEditDiv"><!-- page* -->
<?php if ($inb_new_vehicle_enquiry->corporateCompanyName->Visible) { // corporateCompanyName ?>
	<div id="r_corporateCompanyName" class="form-group">
		<label id="elh_inb_new_vehicle_enquiry_corporateCompanyName" for="x_corporateCompanyName" class="<?php echo $inb_new_vehicle_enquiry_edit->LeftColumnClass ?>"><?php echo $inb_new_vehicle_enquiry->corporateCompanyName->FldCaption() ?></label>
		<div class="<?php echo $inb_new_vehicle_enquiry_edit->RightColumnClass ?>"><div<?php echo $inb_new_vehicle_enquiry->corporateCompanyName->CellAttributes() ?>>
...
<?php if ($inb_new_vehicle_enquiry->corporateFullName->Visible) { // corporateFullName ?>
	<div id="r_corporateFullName" class="form-group">
		<label id="elh_inb_new_vehicle_enquiry_corporateFullName" for="x_corporateFullName" class="<?php echo $inb_new_vehicle_enquiry_edit->LeftColumnClass ?>"><?php echo $inb_new_vehicle_enquiry->corporateFullName->FldCaption() ?></label>
		<div class="<?php echo $inb_new_vehicle_enquiry_edit->RightColumnClass ?>"><div<?php echo $inb_new_vehicle_enquiry->corporateFullName->CellAttributes() ?>>
...
<?php if ($inb_new_vehicle_enquiry->corporateVehicle->Visible) { // corporateVehicle ?>
	<div id="r_corporateVehicle" class="form-group">
		<label id="elh_inb_new_vehicle_enquiry_corporateVehicle" for="x_corporateVehicle" class="<?php echo $inb_new_vehicle_enquiry_edit->LeftColumnClass ?>"><?php echo $inb_new_vehicle_enquiry->corporateVehicle->FldCaption() ?></label>
		<div class="<?php echo $inb_new_vehicle_enquiry_edit->RightColumnClass ?>"><div<?php echo $inb_new_vehicle_enquiry->corporateVehicle->CellAttributes() ?>>
...
<?php if ($inb_new_vehicle_enquiry->corporateNoOfVehicle->Visible) { // corporateNoOfVehicle ?>
	<div id="r_corporateNoOfVehicle" class="form-group">
		<label id="elh_inb_new_vehicle_enquiry_corporateNoOfVehicle" for="x_corporateNoOfVehicle" class="<?php echo $inb_new_vehicle_enquiry_edit->LeftColumnClass ?>"><?php echo $inb_new_vehicle_enquiry->corporateNoOfVehicle->FldCaption() ?></label>
		<div class="<?php echo $inb_new_vehicle_enquiry_edit->RightColumnClass ?>"><div<?php echo $inb_new_vehicle_enquiry->corporateNoOfVehicle->CellAttributes() ?>>
...
<?php if ($inb_new_vehicle_enquiry->corporateSpecificRequirement->Visible) { // corporateSpecificRequirement ?>
	<div id="r_corporateSpecificRequirement" class="form-group">
		<label id="elh_inb_new_vehicle_enquiry_corporateSpecificRequirement" for="x_corporateSpecificRequirement" class="<?php echo $inb_new_vehicle_enquiry_edit->LeftColumnClass ?>"><?php echo $inb_new_vehicle_enquiry->corporateSpecificRequirement->FldCaption() ?></label>
		<div class="<?php echo $inb_new_vehicle_enquiry_edit->RightColumnClass ?>"><div<?php echo $inb_new_vehicle_enquiry->corporateSpecificRequirement->CellAttributes() ?>>
...
<?php if (!$inb_new_vehicle_enquiry_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $inb_new_vehicle_enquiry_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $inb_new_vehicle_enquiry_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
finb_new_vehicle_enquiryedit.Init();
</script>
<?php
$inb_new_vehicle_enquiry_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$inb_new_vehicle_enquiry_edit->Page_Terminate();
?>
