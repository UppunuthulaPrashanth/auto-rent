...
$faqs_edit = NULL; // Initialize page object first

class cfaqs_edit extends cfaqs {
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			...
			// Load key from Form
			if ($objForm->HasValue("x_faqID")) {
				$this->faqID->setFormValue($objForm->GetValue("x_faqID"));
			}
		} else {
	...
	function RestoreFormValues() {
		global $objForm;
		$this->faqID->CurrentValue = $this->faqID->FormValue;
	...
	function RenderRow() {
		...
		$this->active->ViewCustomAttributes = "";
			...
			// faqID
			$this->faqID->EditAttrs["class"] = "form-control";
			$this->faqID->EditCustomAttributes = "";
			$this->faqID->EditValue = $this->faqID->CurrentValue;
			$this->faqID->ViewCustomAttributes = "";
...
// Create page object
if (!isset($faqs_edit)) $faqs_edit = new cfaqs_edit();
...
var CurrentForm = ffaqsedit = new ew_Form("ffaqsedit", "edit");

// Validate form
ffaqsedit.Validate = function() {
...
ffaqsedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ffaqsedit.Lists["x_active"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ffaqsedit.Lists["x_active"].Options = <?php echo json_encode($faqs_edit->active->Options()) ?>;
...
<?php $faqs_edit->ShowPageHeader(); ?>
<?php
$faqs_edit->ShowMessage();
?>
<form name="ffaqsedit" id="ffaqsedit" class="<?php echo $faqs_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($faqs_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $faqs_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="faqs">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($faqs_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($faqs->faqID->Visible) { // faqID ?>
	<div id="r_faqID" class="form-group">
		<label id="elh_faqs_faqID" class="<?php echo $faqs_edit->LeftColumnClass ?>"><?php echo $faqs->faqID->FldCaption() ?></label>
		<div class="<?php echo $faqs_edit->RightColumnClass ?>"><div<?php echo $faqs->faqID->CellAttributes() ?>>
<span id="el_faqs_faqID">
<span<?php echo $faqs->faqID->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $faqs->faqID->EditValue ?></p></span>
</span>
<input type="hidden" data-table="faqs" data-field="x_faqID" name="x_faqID" id="x_faqID" value="<?php echo ew_HtmlEncode($faqs->faqID->CurrentValue) ?>">
<?php echo $faqs->faqID->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($faqs->question->Visible) { // question ?>
	<div id="r_question" class="form-group">
		<label id="elh_faqs_question" for="x_question" class="<?php echo $faqs_edit->LeftColumnClass ?>"><?php echo $faqs->question->FldCaption() ?></label>
		<div class="<?php echo $faqs_edit->RightColumnClass ?>"><div<?php echo $faqs->question->CellAttributes() ?>>
...
<?php if ($faqs->answer->Visible) { // answer ?>
	<div id="r_answer" class="form-group">
		<label id="elh_faqs_answer" class="<?php echo $faqs_edit->LeftColumnClass ?>"><?php echo $faqs->answer->FldCaption() ?></label>
		<div class="<?php echo $faqs_edit->RightColumnClass ?>"><div<?php echo $faqs->answer->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateEditor("ffaqsedit", "x_answer", 0, 0, <?php echo ($faqs->answer->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php if ($faqs->so->Visible) { // so ?>
	<div id="r_so" class="form-group">
		<label id="elh_faqs_so" for="x_so" class="<?php echo $faqs_edit->LeftColumnClass ?>"><?php echo $faqs->so->FldCaption() ?></label>
		<div class="<?php echo $faqs_edit->RightColumnClass ?>"><div<?php echo $faqs->so->CellAttributes() ?>>
<span id="el_faqs_so">
...
<?php if ($faqs->active->Visible) { // active ?>
	<div id="r_active" class="form-group">
		<label id="elh_faqs_active" for="x_active" class="<?php echo $faqs_edit->LeftColumnClass ?>"><?php echo $faqs->active->FldCaption() ?></label>
		<div class="<?php echo $faqs_edit->RightColumnClass ?>"><div<?php echo $faqs->active->CellAttributes() ?>>
...
<?php if (!$faqs_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $faqs_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $faqs_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
