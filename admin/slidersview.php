...
<?php if ($sliders->subTitle->Visible) { // subTitle ?>
	<tr id="r_subTitle">
		<td class="col-sm-2"><span id="elh_sliders_subTitle"><?php echo $sliders->subTitle->FldCaption() ?></span></td>
		<td data-name="subTitle"<?php echo $sliders->subTitle->CellAttributes() ?>>
<span id="el_sliders_subTitle">
<span<?php echo $sliders->subTitle->ViewAttributes() ?>>
<?php echo $sliders->subTitle->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($sliders->linkLabel->Visible) { // linkLabel ?>
	<tr id="r_linkLabel">
		<td class="col-sm-2"><span id="elh_sliders_linkLabel"><?php echo $sliders->linkLabel->FldCaption() ?></span></td>
		<td data-name="linkLabel"<?php echo $sliders->linkLabel->CellAttributes() ?>>
<span id="el_sliders_linkLabel">
<span<?php echo $sliders->linkLabel->ViewAttributes() ?>>
<?php echo $sliders->linkLabel->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($sliders->linkTo->Visible) { // linkTo ?>
	<tr id="r_linkTo">
		<td class="col-sm-2"><span id="elh_sliders_linkTo"><?php echo $sliders->linkTo->FldCaption() ?></span></td>
		<td data-name="linkTo"<?php echo $sliders->linkTo->CellAttributes() ?>>
<span id="el_sliders_linkTo">
<span<?php echo $sliders->linkTo->ViewAttributes() ?>>
<?php echo $sliders->linkTo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
