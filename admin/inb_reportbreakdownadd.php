...
$inb_reportbreakdown_add = NULL; // Initialize page object first

class cinb_reportbreakdown_add extends cinb_reportbreakdown {
	...
	// Page object name
	var $PageObjName = 'inb_reportbreakdown_add';
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["reportBreakdownID"] != "") {
				$this->reportBreakdownID->setQueryStringValue($_GET["reportBreakdownID"]);
				$this->setKey("reportBreakdownID", $this->reportBreakdownID->CurrentValue); // Set up key
			} else {
				$this->setKey("reportBreakdownID", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "inb_reportbreakdownview.php")
	...
	function LoadDefaultValues() {
		...
		$this->reportBreakdownID->OldValue = $this->reportBreakdownID->CurrentValue;
		...
		$this->bookingReferenceNumber->CurrentValue = NULL;
		$this->bookingReferenceNumber->OldValue = $this->bookingReferenceNumber->CurrentValue;
		$this->breakdownLocation->CurrentValue = NULL;
		$this->breakdownLocation->OldValue = $this->breakdownLocation->CurrentValue;
		$this->causeForBreakdown->CurrentValue = NULL;
		$this->causeForBreakdown->OldValue = $this->causeForBreakdown->CurrentValue;
	...
	function NewRow() {
		...
		$row = array();
		$row['reportBreakdownID'] = $this->reportBreakdownID->CurrentValue;
		...
		$row['bookingReferenceNumber'] = $this->bookingReferenceNumber->CurrentValue;
		$row['breakdownLocation'] = $this->breakdownLocation->CurrentValue;
		$row['causeForBreakdown'] = $this->causeForBreakdown->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// bookingReferenceNumber
		$this->bookingReferenceNumber->SetDbValueDef($rsnew, $this->bookingReferenceNumber->CurrentValue, NULL, FALSE);

		// breakdownLocation
		$this->breakdownLocation->SetDbValueDef($rsnew, $this->breakdownLocation->CurrentValue, NULL, FALSE);

		// causeForBreakdown
		$this->causeForBreakdown->SetDbValueDef($rsnew, $this->causeForBreakdown->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($inb_reportbreakdown_add)) $inb_reportbreakdown_add = new cinb_reportbreakdown_add();

// Page init
$inb_reportbreakdown_add->Page_Init();

// Page main
$inb_reportbreakdown_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$inb_reportbreakdown_add->Page_Render();
?>
...
var CurrentForm = finb_reportbreakdownadd = new ew_Form("finb_reportbreakdownadd", "add");

// Validate form
finb_reportbreakdownadd.Validate = function() {
...
finb_reportbreakdownadd.Form_CustomValidate = 
...
finb_reportbreakdownadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $inb_reportbreakdown_add->ShowPageHeader(); ?>
<?php
$inb_reportbreakdown_add->ShowMessage();
?>
<form name="finb_reportbreakdownadd" id="finb_reportbreakdownadd" class="<?php echo $inb_reportbreakdown_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($inb_reportbreakdown_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $inb_reportbreakdown_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="inb_reportbreakdown">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($inb_reportbreakdown_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($inb_reportbreakdown->firstName->Visible) { // firstName ?>
	<div id="r_firstName" class="form-group">
		<label id="elh_inb_reportbreakdown_firstName" for="x_firstName" class="<?php echo $inb_reportbreakdown_add->LeftColumnClass ?>"><?php echo $inb_reportbreakdown->firstName->FldCaption() ?></label>
		<div class="<?php echo $inb_reportbreakdown_add->RightColumnClass ?>"><div<?php echo $inb_reportbreakdown->firstName->CellAttributes() ?>>
...
<?php if ($inb_reportbreakdown->lastName->Visible) { // lastName ?>
	<div id="r_lastName" class="form-group">
		<label id="elh_inb_reportbreakdown_lastName" for="x_lastName" class="<?php echo $inb_reportbreakdown_add->LeftColumnClass ?>"><?php echo $inb_reportbreakdown->lastName->FldCaption() ?></label>
		<div class="<?php echo $inb_reportbreakdown_add->RightColumnClass ?>"><div<?php echo $inb_reportbreakdown->lastName->CellAttributes() ?>>
...
<?php if ($inb_reportbreakdown->emailAddress->Visible) { // emailAddress ?>
	<div id="r_emailAddress" class="form-group">
		<label id="elh_inb_reportbreakdown_emailAddress" for="x_emailAddress" class="<?php echo $inb_reportbreakdown_add->LeftColumnClass ?>"><?php echo $inb_reportbreakdown->emailAddress->FldCaption() ?></label>
		<div class="<?php echo $inb_reportbreakdown_add->RightColumnClass ?>"><div<?php echo $inb_reportbreakdown->emailAddress->CellAttributes() ?>>
...
<?php if ($inb_reportbreakdown->phoneNumber->Visible) { // phoneNumber ?>
	<div id="r_phoneNumber" class="form-group">
		<label id="elh_inb_reportbreakdown_phoneNumber" for="x_phoneNumber" class="<?php echo $inb_reportbreakdown_add->LeftColumnClass ?>"><?php echo $inb_reportbreakdown->phoneNumber->FldCaption() ?></label>
		<div class="<?php echo $inb_reportbreakdown_add->RightColumnClass ?>"><div<?php echo $inb_reportbreakdown->phoneNumber->CellAttributes() ?>>
...
<?php if ($inb_reportbreakdown->bookingReferenceNumber->Visible) { // bookingReferenceNumber ?>
	<div id="r_bookingReferenceNumber" class="form-group">
		<label id="elh_inb_reportbreakdown_bookingReferenceNumber" for="x_bookingReferenceNumber" class="<?php echo $inb_reportbreakdown_add->LeftColumnClass ?>"><?php echo $inb_reportbreakdown->bookingReferenceNumber->FldCaption() ?></label>
		<div class="<?php echo $inb_reportbreakdown_add->RightColumnClass ?>"><div<?php echo $inb_reportbreakdown->bookingReferenceNumber->CellAttributes() ?>>
...
<?php if ($inb_reportbreakdown->breakdownLocation->Visible) { // breakdownLocation ?>
	<div id="r_breakdownLocation" class="form-group">
		<label id="elh_inb_reportbreakdown_breakdownLocation" for="x_breakdownLocation" class="<?php echo $inb_reportbreakdown_add->LeftColumnClass ?>"><?php echo $inb_reportbreakdown->breakdownLocation->FldCaption() ?></label>
		<div class="<?php echo $inb_reportbreakdown_add->RightColumnClass ?>"><div<?php echo $inb_reportbreakdown->breakdownLocation->CellAttributes() ?>>
...
<?php if ($inb_reportbreakdown->causeForBreakdown->Visible) { // causeForBreakdown ?>
	<div id="r_causeForBreakdown" class="form-group">
		<label id="elh_inb_reportbreakdown_causeForBreakdown" class="<?php echo $inb_reportbreakdown_add->LeftColumnClass ?>"><?php echo $inb_reportbreakdown->causeForBreakdown->FldCaption() ?></label>
		<div class="<?php echo $inb_reportbreakdown_add->RightColumnClass ?>"><div<?php echo $inb_reportbreakdown->causeForBreakdown->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateEditor("finb_reportbreakdownadd", "x_causeForBreakdown", 0, 0, <?php echo ($inb_reportbreakdown->causeForBreakdown->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php if ($inb_reportbreakdown->dateCreated->Visible) { // dateCreated ?>
	<div id="r_dateCreated" class="form-group">
		<label id="elh_inb_reportbreakdown_dateCreated" for="x_dateCreated" class="<?php echo $inb_reportbreakdown_add->LeftColumnClass ?>"><?php echo $inb_reportbreakdown->dateCreated->FldCaption() ?></label>
		<div class="<?php echo $inb_reportbreakdown_add->RightColumnClass ?>"><div<?php echo $inb_reportbreakdown->dateCreated->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("finb_reportbreakdownadd", "x_dateCreated", {"ignoreReadonly":true,"useCurrent":false,"format":7});
</script>
<?php } ?>
</span>
...
<?php if (!$inb_reportbreakdown_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $inb_reportbreakdown_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $inb_reportbreakdown_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
finb_reportbreakdownadd.Init();
</script>
<?php
$inb_reportbreakdown_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$inb_reportbreakdown_add->Page_Terminate();
?>
