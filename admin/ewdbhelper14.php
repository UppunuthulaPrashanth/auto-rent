...
class cgravityalpha_autorent_db extends cDbHelper {

	// Database connection info
	var $Host = 'beta-space.com';
	var $Port = 3306;
	var $Username = 'gravityalpha';
	var $Password = 'GravityAlpha2021@)@!';
	var $DbName = 'gravityalpha_autorent';
