	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			if (elm && !ew_CheckEuroDate(elm.value))
				return this.OnError(elm, "<?php echo ew_JsEncode2($inb_contactus->dateCreated->FldErrMsg()) ?>");
...
<?php if ($inb_contactus->fullname->Visible) { // fullname ?>
	<div id="r_fullname" class="form-group">
		<label id="elh_inb_contactus_fullname" for="x_fullname" class="<?php echo $inb_contactus_edit->LeftColumnClass ?>"><?php echo $inb_contactus->fullname->FldCaption() ?></label>
		<div class="<?php echo $inb_contactus_edit->RightColumnClass ?>"><div<?php echo $inb_contactus->fullname->CellAttributes() ?>>
<span id="el_inb_contactus_fullname">
<input type="text" data-table="inb_contactus" data-field="x_fullname" name="x_fullname" id="x_fullname" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($inb_contactus->fullname->getPlaceHolder()) ?>" value="<?php echo $inb_contactus->fullname->EditValue ?>"<?php echo $inb_contactus->fullname->EditAttributes() ?>>
</span>
<?php echo $inb_contactus->fullname->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<?php if ($inb_contactus->address->Visible) { // address ?>
	<div id="r_address" class="form-group">
		<label id="elh_inb_contactus_address" for="x_address" class="<?php echo $inb_contactus_edit->LeftColumnClass ?>"><?php echo $inb_contactus->address->FldCaption() ?></label>
		<div class="<?php echo $inb_contactus_edit->RightColumnClass ?>"><div<?php echo $inb_contactus->address->CellAttributes() ?>>
<span id="el_inb_contactus_address">
<input type="text" data-table="inb_contactus" data-field="x_address" name="x_address" id="x_address" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($inb_contactus->address->getPlaceHolder()) ?>" value="<?php echo $inb_contactus->address->EditValue ?>"<?php echo $inb_contactus->address->EditAttributes() ?>>
</span>
<?php echo $inb_contactus->address->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<?php if ($inb_contactus->dateCreated->Visible) { // dateCreated ?>
	<div id="r_dateCreated" class="form-group">
		<label id="elh_inb_contactus_dateCreated" for="x_dateCreated" class="<?php echo $inb_contactus_edit->LeftColumnClass ?>"><?php echo $inb_contactus->dateCreated->FldCaption() ?></label>
		<div class="<?php echo $inb_contactus_edit->RightColumnClass ?>"><div<?php echo $inb_contactus->dateCreated->CellAttributes() ?>>
<span id="el_inb_contactus_dateCreated">
<input type="text" data-table="inb_contactus" data-field="x_dateCreated" data-format="7" name="x_dateCreated" id="x_dateCreated" placeholder="<?php echo ew_HtmlEncode($inb_contactus->dateCreated->getPlaceHolder()) ?>" value="<?php echo $inb_contactus->dateCreated->EditValue ?>"<?php echo $inb_contactus->dateCreated->EditAttributes() ?>>
<?php if (!$inb_contactus->dateCreated->ReadOnly && !$inb_contactus->dateCreated->Disabled && !isset($inb_contactus->dateCreated->EditAttrs["readonly"]) && !isset($inb_contactus->dateCreated->EditAttrs["disabled"])) { ?>
<script type="text/javascript">
ew_CreateDateTimePicker("finb_contactusedit", "x_dateCreated", {"ignoreReadonly":true,"useCurrent":false,"format":7});
</script>
<?php } ?>
</span>
<?php echo $inb_contactus->dateCreated->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div><!-- /page* -->
