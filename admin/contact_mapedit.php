...
class ccontact_map_edit extends ccontact_map {
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			...
			// Load key from Form
			if ($objForm->HasValue("x_contactID")) {
				$this->contactID->setFormValue($objForm->GetValue("x_contactID"));
			}
		} else {
	...
	function LoadFormValues() {
		...
		// Load from form
		global $objForm;
		if (!$this->contactID->FldIsDetailKey)
			$this->contactID->setFormValue($objForm->GetValue("x_contactID"));
...
var CurrentForm = fcontact_mapedit = new ew_Form("fcontact_mapedit", "edit");
...
fcontact_mapedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fcontact_mapedit.Lists["x_active"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fcontact_mapedit.Lists["x_active"].Options = <?php echo json_encode($contact_map_edit->active->Options()) ?>;
...
?>
<form name="fcontact_mapedit" id="fcontact_mapedit" class="<?php echo $contact_map_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($contact_map_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $contact_map_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="contact_map">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($contact_map_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($contact_map->contactID->Visible) { // contactID ?>
	<div id="r_contactID" class="form-group">
		<label id="elh_contact_map_contactID" class="<?php echo $contact_map_edit->LeftColumnClass ?>"><?php echo $contact_map->contactID->FldCaption() ?></label>
		<div class="<?php echo $contact_map_edit->RightColumnClass ?>"><div<?php echo $contact_map->contactID->CellAttributes() ?>>
<span id="el_contact_map_contactID">
<span<?php echo $contact_map->contactID->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $contact_map->contactID->EditValue ?></p></span>
</span>
<input type="hidden" data-table="contact_map" data-field="x_contactID" name="x_contactID" id="x_contactID" value="<?php echo ew_HtmlEncode($contact_map->contactID->CurrentValue) ?>">
<?php echo $contact_map->contactID->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($contact_map->title->Visible) { // title ?>
	<div id="r_title" class="form-group">
		<label id="elh_contact_map_title" for="x_title" class="<?php echo $contact_map_edit->LeftColumnClass ?>"><?php echo $contact_map->title->FldCaption() ?></label>
		<div class="<?php echo $contact_map_edit->RightColumnClass ?>"><div<?php echo $contact_map->title->CellAttributes() ?>>
...
<?php if ($contact_map->phone->Visible) { // phone ?>
	<div id="r_phone" class="form-group">
		<label id="elh_contact_map_phone" for="x_phone" class="<?php echo $contact_map_edit->LeftColumnClass ?>"><?php echo $contact_map->phone->FldCaption() ?></label>
		<div class="<?php echo $contact_map_edit->RightColumnClass ?>"><div<?php echo $contact_map->phone->CellAttributes() ?>>
...
<?php if ($contact_map->fax->Visible) { // fax ?>
	<div id="r_fax" class="form-group">
		<label id="elh_contact_map_fax" for="x_fax" class="<?php echo $contact_map_edit->LeftColumnClass ?>"><?php echo $contact_map->fax->FldCaption() ?></label>
		<div class="<?php echo $contact_map_edit->RightColumnClass ?>"><div<?php echo $contact_map->fax->CellAttributes() ?>>
...
<?php if ($contact_map->_email->Visible) { // email ?>
	<div id="r__email" class="form-group">
		<label id="elh_contact_map__email" for="x__email" class="<?php echo $contact_map_edit->LeftColumnClass ?>"><?php echo $contact_map->_email->FldCaption() ?></label>
		<div class="<?php echo $contact_map_edit->RightColumnClass ?>"><div<?php echo $contact_map->_email->CellAttributes() ?>>
...
<?php if ($contact_map->map->Visible) { // map ?>
	<div id="r_map" class="form-group">
		<label id="elh_contact_map_map" for="x_map" class="<?php echo $contact_map_edit->LeftColumnClass ?>"><?php echo $contact_map->map->FldCaption() ?></label>
		<div class="<?php echo $contact_map_edit->RightColumnClass ?>"><div<?php echo $contact_map->map->CellAttributes() ?>>
...
<?php if ($contact_map->so->Visible) { // so ?>
	<div id="r_so" class="form-group">
		<label id="elh_contact_map_so" for="x_so" class="<?php echo $contact_map_edit->LeftColumnClass ?>"><?php echo $contact_map->so->FldCaption() ?></label>
		<div class="<?php echo $contact_map_edit->RightColumnClass ?>"><div<?php echo $contact_map->so->CellAttributes() ?>>
...
<?php if ($contact_map->active->Visible) { // active ?>
	<div id="r_active" class="form-group">
		<label id="elh_contact_map_active" for="x_active" class="<?php echo $contact_map_edit->LeftColumnClass ?>"><?php echo $contact_map->active->FldCaption() ?></label>
		<div class="<?php echo $contact_map_edit->RightColumnClass ?>"><div<?php echo $contact_map->active->CellAttributes() ?>>
...
<?php if (!$contact_map_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $contact_map_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $contact_map_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
