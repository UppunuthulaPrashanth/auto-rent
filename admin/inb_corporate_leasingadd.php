...
$inb_corporate_leasing_add = NULL; // Initialize page object first

class cinb_corporate_leasing_add extends cinb_corporate_leasing {
	...
	// Page object name
	var $PageObjName = 'inb_corporate_leasing_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "inb_corporate_leasingview.php")
...
// Create page object
if (!isset($inb_corporate_leasing_add)) $inb_corporate_leasing_add = new cinb_corporate_leasing_add();

// Page init
$inb_corporate_leasing_add->Page_Init();

// Page main
$inb_corporate_leasing_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$inb_corporate_leasing_add->Page_Render();
?>
...
var CurrentForm = finb_corporate_leasingadd = new ew_Form("finb_corporate_leasingadd", "add");

// Validate form
finb_corporate_leasingadd.Validate = function() {
...
finb_corporate_leasingadd.Form_CustomValidate = 
...
finb_corporate_leasingadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
finb_corporate_leasingadd.Lists["x_vehicleCategory[]"] = {"LinkField":"x_bodyTypeID","Ajax":true,"AutoFill":false,"DisplayFields":["x_bodytype","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"mtr_bodytype"};
finb_corporate_leasingadd.Lists["x_vehicleCategory[]"].Data = "<?php echo $inb_corporate_leasing_add->vehicleCategory->LookupFilterQuery(FALSE, "add") ?>";
...
<?php $inb_corporate_leasing_add->ShowPageHeader(); ?>
<?php
$inb_corporate_leasing_add->ShowMessage();
?>
<form name="finb_corporate_leasingadd" id="finb_corporate_leasingadd" class="<?php echo $inb_corporate_leasing_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($inb_corporate_leasing_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $inb_corporate_leasing_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="inb_corporate_leasing">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($inb_corporate_leasing_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($inb_corporate_leasing->fullname->Visible) { // fullname ?>
	<div id="r_fullname" class="form-group">
		<label id="elh_inb_corporate_leasing_fullname" for="x_fullname" class="<?php echo $inb_corporate_leasing_add->LeftColumnClass ?>"><?php echo $inb_corporate_leasing->fullname->FldCaption() ?></label>
		<div class="<?php echo $inb_corporate_leasing_add->RightColumnClass ?>"><div<?php echo $inb_corporate_leasing->fullname->CellAttributes() ?>>
...
<?php if ($inb_corporate_leasing->companyName->Visible) { // companyName ?>
	<div id="r_companyName" class="form-group">
		<label id="elh_inb_corporate_leasing_companyName" for="x_companyName" class="<?php echo $inb_corporate_leasing_add->LeftColumnClass ?>"><?php echo $inb_corporate_leasing->companyName->FldCaption() ?></label>
		<div class="<?php echo $inb_corporate_leasing_add->RightColumnClass ?>"><div<?php echo $inb_corporate_leasing->companyName->CellAttributes() ?>>
...
<?php if ($inb_corporate_leasing->_email->Visible) { // email ?>
	<div id="r__email" class="form-group">
		<label id="elh_inb_corporate_leasing__email" for="x__email" class="<?php echo $inb_corporate_leasing_add->LeftColumnClass ?>"><?php echo $inb_corporate_leasing->_email->FldCaption() ?></label>
		<div class="<?php echo $inb_corporate_leasing_add->RightColumnClass ?>"><div<?php echo $inb_corporate_leasing->_email->CellAttributes() ?>>
...
<?php if ($inb_corporate_leasing->phone->Visible) { // phone ?>
	<div id="r_phone" class="form-group">
		<label id="elh_inb_corporate_leasing_phone" for="x_phone" class="<?php echo $inb_corporate_leasing_add->LeftColumnClass ?>"><?php echo $inb_corporate_leasing->phone->FldCaption() ?></label>
		<div class="<?php echo $inb_corporate_leasing_add->RightColumnClass ?>"><div<?php echo $inb_corporate_leasing->phone->CellAttributes() ?>>
...
<?php if ($inb_corporate_leasing->vehicleInterestedIn->Visible) { // vehicleInterestedIn ?>
	<div id="r_vehicleInterestedIn" class="form-group">
		<label id="elh_inb_corporate_leasing_vehicleInterestedIn" for="x_vehicleInterestedIn" class="<?php echo $inb_corporate_leasing_add->LeftColumnClass ?>"><?php echo $inb_corporate_leasing->vehicleInterestedIn->FldCaption() ?></label>
		<div class="<?php echo $inb_corporate_leasing_add->RightColumnClass ?>"><div<?php echo $inb_corporate_leasing->vehicleInterestedIn->CellAttributes() ?>>
...
<?php if ($inb_corporate_leasing->noOfVehicles->Visible) { // noOfVehicles ?>
	<div id="r_noOfVehicles" class="form-group">
		<label id="elh_inb_corporate_leasing_noOfVehicles" for="x_noOfVehicles" class="<?php echo $inb_corporate_leasing_add->LeftColumnClass ?>"><?php echo $inb_corporate_leasing->noOfVehicles->FldCaption() ?></label>
		<div class="<?php echo $inb_corporate_leasing_add->RightColumnClass ?>"><div<?php echo $inb_corporate_leasing->noOfVehicles->CellAttributes() ?>>
...
<?php if ($inb_corporate_leasing->vehicleCategory->Visible) { // vehicleCategory ?>
	<div id="r_vehicleCategory" class="form-group">
		<label id="elh_inb_corporate_leasing_vehicleCategory" class="<?php echo $inb_corporate_leasing_add->LeftColumnClass ?>"><?php echo $inb_corporate_leasing->vehicleCategory->FldCaption() ?></label>
		<div class="<?php echo $inb_corporate_leasing_add->RightColumnClass ?>"><div<?php echo $inb_corporate_leasing->vehicleCategory->CellAttributes() ?>>
...
<?php if ($inb_corporate_leasing->specificRequirement->Visible) { // specificRequirement ?>
	<div id="r_specificRequirement" class="form-group">
		<label id="elh_inb_corporate_leasing_specificRequirement" class="<?php echo $inb_corporate_leasing_add->LeftColumnClass ?>"><?php echo $inb_corporate_leasing->specificRequirement->FldCaption() ?></label>
		<div class="<?php echo $inb_corporate_leasing_add->RightColumnClass ?>"><div<?php echo $inb_corporate_leasing->specificRequirement->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateEditor("finb_corporate_leasingadd", "x_specificRequirement", 35, 4, <?php echo ($inb_corporate_leasing->specificRequirement->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php if ($inb_corporate_leasing->dateCreated->Visible) { // dateCreated ?>
	<div id="r_dateCreated" class="form-group">
		<label id="elh_inb_corporate_leasing_dateCreated" for="x_dateCreated" class="<?php echo $inb_corporate_leasing_add->LeftColumnClass ?>"><?php echo $inb_corporate_leasing->dateCreated->FldCaption() ?></label>
		<div class="<?php echo $inb_corporate_leasing_add->RightColumnClass ?>"><div<?php echo $inb_corporate_leasing->dateCreated->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("finb_corporate_leasingadd", "x_dateCreated", {"ignoreReadonly":true,"useCurrent":false,"format":7});
</script>
<?php } ?>
</span>
...
<?php if (!$inb_corporate_leasing_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $inb_corporate_leasing_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $inb_corporate_leasing_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
finb_corporate_leasingadd.Init();
</script>
<?php
$inb_corporate_leasing_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$inb_corporate_leasing_add->Page_Terminate();
?>
