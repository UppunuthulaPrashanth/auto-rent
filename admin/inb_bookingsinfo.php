...
//
// Table class for inb_bookings
//
class cinb_bookings extends cTable {
	var $bookingID;
	var $bookingNumber;
	var $_userID;
	var $rentLeaseCarID;
	...
	function __construct() {
		...
		$this->TableVar = 'inb_bookings';
		$this->TableName = 'inb_bookings';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`inb_bookings`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// bookingID
		$this->bookingID = new cField('inb_bookings', 'inb_bookings', 'x_bookingID', 'bookingID', '`bookingID`', '`bookingID`', 3, -1, FALSE, '`bookingID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// bookingNumber
		$this->bookingNumber = new cField('inb_bookings', 'inb_bookings', 'x_bookingNumber', 'bookingNumber', '`bookingNumber`', '`bookingNumber`', 19, -1, FALSE, '`bookingNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// userID
		$this->_userID = new cField('inb_bookings', 'inb_bookings', 'x__userID', 'userID', '`userID`', '`userID`', 3, -1, FALSE, '`userID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// rentLeaseCarID
		$this->rentLeaseCarID = new cField('inb_bookings', 'inb_bookings', 'x_rentLeaseCarID', 'rentLeaseCarID', '`rentLeaseCarID`', '`rentLeaseCarID`', 3, -1, FALSE, '`rentLeaseCarID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->rentLeaseCarID->Sortable = TRUE; // Allow sort
		$this->rentLeaseCarID->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->rentLeaseCarID->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->rentLeaseCarID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['rentLeaseCarID'] = &$this->rentLeaseCarID;

		// pickUpLocation
		$this->pickUpLocation = new cField('inb_bookings', 'inb_bookings', 'x_pickUpLocation', 'pickUpLocation', '`pickUpLocation`', '`pickUpLocation`', 3, -1, FALSE, '`pickUpLocation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// dropLocation
		$this->dropLocation = new cField('inb_bookings', 'inb_bookings', 'x_dropLocation', 'dropLocation', '`dropLocation`', '`dropLocation`', 3, -1, FALSE, '`dropLocation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// pickUpDate
		$this->pickUpDate = new cField('inb_bookings', 'inb_bookings', 'x_pickUpDate', 'pickUpDate', '`pickUpDate`', ew_CastDateFieldForLike('`pickUpDate`', 7, "DB"), 135, 7, FALSE, '`pickUpDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->pickUpDate->Sortable = TRUE; // Allow sort
		$this->fields['pickUpDate'] = &$this->pickUpDate;

		// dropDate
		$this->dropDate = new cField('inb_bookings', 'inb_bookings', 'x_dropDate', 'dropDate', '`dropDate`', ew_CastDateFieldForLike('`dropDate`', 7, "DB"), 135, 7, FALSE, '`dropDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->dropDate->Sortable = TRUE; // Allow sort
		$this->fields['dropDate'] = &$this->dropDate;

		// noOfDays
		$this->noOfDays = new cField('inb_bookings', 'inb_bookings', 'x_noOfDays', 'noOfDays', '`noOfDays`', '`noOfDays`', 3, -1, FALSE, '`noOfDays`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// bookingTerm
		$this->bookingTerm = new cField('inb_bookings', 'inb_bookings', 'x_bookingTerm', 'bookingTerm', '`bookingTerm`', '`bookingTerm`', 200, -1, FALSE, '`bookingTerm`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->bookingTerm->Sortable = TRUE; // Allow sort
		$this->fields['bookingTerm'] = &$this->bookingTerm;

		// orangeCard
		$this->orangeCard = new cField('inb_bookings', 'inb_bookings', 'x_orangeCard', 'orangeCard', '`orangeCard`', '`orangeCard`', 5, -1, FALSE, '`orangeCard`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// gps
		$this->gps = new cField('inb_bookings', 'inb_bookings', 'x_gps', 'gps', '`gps`', '`gps`', 200, -1, FALSE, '`gps`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->gps->Sortable = TRUE; // Allow sort
		$this->fields['gps'] = &$this->gps;

		// deliveryCharge
		$this->deliveryCharge = new cField('inb_bookings', 'inb_bookings', 'x_deliveryCharge', 'deliveryCharge', '`deliveryCharge`', '`deliveryCharge`', 5, -1, FALSE, '`deliveryCharge`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// collectionCharge
		$this->collectionCharge = new cField('inb_bookings', 'inb_bookings', 'x_collectionCharge', 'collectionCharge', '`collectionCharge`', '`collectionCharge`', 5, -1, FALSE, '`collectionCharge`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// rentalAmount
		$this->rentalAmount = new cField('inb_bookings', 'inb_bookings', 'x_rentalAmount', 'rentalAmount', '`rentalAmount`', '`rentalAmount`', 5, -1, FALSE, '`rentalAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// vat
		$this->vat = new cField('inb_bookings', 'inb_bookings', 'x_vat', 'vat', '`vat`', '`vat`', 5, -1, FALSE, '`vat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->vat->Sortable = TRUE; // Allow sort
		$this->vat->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['vat'] = &$this->vat;

		// grandTotal
		$this->grandTotal = new cField('inb_bookings', 'inb_bookings', 'x_grandTotal', 'grandTotal', '`grandTotal`', '`grandTotal`', 5, -1, FALSE, '`grandTotal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// totalAmount
		$this->totalAmount = new cField('inb_bookings', 'inb_bookings', 'x_totalAmount', 'totalAmount', '`totalAmount`', '`totalAmount`', 5, -1, FALSE, '`totalAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->totalAmount->Sortable = TRUE; // Allow sort
		$this->fields['totalAmount'] = &$this->totalAmount;

		// deliveryAddress
		$this->deliveryAddress = new cField('inb_bookings', 'inb_bookings', 'x_deliveryAddress', 'deliveryAddress', '`deliveryAddress`', '`deliveryAddress`', 200, -1, FALSE, '`deliveryAddress`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->deliveryAddress->Sortable = TRUE; // Allow sort
		$this->fields['deliveryAddress'] = &$this->deliveryAddress;

		// paymentMethod
		$this->paymentMethod = new cField('inb_bookings', 'inb_bookings', 'x_paymentMethod', 'paymentMethod', '`paymentMethod`', '`paymentMethod`', 202, -1, FALSE, '`paymentMethod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		$this->paymentMethod->Sortable = TRUE; // Allow sort
		$this->paymentMethod->OptionCount = 2;
		$this->fields['paymentMethod'] = &$this->paymentMethod;

		// dateCreated
		$this->dateCreated = new cField('inb_bookings', 'inb_bookings', 'x_dateCreated', 'dateCreated', '`dateCreated`', ew_CastDateFieldForLike('`dateCreated`', 7, "DB"), 135, 7, FALSE, '`dateCreated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`inb_bookings`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "inb_bookingsedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "inb_bookingsadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("inb_bookingsview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("inb_bookingsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "inb_bookingsadd.php?" . $this->UrlParm($parm);
		else
			$url = "inb_bookingsadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("inb_bookingsedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("inb_bookingsadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("inb_bookingsdelete.php", $this->UrlParm());
	}
