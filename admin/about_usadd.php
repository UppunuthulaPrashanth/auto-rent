...
class cabout_us_add extends cabout_us {
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["aboutID"] != "") {
				...
				$this->setKey("aboutID", $this->aboutID->CurrentValue); // Set up key
			} else {
				$this->setKey("aboutID", ""); // Clear key
	...
	function LoadDefaultValues() {
		...
		$this->aboutID->OldValue = $this->aboutID->CurrentValue;
	...
	function NewRow() {
		...
		$row = array();
		$row['aboutID'] = $this->aboutID->CurrentValue;
...
fabout_usadd.Lists["x_active"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fabout_usadd.Lists["x_active"].Options = <?php echo json_encode($about_us_add->active->Options()) ?>;
...
<?php if ($about_us->title->Visible) { // title ?>
	<div id="r_title" class="form-group">
		<label id="elh_about_us_title" for="x_title" class="<?php echo $about_us_add->LeftColumnClass ?>"><?php echo $about_us->title->FldCaption() ?></label>
		<div class="<?php echo $about_us_add->RightColumnClass ?>"><div<?php echo $about_us->title->CellAttributes() ?>>
...
<?php if ($about_us->summary->Visible) { // summary ?>
	<div id="r_summary" class="form-group">
		<label id="elh_about_us_summary" for="x_summary" class="<?php echo $about_us_add->LeftColumnClass ?>"><?php echo $about_us->summary->FldCaption() ?></label>
		<div class="<?php echo $about_us_add->RightColumnClass ?>"><div<?php echo $about_us->summary->CellAttributes() ?>>
...
<?php if ($about_us->image->Visible) { // image ?>
	<div id="r_image" class="form-group">
		<label id="elh_about_us_image" class="<?php echo $about_us_add->LeftColumnClass ?>"><?php echo $about_us->image->FldCaption() ?></label>
		<div class="<?php echo $about_us_add->RightColumnClass ?>"><div<?php echo $about_us->image->CellAttributes() ?>>
...
<?php if ($about_us->so->Visible) { // so ?>
	<div id="r_so" class="form-group">
		<label id="elh_about_us_so" for="x_so" class="<?php echo $about_us_add->LeftColumnClass ?>"><?php echo $about_us->so->FldCaption() ?></label>
		<div class="<?php echo $about_us_add->RightColumnClass ?>"><div<?php echo $about_us->so->CellAttributes() ?>>
...
<?php if ($about_us->active->Visible) { // active ?>
	<div id="r_active" class="form-group">
		<label id="elh_about_us_active" for="x_active" class="<?php echo $about_us_add->LeftColumnClass ?>"><?php echo $about_us->active->FldCaption() ?></label>
		<div class="<?php echo $about_us_add->RightColumnClass ?>"><div<?php echo $about_us->active->CellAttributes() ?>>
