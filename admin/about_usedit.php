...
class cabout_us_edit extends cabout_us {
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			...
			// Load key from Form
			if ($objForm->HasValue("x_aboutID")) {
				$this->aboutID->setFormValue($objForm->GetValue("x_aboutID"));
			}
		} else {
			...
			if (isset($_GET["aboutID"])) {
				$this->aboutID->setQueryStringValue($_GET["aboutID"]);
				$loadByQuery = TRUE;
			} else {
				$this->aboutID->CurrentValue = NULL;
			}
		}
	...
	function LoadFormValues() {
		...
		if (!$this->aboutID->FldIsDetailKey)
			$this->aboutID->setFormValue($objForm->GetValue("x_aboutID"));
	...
	function RestoreFormValues() {
		global $objForm;
		$this->aboutID->CurrentValue = $this->aboutID->FormValue;
	...
	function RenderRow() {
		...
		$this->active->ViewCustomAttributes = "";
			...
			if ($this->image->UseColorbox) {
				...
				$this->image->LinkAttrs["data-rel"] = "about_us_x_image";
			...
			// aboutID
			$this->aboutID->EditAttrs["class"] = "form-control";
			$this->aboutID->EditCustomAttributes = "";
			$this->aboutID->EditValue = $this->aboutID->CurrentValue;
			$this->aboutID->ViewCustomAttributes = "";
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			if (elm && !ew_CheckInteger(elm.value))
				return this.OnError(elm, "<?php echo ew_JsEncode2($about_us->so->FldErrMsg()) ?>");
...
fabout_usedit.Lists["x_active"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fabout_usedit.Lists["x_active"].Options = <?php echo json_encode($about_us_edit->active->Options()) ?>;
...
<?php if ($about_us->aboutID->Visible) { // aboutID ?>
	<div id="r_aboutID" class="form-group">
		<label id="elh_about_us_aboutID" class="<?php echo $about_us_edit->LeftColumnClass ?>"><?php echo $about_us->aboutID->FldCaption() ?></label>
		<div class="<?php echo $about_us_edit->RightColumnClass ?>"><div<?php echo $about_us->aboutID->CellAttributes() ?>>
<span id="el_about_us_aboutID">
<span<?php echo $about_us->aboutID->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $about_us->aboutID->EditValue ?></p></span>
</span>
<input type="hidden" data-table="about_us" data-field="x_aboutID" name="x_aboutID" id="x_aboutID" value="<?php echo ew_HtmlEncode($about_us->aboutID->CurrentValue) ?>">
<?php echo $about_us->aboutID->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($about_us->title->Visible) { // title ?>
	<div id="r_title" class="form-group">
		<label id="elh_about_us_title" for="x_title" class="<?php echo $about_us_edit->LeftColumnClass ?>"><?php echo $about_us->title->FldCaption() ?></label>
		<div class="<?php echo $about_us_edit->RightColumnClass ?>"><div<?php echo $about_us->title->CellAttributes() ?>>
<span id="el_about_us_title">
<input type="text" data-table="about_us" data-field="x_title" name="x_title" id="x_title" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($about_us->title->getPlaceHolder()) ?>" value="<?php echo $about_us->title->EditValue ?>"<?php echo $about_us->title->EditAttributes() ?>>
</span>
<?php echo $about_us->title->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($about_us->summary->Visible) { // summary ?>
	<div id="r_summary" class="form-group">
		<label id="elh_about_us_summary" for="x_summary" class="<?php echo $about_us_edit->LeftColumnClass ?>"><?php echo $about_us->summary->FldCaption() ?></label>
		<div class="<?php echo $about_us_edit->RightColumnClass ?>"><div<?php echo $about_us->summary->CellAttributes() ?>>
<span id="el_about_us_summary">
<input type="text" data-table="about_us" data-field="x_summary" name="x_summary" id="x_summary" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($about_us->summary->getPlaceHolder()) ?>" value="<?php echo $about_us->summary->EditValue ?>"<?php echo $about_us->summary->EditAttributes() ?>>
</span>
<?php echo $about_us->summary->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($about_us->image->Visible) { // image ?>
	<div id="r_image" class="form-group">
		<label id="elh_about_us_image" class="<?php echo $about_us_edit->LeftColumnClass ?>"><?php echo $about_us->image->FldCaption() ?></label>
		<div class="<?php echo $about_us_edit->RightColumnClass ?>"><div<?php echo $about_us->image->CellAttributes() ?>>
<span id="el_about_us_image">
<div id="fd_x_image">
<span title="<?php echo $about_us->image->FldTitle() ? $about_us->image->FldTitle() : $Language->Phrase("ChooseFile") ?>" class="btn btn-default btn-sm fileinput-button ewTooltip<?php if ($about_us->image->ReadOnly || $about_us->image->Disabled) echo " hide"; ?>" data-trigger="hover">
	<span><?php echo $Language->Phrase("ChooseFileBtn") ?></span>
	<input type="file" title=" " data-table="about_us" data-field="x_image" name="x_image" id="x_image"<?php echo $about_us->image->EditAttributes() ?>>
</span>
<input type="hidden" name="fn_x_image" id= "fn_x_image" value="<?php echo $about_us->image->Upload->FileName ?>">
...
<input type="hidden" name="fx_x_image" id= "fx_x_image" value="<?php echo $about_us->image->UploadAllowedFileExt ?>">
<input type="hidden" name="fm_x_image" id= "fm_x_image" value="<?php echo $about_us->image->UploadMaxFileSize ?>">
</div>
<table id="ft_x_image" class="table table-condensed pull-left ewUploadTable"><tbody class="files"></tbody></table>
</span>
<?php echo $about_us->image->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($about_us->so->Visible) { // so ?>
	<div id="r_so" class="form-group">
		<label id="elh_about_us_so" for="x_so" class="<?php echo $about_us_edit->LeftColumnClass ?>"><?php echo $about_us->so->FldCaption() ?></label>
		<div class="<?php echo $about_us_edit->RightColumnClass ?>"><div<?php echo $about_us->so->CellAttributes() ?>>
<span id="el_about_us_so">
<input type="text" data-table="about_us" data-field="x_so" name="x_so" id="x_so" size="30" placeholder="<?php echo ew_HtmlEncode($about_us->so->getPlaceHolder()) ?>" value="<?php echo $about_us->so->EditValue ?>"<?php echo $about_us->so->EditAttributes() ?>>
</span>
<?php echo $about_us->so->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($about_us->active->Visible) { // active ?>
	<div id="r_active" class="form-group">
		<label id="elh_about_us_active" for="x_active" class="<?php echo $about_us_edit->LeftColumnClass ?>"><?php echo $about_us->active->FldCaption() ?></label>
		<div class="<?php echo $about_us_edit->RightColumnClass ?>"><div<?php echo $about_us->active->CellAttributes() ?>>
<span id="el_about_us_active">
<select data-table="about_us" data-field="x_active" data-value-separator="<?php echo $about_us->active->DisplayValueSeparatorAttribute() ?>" id="x_active" name="x_active"<?php echo $about_us->active->EditAttributes() ?>>
<?php echo $about_us->active->SelectOptionListHtml("x_active") ?>
</select>
</span>
<?php echo $about_us->active->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div><!-- /page* -->
