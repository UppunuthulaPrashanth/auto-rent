...
$rent_lease_cars_edit = NULL; // Initialize page object first

class crent_lease_cars_edit extends crent_lease_cars {
	...
	// Page object name
	var $PageObjName = 'rent_lease_cars_edit';
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			...
			// Load key from Form
			if ($objForm->HasValue("x_rentLeaseCarID")) {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// dailyAED
			$this->dailyAED->SetDbValueDef($rsnew, $this->dailyAED->CurrentValue, NULL, $this->dailyAED->ReadOnly);

			// dailyDummyAED
			$this->dailyDummyAED->SetDbValueDef($rsnew, $this->dailyDummyAED->CurrentValue, NULL, $this->dailyDummyAED->ReadOnly);

			// weeklyAED
			$this->weeklyAED->SetDbValueDef($rsnew, $this->weeklyAED->CurrentValue, NULL, $this->weeklyAED->ReadOnly);

			// weeklyDummyAED
			$this->weeklyDummyAED->SetDbValueDef($rsnew, $this->weeklyDummyAED->CurrentValue, NULL, $this->weeklyDummyAED->ReadOnly);

			// monthlyAED
			$this->monthlyAED->SetDbValueDef($rsnew, $this->monthlyAED->CurrentValue, NULL, $this->monthlyAED->ReadOnly);

			// monthlyDummyAED
			$this->monthlyDummyAED->SetDbValueDef($rsnew, $this->monthlyDummyAED->CurrentValue, NULL, $this->monthlyDummyAED->ReadOnly);
			...
			// weeklyDeals
			$this->weeklyDeals->SetDbValueDef($rsnew, $this->weeklyDeals->CurrentValue, NULL, $this->weeklyDeals->ReadOnly);
...
// Create page object
if (!isset($rent_lease_cars_edit)) $rent_lease_cars_edit = new crent_lease_cars_edit();

// Page init
$rent_lease_cars_edit->Page_Init();

// Page main
$rent_lease_cars_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$rent_lease_cars_edit->Page_Render();
?>
...
var CurrentForm = frent_lease_carsedit = new ew_Form("frent_lease_carsedit", "edit");

// Validate form
frent_lease_carsedit.Validate = function() {
...
frent_lease_carsedit.Form_CustomValidate = 
...
frent_lease_carsedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Multi-Page
frent_lease_carsedit.MultiPage = new ew_MultiPage("frent_lease_carsedit");

// Dynamic selection lists
frent_lease_carsedit.Lists["x_bodyTypeID"] = {"LinkField":"x_bodyTypeID","Ajax":true,"AutoFill":false,"DisplayFields":["x_bodytype","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"mtr_bodytype"};
frent_lease_carsedit.Lists["x_bodyTypeID"].Data = "<?php echo $rent_lease_cars_edit->bodyTypeID->LookupFilterQuery(FALSE, "edit") ?>";
frent_lease_carsedit.Lists["x_extraFeatures[]"] = {"LinkField":"x_featureID","Ajax":true,"AutoFill":false,"DisplayFields":["x_extraFeatures","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"mtr_extra_features"};
frent_lease_carsedit.Lists["x_extraFeatures[]"].Data = "<?php echo $rent_lease_cars_edit->extraFeatures->LookupFilterQuery(FALSE, "edit") ?>";
frent_lease_carsedit.Lists["x_transmissionID"] = {"LinkField":"x_transmissionID","Ajax":true,"AutoFill":false,"DisplayFields":["x_transmission","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"mtr_transmission"};
frent_lease_carsedit.Lists["x_transmissionID"].Data = "<?php echo $rent_lease_cars_edit->transmissionID->LookupFilterQuery(FALSE, "edit") ?>";
frent_lease_carsedit.Lists["x_ac[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
frent_lease_carsedit.Lists["x_ac[]"].Options = <?php echo json_encode($rent_lease_cars_edit->ac->Options()) ?>;
frent_lease_carsedit.Lists["x_active"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
frent_lease_carsedit.Lists["x_active"].Options = <?php echo json_encode($rent_lease_cars_edit->active->Options()) ?>;
frent_lease_carsedit.Lists["x_weeklyDeals"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
frent_lease_carsedit.Lists["x_weeklyDeals"].Options = <?php echo json_encode($rent_lease_cars_edit->weeklyDeals->Options()) ?>;
...
<?php $rent_lease_cars_edit->ShowPageHeader(); ?>
<?php
$rent_lease_cars_edit->ShowMessage();
?>
<form name="frent_lease_carsedit" id="frent_lease_carsedit" class="<?php echo $rent_lease_cars_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($rent_lease_cars_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $rent_lease_cars_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="rent_lease_cars">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($rent_lease_cars_edit->IsModal) ?>">
<div class="ewMultiPage"><!-- multi-page -->
<div class="nav-tabs-custom" id="rent_lease_cars_edit"><!-- multi-page .nav-tabs-custom -->
	<ul class="nav<?php echo $rent_lease_cars_edit->MultiPages->NavStyle() ?>">
		<li<?php echo $rent_lease_cars_edit->MultiPages->TabStyle("1") ?>><a href="#tab_rent_lease_cars1" data-toggle="tab"><?php echo $rent_lease_cars->PageCaption(1) ?></a></li>
		<li<?php echo $rent_lease_cars_edit->MultiPages->TabStyle("2") ?>><a href="#tab_rent_lease_cars2" data-toggle="tab"><?php echo $rent_lease_cars->PageCaption(2) ?></a></li>
		<li<?php echo $rent_lease_cars_edit->MultiPages->TabStyle("3") ?>><a href="#tab_rent_lease_cars3" data-toggle="tab"><?php echo $rent_lease_cars->PageCaption(3) ?></a></li>
		<li<?php echo $rent_lease_cars_edit->MultiPages->TabStyle("4") ?>><a href="#tab_rent_lease_cars4" data-toggle="tab"><?php echo $rent_lease_cars->PageCaption(4) ?></a></li>
		<li<?php echo $rent_lease_cars_edit->MultiPages->TabStyle("5") ?>><a href="#tab_rent_lease_cars5" data-toggle="tab"><?php echo $rent_lease_cars->PageCaption(5) ?></a></li>
	</ul>
	<div class="tab-content"><!-- multi-page .nav-tabs-custom .tab-content -->
		<div class="tab-pane<?php echo $rent_lease_cars_edit->MultiPages->PageStyle("1") ?>" id="tab_rent_lease_cars1"><!-- multi-page .tab-pane -->
<div class="ewEditDiv"><!-- page* -->
<?php if ($rent_lease_cars->rentLeaseCarID->Visible) { // rentLeaseCarID ?>
	<div id="r_rentLeaseCarID" class="form-group">
		<label id="elh_rent_lease_cars_rentLeaseCarID" class="<?php echo $rent_lease_cars_edit->LeftColumnClass ?>"><?php echo $rent_lease_cars->rentLeaseCarID->FldCaption() ?></label>
		<div class="<?php echo $rent_lease_cars_edit->RightColumnClass ?>"><div<?php echo $rent_lease_cars->rentLeaseCarID->CellAttributes() ?>>
<span id="el_rent_lease_cars_rentLeaseCarID">
<span<?php echo $rent_lease_cars->rentLeaseCarID->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $rent_lease_cars->rentLeaseCarID->EditValue ?></p></span>
</span>
<input type="hidden" data-table="rent_lease_cars" data-field="x_rentLeaseCarID" data-page="1" name="x_rentLeaseCarID" id="x_rentLeaseCarID" value="<?php echo ew_HtmlEncode($rent_lease_cars->rentLeaseCarID->CurrentValue) ?>">
<?php echo $rent_lease_cars->rentLeaseCarID->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($rent_lease_cars->bodyTypeID->Visible) { // bodyTypeID ?>
	<div id="r_bodyTypeID" class="form-group">
		<label id="elh_rent_lease_cars_bodyTypeID" for="x_bodyTypeID" class="<?php echo $rent_lease_cars_edit->LeftColumnClass ?>"><?php echo $rent_lease_cars->bodyTypeID->FldCaption() ?></label>
		<div class="<?php echo $rent_lease_cars_edit->RightColumnClass ?>"><div<?php echo $rent_lease_cars->bodyTypeID->CellAttributes() ?>>
...
<?php if ($rent_lease_cars->carTitle->Visible) { // carTitle ?>
	<div id="r_carTitle" class="form-group">
		<label id="elh_rent_lease_cars_carTitle" for="x_carTitle" class="<?php echo $rent_lease_cars_edit->LeftColumnClass ?>"><?php echo $rent_lease_cars->carTitle->FldCaption() ?></label>
		<div class="<?php echo $rent_lease_cars_edit->RightColumnClass ?>"><div<?php echo $rent_lease_cars->carTitle->CellAttributes() ?>>
...
<?php if ($rent_lease_cars->slug->Visible) { // slug ?>
	<div id="r_slug" class="form-group">
		<label id="elh_rent_lease_cars_slug" for="x_slug" class="<?php echo $rent_lease_cars_edit->LeftColumnClass ?>"><?php echo $rent_lease_cars->slug->FldCaption() ?></label>
		<div class="<?php echo $rent_lease_cars_edit->RightColumnClass ?>"><div<?php echo $rent_lease_cars->slug->CellAttributes() ?>>
...
<?php if ($rent_lease_cars->image->Visible) { // image ?>
	<div id="r_image" class="form-group">
		<label id="elh_rent_lease_cars_image" class="<?php echo $rent_lease_cars_edit->LeftColumnClass ?>"><?php echo $rent_lease_cars->image->FldCaption() ?></label>
		<div class="<?php echo $rent_lease_cars_edit->RightColumnClass ?>"><div<?php echo $rent_lease_cars->image->CellAttributes() ?>>
...
<?php if ($rent_lease_cars->extraFeatures->Visible) { // extraFeatures ?>
	<div id="r_extraFeatures" class="form-group">
		<label id="elh_rent_lease_cars_extraFeatures" class="<?php echo $rent_lease_cars_edit->LeftColumnClass ?>"><?php echo $rent_lease_cars->extraFeatures->FldCaption() ?></label>
		<div class="<?php echo $rent_lease_cars_edit->RightColumnClass ?>"><div<?php echo $rent_lease_cars->extraFeatures->CellAttributes() ?>>
...
<?php if ($rent_lease_cars->noOfSeats->Visible) { // noOfSeats ?>
	<div id="r_noOfSeats" class="form-group">
		<label id="elh_rent_lease_cars_noOfSeats" for="x_noOfSeats" class="<?php echo $rent_lease_cars_edit->LeftColumnClass ?>"><?php echo $rent_lease_cars->noOfSeats->FldCaption() ?></label>
		<div class="<?php echo $rent_lease_cars_edit->RightColumnClass ?>"><div<?php echo $rent_lease_cars->noOfSeats->CellAttributes() ?>>
...
<?php if ($rent_lease_cars->luggage->Visible) { // luggage ?>
	<div id="r_luggage" class="form-group">
		<label id="elh_rent_lease_cars_luggage" for="x_luggage" class="<?php echo $rent_lease_cars_edit->LeftColumnClass ?>"><?php echo $rent_lease_cars->luggage->FldCaption() ?></label>
		<div class="<?php echo $rent_lease_cars_edit->RightColumnClass ?>"><div<?php echo $rent_lease_cars->luggage->CellAttributes() ?>>
...
<?php if ($rent_lease_cars->transmissionID->Visible) { // transmissionID ?>
	<div id="r_transmissionID" class="form-group">
		<label id="elh_rent_lease_cars_transmissionID" for="x_transmissionID" class="<?php echo $rent_lease_cars_edit->LeftColumnClass ?>"><?php echo $rent_lease_cars->transmissionID->FldCaption() ?></label>
		<div class="<?php echo $rent_lease_cars_edit->RightColumnClass ?>"><div<?php echo $rent_lease_cars->transmissionID->CellAttributes() ?>>
...
<?php if ($rent_lease_cars->ac->Visible) { // ac ?>
	<div id="r_ac" class="form-group">
		<label id="elh_rent_lease_cars_ac" class="<?php echo $rent_lease_cars_edit->LeftColumnClass ?>"><?php echo $rent_lease_cars->ac->FldCaption() ?></label>
		<div class="<?php echo $rent_lease_cars_edit->RightColumnClass ?>"><div<?php echo $rent_lease_cars->ac->CellAttributes() ?>>
...
<?php if ($rent_lease_cars->noOfDoors->Visible) { // noOfDoors ?>
	<div id="r_noOfDoors" class="form-group">
		<label id="elh_rent_lease_cars_noOfDoors" for="x_noOfDoors" class="<?php echo $rent_lease_cars_edit->LeftColumnClass ?>"><?php echo $rent_lease_cars->noOfDoors->FldCaption() ?></label>
		<div class="<?php echo $rent_lease_cars_edit->RightColumnClass ?>"><div<?php echo $rent_lease_cars->noOfDoors->CellAttributes() ?>>
...
<?php if ($rent_lease_cars->deliveryAED->Visible) { // deliveryAED ?>
	<div id="r_deliveryAED" class="form-group">
		<label id="elh_rent_lease_cars_deliveryAED" for="x_deliveryAED" class="<?php echo $rent_lease_cars_edit->LeftColumnClass ?>"><?php echo $rent_lease_cars->deliveryAED->FldCaption() ?></label>
		<div class="<?php echo $rent_lease_cars_edit->RightColumnClass ?>"><div<?php echo $rent_lease_cars->deliveryAED->CellAttributes() ?>>
...
<?php if ($rent_lease_cars->active->Visible) { // active ?>
	<div id="r_active" class="form-group">
		<label id="elh_rent_lease_cars_active" for="x_active" class="<?php echo $rent_lease_cars_edit->LeftColumnClass ?>"><?php echo $rent_lease_cars->active->FldCaption() ?></label>
		<div class="<?php echo $rent_lease_cars_edit->RightColumnClass ?>"><div<?php echo $rent_lease_cars->active->CellAttributes() ?>>
...
<?php if ($rent_lease_cars->weeklyDeals->Visible) { // weeklyDeals ?>
	<div id="r_weeklyDeals" class="form-group">
		<label id="elh_rent_lease_cars_weeklyDeals" for="x_weeklyDeals" class="<?php echo $rent_lease_cars_edit->LeftColumnClass ?>"><?php echo $rent_lease_cars->weeklyDeals->FldCaption() ?></label>
		<div class="<?php echo $rent_lease_cars_edit->RightColumnClass ?>"><div<?php echo $rent_lease_cars->weeklyDeals->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $rent_lease_cars_edit->MultiPages->PageStyle("2") ?>" id="tab_rent_lease_cars2"><!-- multi-page .tab-pane -->
<div class="ewEditDiv"><!-- page* -->
<?php if ($rent_lease_cars->dailyAED->Visible) { // dailyAED ?>
	<div id="r_dailyAED" class="form-group">
		<label id="elh_rent_lease_cars_dailyAED" for="x_dailyAED" class="<?php echo $rent_lease_cars_edit->LeftColumnClass ?>"><?php echo $rent_lease_cars->dailyAED->FldCaption() ?></label>
		<div class="<?php echo $rent_lease_cars_edit->RightColumnClass ?>"><div<?php echo $rent_lease_cars->dailyAED->CellAttributes() ?>>
...
<?php if ($rent_lease_cars->dailyDummyAED->Visible) { // dailyDummyAED ?>
	<div id="r_dailyDummyAED" class="form-group">
		<label id="elh_rent_lease_cars_dailyDummyAED" for="x_dailyDummyAED" class="<?php echo $rent_lease_cars_edit->LeftColumnClass ?>"><?php echo $rent_lease_cars->dailyDummyAED->FldCaption() ?></label>
		<div class="<?php echo $rent_lease_cars_edit->RightColumnClass ?>"><div<?php echo $rent_lease_cars->dailyDummyAED->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $rent_lease_cars_edit->MultiPages->PageStyle("3") ?>" id="tab_rent_lease_cars3"><!-- multi-page .tab-pane -->
<div class="ewEditDiv"><!-- page* -->
<?php if ($rent_lease_cars->weeklyAED->Visible) { // weeklyAED ?>
	<div id="r_weeklyAED" class="form-group">
		<label id="elh_rent_lease_cars_weeklyAED" for="x_weeklyAED" class="<?php echo $rent_lease_cars_edit->LeftColumnClass ?>"><?php echo $rent_lease_cars->weeklyAED->FldCaption() ?></label>
		<div class="<?php echo $rent_lease_cars_edit->RightColumnClass ?>"><div<?php echo $rent_lease_cars->weeklyAED->CellAttributes() ?>>
...
<?php if ($rent_lease_cars->weeklyDummyAED->Visible) { // weeklyDummyAED ?>
	<div id="r_weeklyDummyAED" class="form-group">
		<label id="elh_rent_lease_cars_weeklyDummyAED" for="x_weeklyDummyAED" class="<?php echo $rent_lease_cars_edit->LeftColumnClass ?>"><?php echo $rent_lease_cars->weeklyDummyAED->FldCaption() ?></label>
		<div class="<?php echo $rent_lease_cars_edit->RightColumnClass ?>"><div<?php echo $rent_lease_cars->weeklyDummyAED->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $rent_lease_cars_edit->MultiPages->PageStyle("4") ?>" id="tab_rent_lease_cars4"><!-- multi-page .tab-pane -->
<div class="ewEditDiv"><!-- page* -->
<?php if ($rent_lease_cars->monthlyAED->Visible) { // monthlyAED ?>
	<div id="r_monthlyAED" class="form-group">
		<label id="elh_rent_lease_cars_monthlyAED" for="x_monthlyAED" class="<?php echo $rent_lease_cars_edit->LeftColumnClass ?>"><?php echo $rent_lease_cars->monthlyAED->FldCaption() ?></label>
		<div class="<?php echo $rent_lease_cars_edit->RightColumnClass ?>"><div<?php echo $rent_lease_cars->monthlyAED->CellAttributes() ?>>
...
<?php if ($rent_lease_cars->monthlyDummyAED->Visible) { // monthlyDummyAED ?>
	<div id="r_monthlyDummyAED" class="form-group">
		<label id="elh_rent_lease_cars_monthlyDummyAED" for="x_monthlyDummyAED" class="<?php echo $rent_lease_cars_edit->LeftColumnClass ?>"><?php echo $rent_lease_cars->monthlyDummyAED->FldCaption() ?></label>
		<div class="<?php echo $rent_lease_cars_edit->RightColumnClass ?>"><div<?php echo $rent_lease_cars->monthlyDummyAED->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $rent_lease_cars_edit->MultiPages->PageStyle("5") ?>" id="tab_rent_lease_cars5"><!-- multi-page .tab-pane -->
<div class="ewEditDiv"><!-- page* -->
<?php if ($rent_lease_cars->phase1OrangeCard->Visible) { // phase1OrangeCard ?>
	<div id="r_phase1OrangeCard" class="form-group">
		<label id="elh_rent_lease_cars_phase1OrangeCard" for="x_phase1OrangeCard" class="<?php echo $rent_lease_cars_edit->LeftColumnClass ?>"><?php echo $rent_lease_cars->phase1OrangeCard->FldCaption() ?></label>
		<div class="<?php echo $rent_lease_cars_edit->RightColumnClass ?>"><div<?php echo $rent_lease_cars->phase1OrangeCard->CellAttributes() ?>>
...
<?php if ($rent_lease_cars->phase1GPS->Visible) { // phase1GPS ?>
	<div id="r_phase1GPS" class="form-group">
		<label id="elh_rent_lease_cars_phase1GPS" for="x_phase1GPS" class="<?php echo $rent_lease_cars_edit->LeftColumnClass ?>"><?php echo $rent_lease_cars->phase1GPS->FldCaption() ?></label>
		<div class="<?php echo $rent_lease_cars_edit->RightColumnClass ?>"><div<?php echo $rent_lease_cars->phase1GPS->CellAttributes() ?>>
...
<?php if ($rent_lease_cars->phase1DeliveryCharges->Visible) { // phase1DeliveryCharges ?>
	<div id="r_phase1DeliveryCharges" class="form-group">
		<label id="elh_rent_lease_cars_phase1DeliveryCharges" for="x_phase1DeliveryCharges" class="<?php echo $rent_lease_cars_edit->LeftColumnClass ?>"><?php echo $rent_lease_cars->phase1DeliveryCharges->FldCaption() ?></label>
		<div class="<?php echo $rent_lease_cars_edit->RightColumnClass ?>"><div<?php echo $rent_lease_cars->phase1DeliveryCharges->CellAttributes() ?>>
...
<?php if ($rent_lease_cars->phase1CollectionCharges->Visible) { // phase1CollectionCharges ?>
	<div id="r_phase1CollectionCharges" class="form-group">
		<label id="elh_rent_lease_cars_phase1CollectionCharges" for="x_phase1CollectionCharges" class="<?php echo $rent_lease_cars_edit->LeftColumnClass ?>"><?php echo $rent_lease_cars->phase1CollectionCharges->FldCaption() ?></label>
		<div class="<?php echo $rent_lease_cars_edit->RightColumnClass ?>"><div<?php echo $rent_lease_cars->phase1CollectionCharges->CellAttributes() ?>>
...
<?php if (!$rent_lease_cars_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $rent_lease_cars_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $rent_lease_cars_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
frent_lease_carsedit.Init();
</script>
<?php
$rent_lease_cars_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$rent_lease_cars_edit->Page_Terminate();
?>
