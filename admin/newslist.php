...
class cnews_list extends cnews {
	...
	function SetupKeyValues($key) {
		...
		if (count($arrKeyFlds) >= 1) {
			$this->newsID->setFormValue($arrKeyFlds[0]);
	...
	function GetFilterList() {
		...
		$sFilterList = ew_Concat($sFilterList, $this->newsID->AdvancedSearch->ToJson(), ","); // Field newsID
		...
		$sFilterList = ew_Concat($sFilterList, $this->postDate->AdvancedSearch->ToJson(), ","); // Field postDate
	...
	function RestoreFilterList() {
		...
		// Field postDate
		$this->postDate->AdvancedSearch->SearchValue = @$filter["x_postDate"];
		$this->postDate->AdvancedSearch->SearchOperator = @$filter["z_postDate"];
		$this->postDate->AdvancedSearch->SearchCondition = @$filter["v_postDate"];
		$this->postDate->AdvancedSearch->SearchValue2 = @$filter["y_postDate"];
		$this->postDate->AdvancedSearch->SearchOperator2 = @$filter["w_postDate"];
		$this->postDate->AdvancedSearch->Save();
	...
	function SetupSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->largeImage); // largeImage
			$this->UpdateSort($this->postDate); // postDate
	...
	function ResetCmd() {
		...
		if (substr($this->Command,0,5) == "reset") {
			...
			if ($this->Command == "resetsort") {
				...
				$this->largeImage->setSort("");
				$this->postDate->setSort("");
				$this->active->setSort("");
			}
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<input type=\"checkbox\" name=\"key_m[]\" class=\"ewMultiSelect\" value=\"" . ew_HtmlEncode($this->newsID->CurrentValue) . "\" onclick=\"ew_ClickMultiCheckbox(event);\">";
	...
	function RenderRow() {
		...
		$this->active->ViewCustomAttributes = "";
			...
			if ($this->largeImage->UseColorbox) {
				...
				$this->largeImage->LinkAttrs["data-rel"] = "news_x" . $this->RowCnt . "_largeImage";
...
fnewslist.Lists["x_active"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fnewslist.Lists["x_active"].Options = <?php echo json_encode($news_list->active->Options()) ?>;
...
<?php if ($news->newsID->Visible) { // newsID ?>
	<?php if ($news->SortUrl($news->newsID) == "") { ?>
		<th data-name="newsID" class="<?php echo $news->newsID->HeaderCellClass() ?>"><div id="elh_news_newsID" class="news_newsID"><div class="ewTableHeaderCaption"><?php echo $news->newsID->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="newsID" class="<?php echo $news->newsID->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $news->SortUrl($news->newsID) ?>',1);"><div id="elh_news_newsID" class="news_newsID">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $news->newsID->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($news->newsID->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($news->newsID->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php if ($news->largeImage->Visible) { // largeImage ?>
	<?php if ($news->SortUrl($news->largeImage) == "") { ?>
		<th data-name="largeImage" class="<?php echo $news->largeImage->HeaderCellClass() ?>"><div id="elh_news_largeImage" class="news_largeImage"><div class="ewTableHeaderCaption"><?php echo $news->largeImage->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="largeImage" class="<?php echo $news->largeImage->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $news->SortUrl($news->largeImage) ?>',1);"><div id="elh_news_largeImage" class="news_largeImage">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $news->largeImage->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($news->largeImage->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($news->largeImage->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($news->postDate->Visible) { // postDate ?>
	<?php if ($news->SortUrl($news->postDate) == "") { ?>
		<th data-name="postDate" class="<?php echo $news->postDate->HeaderCellClass() ?>"><div id="elh_news_postDate" class="news_postDate"><div class="ewTableHeaderCaption"><?php echo $news->postDate->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="postDate" class="<?php echo $news->postDate->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $news->SortUrl($news->postDate) ?>',1);"><div id="elh_news_postDate" class="news_postDate">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $news->postDate->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($news->postDate->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($news->postDate->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($news->active->Visible) { // active ?>
	<?php if ($news->SortUrl($news->active) == "") { ?>
		<th data-name="active" class="<?php echo $news->active->HeaderCellClass() ?>"><div id="elh_news_active" class="news_active"><div class="ewTableHeaderCaption"><?php echo $news->active->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="active" class="<?php echo $news->active->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $news->SortUrl($news->active) ?>',1);"><div id="elh_news_active" class="news_active">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $news->active->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($news->active->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($news->active->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<span id="el<?php echo $news_list->RowCnt ?>_news_largeImage" class="news_largeImage">
<span>
...
<span id="el<?php echo $news_list->RowCnt ?>_news_postDate" class="news_postDate">
...
<span id="el<?php echo $news_list->RowCnt ?>_news_active" class="news_active">
