...
class cabout_us_list extends cabout_us {
	...
	function Page_Init() {
		...
		$this->aboutID->SetVisibility();
		$this->aboutID->Visible = !$this->IsAdd() && !$this->IsCopy() && !$this->IsGridAdd();
	...
	function SetupKeyValues($key) {
		...
		if (count($arrKeyFlds) >= 1) {
			$this->aboutID->setFormValue($arrKeyFlds[0]);
			if (!is_numeric($this->aboutID->FormValue))
				return FALSE;
		}
		return TRUE;
	}
	...
	function GetFilterList() {
		...
		$sFilterList = ew_Concat($sFilterList, $this->aboutID->AdvancedSearch->ToJson(), ","); // Field aboutID
	...
	function RestoreFilterList() {
		...
		// Field aboutID
		$this->aboutID->AdvancedSearch->SearchValue = @$filter["x_aboutID"];
		$this->aboutID->AdvancedSearch->SearchOperator = @$filter["z_aboutID"];
		$this->aboutID->AdvancedSearch->SearchCondition = @$filter["v_aboutID"];
		$this->aboutID->AdvancedSearch->SearchValue2 = @$filter["y_aboutID"];
		$this->aboutID->AdvancedSearch->SearchOperator2 = @$filter["w_aboutID"];
		$this->aboutID->AdvancedSearch->Save();
	...
	function SetupSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->aboutID); // aboutID
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<input type=\"checkbox\" name=\"key_m[]\" class=\"ewMultiSelect\" value=\"" . ew_HtmlEncode($this->aboutID->CurrentValue) . "\" onclick=\"ew_ClickMultiCheckbox(event);\">";
	...
	function LoadRowValues($rs = NULL) {
		...
		if (!$rs || $rs->EOF)
			return;
		$this->aboutID->setDbValue($row['aboutID']);
	...
	function LoadDbValues(&$rs) {
		...
		$this->aboutID->DbValue = $row['aboutID'];
	...
	function LoadOldRecord() {
		...
		$bValidKey = TRUE;
		if (strval($this->getKey("aboutID")) <> "")
			$this->aboutID->CurrentValue = $this->getKey("aboutID"); // aboutID
		else
			$bValidKey = FALSE;
	...
	function RenderRow() {
		...
		// aboutID
		$this->aboutID->ViewValue = $this->aboutID->CurrentValue;
		$this->aboutID->ViewCustomAttributes = "";
		...
		$this->active->ViewCustomAttributes = "";
			...
			// aboutID
			$this->aboutID->LinkCustomAttributes = "";
			$this->aboutID->HrefValue = "";
			$this->aboutID->TooltipValue = "";
			...
			if ($this->image->UseColorbox) {
				...
				$this->image->LinkAttrs["data-rel"] = "about_us_x" . $this->RowCnt . "_image";
...
fabout_uslist.Lists["x_active"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fabout_uslist.Lists["x_active"].Options = <?php echo json_encode($about_us_list->active->Options()) ?>;
...
?>
<?php if ($about_us->aboutID->Visible) { // aboutID ?>
	<?php if ($about_us->SortUrl($about_us->aboutID) == "") { ?>
		<th data-name="aboutID" class="<?php echo $about_us->aboutID->HeaderCellClass() ?>"><div id="elh_about_us_aboutID" class="about_us_aboutID"><div class="ewTableHeaderCaption"><?php echo $about_us->aboutID->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="aboutID" class="<?php echo $about_us->aboutID->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $about_us->SortUrl($about_us->aboutID) ?>',1);"><div id="elh_about_us_aboutID" class="about_us_aboutID">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $about_us->aboutID->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($about_us->aboutID->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($about_us->aboutID->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($about_us->title->Visible) { // title ?>
	<?php if ($about_us->SortUrl($about_us->title) == "") { ?>
		<th data-name="title" class="<?php echo $about_us->title->HeaderCellClass() ?>"><div id="elh_about_us_title" class="about_us_title"><div class="ewTableHeaderCaption"><?php echo $about_us->title->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="title" class="<?php echo $about_us->title->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $about_us->SortUrl($about_us->title) ?>',1);"><div id="elh_about_us_title" class="about_us_title">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $about_us->title->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($about_us->title->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($about_us->title->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($about_us->image->Visible) { // image ?>
	<?php if ($about_us->SortUrl($about_us->image) == "") { ?>
		<th data-name="image" class="<?php echo $about_us->image->HeaderCellClass() ?>"><div id="elh_about_us_image" class="about_us_image"><div class="ewTableHeaderCaption"><?php echo $about_us->image->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="image" class="<?php echo $about_us->image->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $about_us->SortUrl($about_us->image) ?>',1);"><div id="elh_about_us_image" class="about_us_image">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $about_us->image->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($about_us->image->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($about_us->image->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($about_us->active->Visible) { // active ?>
	<?php if ($about_us->SortUrl($about_us->active) == "") { ?>
		<th data-name="active" class="<?php echo $about_us->active->HeaderCellClass() ?>"><div id="elh_about_us_active" class="about_us_active"><div class="ewTableHeaderCaption"><?php echo $about_us->active->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="active" class="<?php echo $about_us->active->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $about_us->SortUrl($about_us->active) ?>',1);"><div id="elh_about_us_active" class="about_us_active">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $about_us->active->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($about_us->active->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($about_us->active->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
?>
	<?php if ($about_us->aboutID->Visible) { // aboutID ?>
		<td data-name="aboutID"<?php echo $about_us->aboutID->CellAttributes() ?>>
<span id="el<?php echo $about_us_list->RowCnt ?>_about_us_aboutID" class="about_us_aboutID">
<span<?php echo $about_us->aboutID->ViewAttributes() ?>>
<?php echo $about_us->aboutID->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($about_us->title->Visible) { // title ?>
		<td data-name="title"<?php echo $about_us->title->CellAttributes() ?>>
<span id="el<?php echo $about_us_list->RowCnt ?>_about_us_title" class="about_us_title">
<span<?php echo $about_us->title->ViewAttributes() ?>>
<?php echo $about_us->title->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($about_us->image->Visible) { // image ?>
		<td data-name="image"<?php echo $about_us->image->CellAttributes() ?>>
<span id="el<?php echo $about_us_list->RowCnt ?>_about_us_image" class="about_us_image">
<span>
<?php echo ew_GetFileViewTag($about_us->image, $about_us->image->ListViewValue()) ?>
</span>
</span>
</td>
	<?php } ?>
	<?php if ($about_us->active->Visible) { // active ?>
		<td data-name="active"<?php echo $about_us->active->CellAttributes() ?>>
<span id="el<?php echo $about_us_list->RowCnt ?>_about_us_active" class="about_us_active">
<span<?php echo $about_us->active->ViewAttributes() ?>>
<?php echo $about_us->active->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
