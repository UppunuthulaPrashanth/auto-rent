...
define("EW_PROJECT_NAME", "Autorent", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{F745D41A-D8C3-4E57-B065-3A7F49376673}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'gNEazueqCBO08Rj7', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/Autorent.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "127.0.0.1", "port" => 3306, "user" => "autoro8m_uaeauto", "pass" => "6BKLK}541YdR", "db" => "autoro8m_uaeautorent", "qs" => "`", "qe" => "`");
...
// Security
define("EW_ADMIN_USER_NAME", "superadmin123!@#", TRUE); // Administrator user name
define("EW_ADMIN_PASSWORD", "accessmaster123!@#", TRUE); // Administrator password
...
define("EW_USER_TABLE", "`cms_users`", TRUE);
define("EW_USER_NAME_FILTER", "(`name` = '%u')", TRUE);
...
define("EW_MAX_FILE_SIZE", 150000000, TRUE); // Max file size
