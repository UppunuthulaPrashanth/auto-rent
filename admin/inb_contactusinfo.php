...
//
// Table class for inb_contactus
//
class cinb_contactus extends cTable {
	var $id;
	var $fullname;
	var $subject;
	var $_email;
	...
	function __construct() {
		...
		$this->TableVar = 'inb_contactus';
		$this->TableName = 'inb_contactus';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`inb_contactus`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('inb_contactus', 'inb_contactus', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// fullname
		$this->fullname = new cField('inb_contactus', 'inb_contactus', 'x_fullname', 'fullname', '`fullname`', '`fullname`', 200, -1, FALSE, '`fullname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fullname->Sortable = TRUE; // Allow sort
		$this->fields['fullname'] = &$this->fullname;

		// subject
		$this->subject = new cField('inb_contactus', 'inb_contactus', 'x_subject', 'subject', '`subject`', '`subject`', 200, -1, FALSE, '`subject`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->subject->Sortable = TRUE; // Allow sort
		$this->fields['subject'] = &$this->subject;

		// email
		$this->_email = new cField('inb_contactus', 'inb_contactus', 'x__email', 'email', '`email`', '`email`', 200, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_email->Sortable = TRUE; // Allow sort
		$this->fields['email'] = &$this->_email;

		// phone
		$this->phone = new cField('inb_contactus', 'inb_contactus', 'x_phone', 'phone', '`phone`', '`phone`', 200, -1, FALSE, '`phone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->phone->Sortable = TRUE; // Allow sort
		$this->fields['phone'] = &$this->phone;

		// address
		$this->address = new cField('inb_contactus', 'inb_contactus', 'x_address', 'address', '`address`', '`address`', 200, -1, FALSE, '`address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->address->Sortable = TRUE; // Allow sort
		$this->fields['address'] = &$this->address;

		// message
		$this->message = new cField('inb_contactus', 'inb_contactus', 'x_message', 'message', '`message`', '`message`', 201, -1, FALSE, '`message`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->message->Sortable = TRUE; // Allow sort
		$this->fields['message'] = &$this->message;

		// dateCreated
		$this->dateCreated = new cField('inb_contactus', 'inb_contactus', 'x_dateCreated', 'dateCreated', '`dateCreated`', ew_CastDateFieldForLike('`dateCreated`', 7, "DB"), 135, 7, FALSE, '`dateCreated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`inb_contactus`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "inb_contactusedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "inb_contactusadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("inb_contactusview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("inb_contactusview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "inb_contactusadd.php?" . $this->UrlParm($parm);
		else
			$url = "inb_contactusadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("inb_contactusedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("inb_contactusadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("inb_contactusdelete.php", $this->UrlParm());
	}
