...
class cservices_edit extends cservices {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// serviceTypeID
			$this->serviceTypeID->SetDbValueDef($rsnew, $this->serviceTypeID->CurrentValue, NULL, $this->serviceTypeID->ReadOnly);

			// serviceName
			$this->serviceName->SetDbValueDef($rsnew, $this->serviceName->CurrentValue, NULL, $this->serviceName->ReadOnly);

			// serviceSlug
			$this->serviceSlug->SetDbValueDef($rsnew, $this->serviceSlug->CurrentValue, NULL, $this->serviceSlug->ReadOnly);
...
fservicesedit.Lists["x_serviceTypeID"] = {"LinkField":"x_serviceTypeID","Ajax":true,"AutoFill":false,"DisplayFields":["x_serviceTypeName","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"mtr_service_type"};
fservicesedit.Lists["x_serviceTypeID"].Data = "<?php echo $services_edit->serviceTypeID->LookupFilterQuery(FALSE, "edit") ?>";
...
<input type="hidden" data-table="services" data-field="x_serviceID" name="x_serviceID" id="x_serviceID" value="<?php echo ew_HtmlEncode($services->serviceID->CurrentValue) ?>">
...
<?php if ($services->serviceTypeID->Visible) { // serviceTypeID ?>
	<div id="r_serviceTypeID" class="form-group">
		<label id="elh_services_serviceTypeID" for="x_serviceTypeID" class="<?php echo $services_edit->LeftColumnClass ?>"><?php echo $services->serviceTypeID->FldCaption() ?></label>
		<div class="<?php echo $services_edit->RightColumnClass ?>"><div<?php echo $services->serviceTypeID->CellAttributes() ?>>
...
<?php if ($services->serviceName->Visible) { // serviceName ?>
	<div id="r_serviceName" class="form-group">
		<label id="elh_services_serviceName" for="x_serviceName" class="<?php echo $services_edit->LeftColumnClass ?>"><?php echo $services->serviceName->FldCaption() ?></label>
		<div class="<?php echo $services_edit->RightColumnClass ?>"><div<?php echo $services->serviceName->CellAttributes() ?>>
...
<?php if ($services->serviceSlug->Visible) { // serviceSlug ?>
	<div id="r_serviceSlug" class="form-group">
		<label id="elh_services_serviceSlug" for="x_serviceSlug" class="<?php echo $services_edit->LeftColumnClass ?>"><?php echo $services->serviceSlug->FldCaption() ?></label>
		<div class="<?php echo $services_edit->RightColumnClass ?>"><div<?php echo $services->serviceSlug->CellAttributes() ?>>
