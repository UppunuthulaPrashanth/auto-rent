...
$home_document_required_edit = NULL; // Initialize page object first

class chome_document_required_edit extends chome_document_required {
	...
	// Page object name
	var $PageObjName = 'home_document_required_edit';
...
// Create page object
if (!isset($home_document_required_edit)) $home_document_required_edit = new chome_document_required_edit();

// Page init
$home_document_required_edit->Page_Init();

// Page main
$home_document_required_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$home_document_required_edit->Page_Render();
?>
...
var CurrentForm = fhome_document_requirededit = new ew_Form("fhome_document_requirededit", "edit");

// Validate form
fhome_document_requirededit.Validate = function() {
...
fhome_document_requirededit.Form_CustomValidate = 
...
fhome_document_requirededit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fhome_document_requirededit.Lists["x_active"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fhome_document_requirededit.Lists["x_active"].Options = <?php echo json_encode($home_document_required_edit->active->Options()) ?>;
...
<?php $home_document_required_edit->ShowPageHeader(); ?>
<?php
$home_document_required_edit->ShowMessage();
?>
<form name="fhome_document_requirededit" id="fhome_document_requirededit" class="<?php echo $home_document_required_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($home_document_required_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $home_document_required_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="home_document_required">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($home_document_required_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($home_document_required->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_home_document_required_id" class="<?php echo $home_document_required_edit->LeftColumnClass ?>"><?php echo $home_document_required->id->FldCaption() ?></label>
		<div class="<?php echo $home_document_required_edit->RightColumnClass ?>"><div<?php echo $home_document_required->id->CellAttributes() ?>>
<span id="el_home_document_required_id">
<span<?php echo $home_document_required->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $home_document_required->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="home_document_required" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($home_document_required->id->CurrentValue) ?>">
<?php echo $home_document_required->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($home_document_required->title->Visible) { // title ?>
	<div id="r_title" class="form-group">
		<label id="elh_home_document_required_title" for="x_title" class="<?php echo $home_document_required_edit->LeftColumnClass ?>"><?php echo $home_document_required->title->FldCaption() ?></label>
		<div class="<?php echo $home_document_required_edit->RightColumnClass ?>"><div<?php echo $home_document_required->title->CellAttributes() ?>>
...
<?php if ($home_document_required->image->Visible) { // image ?>
	<div id="r_image" class="form-group">
		<label id="elh_home_document_required_image" class="<?php echo $home_document_required_edit->LeftColumnClass ?>"><?php echo $home_document_required->image->FldCaption() ?></label>
		<div class="<?php echo $home_document_required_edit->RightColumnClass ?>"><div<?php echo $home_document_required->image->CellAttributes() ?>>
...
<?php if ($home_document_required->description->Visible) { // description ?>
	<div id="r_description" class="form-group">
		<label id="elh_home_document_required_description" class="<?php echo $home_document_required_edit->LeftColumnClass ?>"><?php echo $home_document_required->description->FldCaption() ?></label>
		<div class="<?php echo $home_document_required_edit->RightColumnClass ?>"><div<?php echo $home_document_required->description->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateEditor("fhome_document_requirededit", "x_description", 35, 4, <?php echo ($home_document_required->description->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php if ($home_document_required->so->Visible) { // so ?>
	<div id="r_so" class="form-group">
		<label id="elh_home_document_required_so" for="x_so" class="<?php echo $home_document_required_edit->LeftColumnClass ?>"><?php echo $home_document_required->so->FldCaption() ?></label>
		<div class="<?php echo $home_document_required_edit->RightColumnClass ?>"><div<?php echo $home_document_required->so->CellAttributes() ?>>
...
<?php if ($home_document_required->active->Visible) { // active ?>
	<div id="r_active" class="form-group">
		<label id="elh_home_document_required_active" for="x_active" class="<?php echo $home_document_required_edit->LeftColumnClass ?>"><?php echo $home_document_required->active->FldCaption() ?></label>
		<div class="<?php echo $home_document_required_edit->RightColumnClass ?>"><div<?php echo $home_document_required->active->CellAttributes() ?>>
...
<?php if (!$home_document_required_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $home_document_required_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $home_document_required_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fhome_document_requirededit.Init();
</script>
<?php
$home_document_required_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$home_document_required_edit->Page_Terminate();
?>
