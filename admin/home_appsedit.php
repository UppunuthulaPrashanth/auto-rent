...
$home_apps_edit = NULL; // Initialize page object first

class chome_apps_edit extends chome_apps {
	...
	// Page object name
	var $PageObjName = 'home_apps_edit';
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			...
			// Load key from Form
			if ($objForm->HasValue("x_appsID")) {
				$this->appsID->setFormValue($objForm->GetValue("x_appsID"));
			}
		} else {
	...
	function RestoreFormValues() {
		global $objForm;
		$this->appsID->CurrentValue = $this->appsID->FormValue;
	...
	function RenderRow() {
		...
		$this->backgroundImage->ViewCustomAttributes = "";
			...
			if ($this->CurrentAction == "I" && !$this->EventCancelled) ew_RenderUploadField($this->buttonIcon1);
			...
			if ($this->CurrentAction == "I" && !$this->EventCancelled) ew_RenderUploadField($this->buttonIcon2);
			...
			if ($this->CurrentAction == "I" && !$this->EventCancelled) ew_RenderUploadField($this->backgroundImage);
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// buttonIcon1
			if ($this->buttonIcon1->Visible && !$this->buttonIcon1->ReadOnly && !$this->buttonIcon1->Upload->KeepFile) {
				$this->buttonIcon1->Upload->DbValue = $rsold['buttonIcon1']; // Get original value
			...
			// buttonLinkLabel1
			$this->buttonLinkLabel1->SetDbValueDef($rsnew, $this->buttonLinkLabel1->CurrentValue, NULL, $this->buttonLinkLabel1->ReadOnly);

			// buttonLink1
			$this->buttonLink1->SetDbValueDef($rsnew, $this->buttonLink1->CurrentValue, NULL, $this->buttonLink1->ReadOnly);

			// buttonIcon2
			if ($this->buttonIcon2->Visible && !$this->buttonIcon2->ReadOnly && !$this->buttonIcon2->Upload->KeepFile) {
				$this->buttonIcon2->Upload->DbValue = $rsold['buttonIcon2']; // Get original value
			...
			// buttonLinkLabel2
			$this->buttonLinkLabel2->SetDbValueDef($rsnew, $this->buttonLinkLabel2->CurrentValue, NULL, $this->buttonLinkLabel2->ReadOnly);

			// buttonLink2
			$this->buttonLink2->SetDbValueDef($rsnew, $this->buttonLink2->CurrentValue, NULL, $this->buttonLink2->ReadOnly);
			...
			// backgroundImage
			if ($this->backgroundImage->Visible && !$this->backgroundImage->ReadOnly && !$this->backgroundImage->Upload->KeepFile) {
				$this->backgroundImage->Upload->DbValue = $rsold['backgroundImage']; // Get original value
			...
			if ($this->buttonIcon1->Visible && !$this->buttonIcon1->Upload->KeepFile) {
				...
				if (!ew_Empty($this->buttonIcon1->Upload->FileName)) {
					...
					$this->buttonIcon1->SetDbValueDef($rsnew, $this->buttonIcon1->Upload->FileName, NULL, $this->buttonIcon1->ReadOnly);
				}
			}
			if ($this->buttonIcon2->Visible && !$this->buttonIcon2->Upload->KeepFile) {
				...
				if (!ew_Empty($this->buttonIcon2->Upload->FileName)) {
					...
					$this->buttonIcon2->SetDbValueDef($rsnew, $this->buttonIcon2->Upload->FileName, NULL, $this->buttonIcon2->ReadOnly);
				}
			}
			...
			if ($this->backgroundImage->Visible && !$this->backgroundImage->Upload->KeepFile) {
				...
				if (!ew_Empty($this->backgroundImage->Upload->FileName)) {
					...
					$this->backgroundImage->SetDbValueDef($rsnew, $this->backgroundImage->Upload->FileName, NULL, $this->backgroundImage->ReadOnly);
				}
			}
...
// Create page object
if (!isset($home_apps_edit)) $home_apps_edit = new chome_apps_edit();

// Page init
$home_apps_edit->Page_Init();

// Page main
$home_apps_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$home_apps_edit->Page_Render();
?>
...
var CurrentForm = fhome_appsedit = new ew_Form("fhome_appsedit", "edit");

// Validate form
fhome_appsedit.Validate = function() {
...
fhome_appsedit.Form_CustomValidate = 
...
fhome_appsedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Multi-Page
fhome_appsedit.MultiPage = new ew_MultiPage("fhome_appsedit");
...
<?php $home_apps_edit->ShowPageHeader(); ?>
<?php
$home_apps_edit->ShowMessage();
?>
<form name="fhome_appsedit" id="fhome_appsedit" class="<?php echo $home_apps_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($home_apps_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $home_apps_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="home_apps">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($home_apps_edit->IsModal) ?>">
<div class="ewMultiPage"><!-- multi-page -->
<div class="nav-tabs-custom" id="home_apps_edit"><!-- multi-page .nav-tabs-custom -->
	<ul class="nav<?php echo $home_apps_edit->MultiPages->NavStyle() ?>">
		<li<?php echo $home_apps_edit->MultiPages->TabStyle("1") ?>><a href="#tab_home_apps1" data-toggle="tab"><?php echo $home_apps->PageCaption(1) ?></a></li>
		<li<?php echo $home_apps_edit->MultiPages->TabStyle("2") ?>><a href="#tab_home_apps2" data-toggle="tab"><?php echo $home_apps->PageCaption(2) ?></a></li>
		<li<?php echo $home_apps_edit->MultiPages->TabStyle("3") ?>><a href="#tab_home_apps3" data-toggle="tab"><?php echo $home_apps->PageCaption(3) ?></a></li>
	</ul>
	<div class="tab-content"><!-- multi-page .nav-tabs-custom .tab-content -->
		<div class="tab-pane<?php echo $home_apps_edit->MultiPages->PageStyle("1") ?>" id="tab_home_apps1"><!-- multi-page .tab-pane -->
<div class="ewEditDiv"><!-- page* -->
<?php if ($home_apps->appsID->Visible) { // appsID ?>
	<div id="r_appsID" class="form-group">
		<label id="elh_home_apps_appsID" class="<?php echo $home_apps_edit->LeftColumnClass ?>"><?php echo $home_apps->appsID->FldCaption() ?></label>
		<div class="<?php echo $home_apps_edit->RightColumnClass ?>"><div<?php echo $home_apps->appsID->CellAttributes() ?>>
<span id="el_home_apps_appsID">
<span<?php echo $home_apps->appsID->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $home_apps->appsID->EditValue ?></p></span>
</span>
<input type="hidden" data-table="home_apps" data-field="x_appsID" data-page="1" name="x_appsID" id="x_appsID" value="<?php echo ew_HtmlEncode($home_apps->appsID->CurrentValue) ?>">
<?php echo $home_apps->appsID->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($home_apps->title->Visible) { // title ?>
	<div id="r_title" class="form-group">
		<label id="elh_home_apps_title" for="x_title" class="<?php echo $home_apps_edit->LeftColumnClass ?>"><?php echo $home_apps->title->FldCaption() ?></label>
		<div class="<?php echo $home_apps_edit->RightColumnClass ?>"><div<?php echo $home_apps->title->CellAttributes() ?>>
...
<?php if ($home_apps->subTitle->Visible) { // subTitle ?>
	<div id="r_subTitle" class="form-group">
		<label id="elh_home_apps_subTitle" for="x_subTitle" class="<?php echo $home_apps_edit->LeftColumnClass ?>"><?php echo $home_apps->subTitle->FldCaption() ?></label>
		<div class="<?php echo $home_apps_edit->RightColumnClass ?>"><div<?php echo $home_apps->subTitle->CellAttributes() ?>>
...
<?php if ($home_apps->image->Visible) { // image ?>
	<div id="r_image" class="form-group">
		<label id="elh_home_apps_image" class="<?php echo $home_apps_edit->LeftColumnClass ?>"><?php echo $home_apps->image->FldCaption() ?></label>
		<div class="<?php echo $home_apps_edit->RightColumnClass ?>"><div<?php echo $home_apps->image->CellAttributes() ?>>
...
<?php if ($home_apps->backgroundImage->Visible) { // backgroundImage ?>
	<div id="r_backgroundImage" class="form-group">
		<label id="elh_home_apps_backgroundImage" class="<?php echo $home_apps_edit->LeftColumnClass ?>"><?php echo $home_apps->backgroundImage->FldCaption() ?></label>
		<div class="<?php echo $home_apps_edit->RightColumnClass ?>"><div<?php echo $home_apps->backgroundImage->CellAttributes() ?>>
...
<?php if (@$_POST["fa_x_backgroundImage"] == "0") { ?>
<input type="hidden" name="fa_x_backgroundImage" id= "fa_x_backgroundImage" value="0">
<?php } else { ?>
<input type="hidden" name="fa_x_backgroundImage" id= "fa_x_backgroundImage" value="1">
<?php } ?>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $home_apps_edit->MultiPages->PageStyle("2") ?>" id="tab_home_apps2"><!-- multi-page .tab-pane -->
<div class="ewEditDiv"><!-- page* -->
<?php if ($home_apps->buttonIcon1->Visible) { // buttonIcon1 ?>
	<div id="r_buttonIcon1" class="form-group">
		<label id="elh_home_apps_buttonIcon1" class="<?php echo $home_apps_edit->LeftColumnClass ?>"><?php echo $home_apps->buttonIcon1->FldCaption() ?></label>
		<div class="<?php echo $home_apps_edit->RightColumnClass ?>"><div<?php echo $home_apps->buttonIcon1->CellAttributes() ?>>
...
<?php if (@$_POST["fa_x_buttonIcon1"] == "0") { ?>
<input type="hidden" name="fa_x_buttonIcon1" id= "fa_x_buttonIcon1" value="0">
<?php } else { ?>
<input type="hidden" name="fa_x_buttonIcon1" id= "fa_x_buttonIcon1" value="1">
<?php } ?>
...
<?php if ($home_apps->buttonLinkLabel1->Visible) { // buttonLinkLabel1 ?>
	<div id="r_buttonLinkLabel1" class="form-group">
		<label id="elh_home_apps_buttonLinkLabel1" for="x_buttonLinkLabel1" class="<?php echo $home_apps_edit->LeftColumnClass ?>"><?php echo $home_apps->buttonLinkLabel1->FldCaption() ?></label>
		<div class="<?php echo $home_apps_edit->RightColumnClass ?>"><div<?php echo $home_apps->buttonLinkLabel1->CellAttributes() ?>>
...
<?php if ($home_apps->buttonLink1->Visible) { // buttonLink1 ?>
	<div id="r_buttonLink1" class="form-group">
		<label id="elh_home_apps_buttonLink1" for="x_buttonLink1" class="<?php echo $home_apps_edit->LeftColumnClass ?>"><?php echo $home_apps->buttonLink1->FldCaption() ?></label>
		<div class="<?php echo $home_apps_edit->RightColumnClass ?>"><div<?php echo $home_apps->buttonLink1->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $home_apps_edit->MultiPages->PageStyle("3") ?>" id="tab_home_apps3"><!-- multi-page .tab-pane -->
<div class="ewEditDiv"><!-- page* -->
<?php if ($home_apps->buttonIcon2->Visible) { // buttonIcon2 ?>
	<div id="r_buttonIcon2" class="form-group">
		<label id="elh_home_apps_buttonIcon2" class="<?php echo $home_apps_edit->LeftColumnClass ?>"><?php echo $home_apps->buttonIcon2->FldCaption() ?></label>
		<div class="<?php echo $home_apps_edit->RightColumnClass ?>"><div<?php echo $home_apps->buttonIcon2->CellAttributes() ?>>
...
<?php if (@$_POST["fa_x_buttonIcon2"] == "0") { ?>
<input type="hidden" name="fa_x_buttonIcon2" id= "fa_x_buttonIcon2" value="0">
<?php } else { ?>
<input type="hidden" name="fa_x_buttonIcon2" id= "fa_x_buttonIcon2" value="1">
<?php } ?>
...
<?php if ($home_apps->buttonLinkLabel2->Visible) { // buttonLinkLabel2 ?>
	<div id="r_buttonLinkLabel2" class="form-group">
		<label id="elh_home_apps_buttonLinkLabel2" for="x_buttonLinkLabel2" class="<?php echo $home_apps_edit->LeftColumnClass ?>"><?php echo $home_apps->buttonLinkLabel2->FldCaption() ?></label>
		<div class="<?php echo $home_apps_edit->RightColumnClass ?>"><div<?php echo $home_apps->buttonLinkLabel2->CellAttributes() ?>>
...
<?php if ($home_apps->buttonLink2->Visible) { // buttonLink2 ?>
	<div id="r_buttonLink2" class="form-group">
		<label id="elh_home_apps_buttonLink2" for="x_buttonLink2" class="<?php echo $home_apps_edit->LeftColumnClass ?>"><?php echo $home_apps->buttonLink2->FldCaption() ?></label>
		<div class="<?php echo $home_apps_edit->RightColumnClass ?>"><div<?php echo $home_apps->buttonLink2->CellAttributes() ?>>
...
<?php if (!$home_apps_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $home_apps_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $home_apps_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
