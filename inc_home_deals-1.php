<div class="theme-page-section theme-page-section-xl">
      <div class="container">
        <div class="theme-page-section-header">
             ...
             ?>
            <h5 class="theme-page-section-title"><?php echo $row['pageTitle'] ?> test</h5>
           ...
           while ($promotionRow = mysqli_fetch_assoc($promotionResult))
           {
            ...
            <div class="banner _br-5 banner-animate banner-animate-mask-in banner-animate-zoom-in">
              <img class="banner-img"
                   src="uploads/promotions/<?php echo $promotionRow['homeImage'];?>"
                   alt="<?php echo $promotionRow['title']; ?>"
                   title="<?php echo $promotionRow['title']; ?>"/>
