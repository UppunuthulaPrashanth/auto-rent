            ...
            <div class="col-md-9 ">
              <div class="_mob-h">
                <div class="theme-hero-text theme-hero-text-white">
                  <div class="">
                    <h2 class="theme-hero-text-title _mb-20 theme-hero-text-title-sm">Payment Details</h2>
                  </div>
                </div>
        ...
        <div class="row row-col-static row-col-mob-gap" id="sticky-parent" data-gutter="60">
         ...
         <tr class="checkout-table-2">
           ...
           <td><strong>AED 184.00</strong></td>
            ...
            <h5>Total amount(for current purchases) AED 184.00 by Credit Card</h5>            
                        
                        <br>
                        
                    <button class="btn btn-primary-invert btn-shadow text-upcase theme-footer-subscribe-btn book-btn" type="submit"> Pay Now</button>    
                  ...
                  <div class="theme-search-results-item-preview">
                    ...
                    <div class="row" data-gutter="20">
                      ...
                      <div class="col-md-8 ">
                        ...
                        <ul class="theme-search-results-item-car-feature-list" style="margin:0px;">
                          <li>
