...
//		echo '<tr><td>' . $information[0] . '</td><td>' . $information[1] . '</td></tr>';
    ...
    $bookingModuleEmail = 'PAY AS YOU DRIVE';
...
//	exit();
	...
	$res = $db->query("SELECT userID FROM inb_bookings_pay_as_you_drive WHERE bookingNumber = ?s", $bookingNumber);
    ...
    $result = $db->query("INSERT INTO pg_transactions (userID, bookingNumber, bookingModule, order_id, tracking_id, bank_ref_no, order_status, failure_message,
        ...
        $_SESSION[USERID], $bookingNumber, $bookingModule, $orderID, $tracking_id, $bank_ref_no, $order_status, $failure_message, $paymentMode,
        $card_name, $status_code, $status_message, $currency, $amount,
        $billing_name, $billing_address, $billing_city, $billing_state, $billing_zip, $billing_country, $billing_tel, $billing_email,
        $delivery_name, $delivery_address, $delivery_city, $delivery_state, $delivery_zip, $delivery_country, $delivery_tel,
        $merchant_param1, $merchant_param2, $merchant_param3, $merchant_param4, $merchant_param5, $vault, $offer_type, $offer_code,
        $discount_value, $mer_amount, $eci_value, $card_holder_name, $bank_qsi_no, $bank_receipt_no, $merchant_param6);
...
$notificationType = 12; // this is for Booking Form
...
if ( $order_status == 'Success' ) {
    ...
    $message = str_replace( "{VEHICLE-NAME}", $payDriveCarRow['carTitle'], $message );
					...
					<div class="row">
						<div class="col-md-6">
                            ...
                            else
                            {
                                if($order_status == "Success"){
                                    ?>
                                    <p class="booking-txt"> Thank You for your payment. Your Booking has been created. </p>
                                    <?php
                                }
                                else{
                                    ?>
							...
							<div class="row" data-gutter="20">
								...
								<div class="col-md-4 ">
									...
									<ul class="theme-search-results-item-car-feature-list">
                                        ...
                                        <?php } ?>
										<li>
											<i class="fa fa-car"></i> <span><?php echo $payDriveCarRow['noOfDoors']; ?></span>
										</li>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
													...
													<span class="icheck-title">
														...
														<strong><?php echo $_SESSION[ CURRENT_CURRENCY ] . " " . number_format( $totalAmount ); ?></strong>
													</span>
