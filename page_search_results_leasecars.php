...
if (empty($leaseBodyType))
{
    ...
    $rentCarResult = $db->query("SELECT * FROM lease_cars WHERE bodyTypeID = ?s ", $leaseBodyType);
}
						...
						<div class="theme-search-results-item theme-search-results-item-">
							<div class="theme-search-results-item-preview products-grid">
                                ...
                                if (empty($leaseBodyType)) {
                                    ...
                                    $rentCarResult = $db->query("SELECT * FROM lease_cars where bodyTypeID = ?s ORDER BY monthlyAED ASC", $leaseBodyType);
                                }
												...
												<div class="row row-col-gap" data-gutter="20">
													<div class="col-md-12">
														<div class="theme-payment-page-form-item form-group">
															<i class="fa fa-angle-down"></i> <select class="form-control" name="selectedType" id="selectedType" required>
