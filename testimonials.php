...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <?php echo $head; ?>
    <title>Autorent Customer Testimonials</title>
	<meta name="keywords" content="autorent, customer testimonials, individual customer appreciation, corporate customer testimonials, car rental customers testimonials">
	<meta name="description" content="Autorent Customers Testimonials ">
    </head>
    <body>
 <!-- ==========================================================================
                              Header Area 
...
if (isset($_GET['success']) && $_GET['success'] == 1) {
	...
	echo "<div class='alert alert-success'>
     ...
     <strong>Success!</strong> Thank you, your testimonial has been submitted.</div>";
}
if (isset($_GET['error']) && $_GET['error'] == 1) {
    ...
    <div class='alert alert-danger'>
     <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
  <strong>Error!</strong> Please Add All Fields.
</div>";
}
?>
