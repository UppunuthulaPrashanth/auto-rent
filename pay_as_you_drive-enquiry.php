...
$PAGEID = "Pay as you drive Enquiry";
...
if ( empty( $slug ) ) {
    header( "location:pay-you-drive" );
    exit();
}


$payAsYouDriveResult = $db->query( "SELECT * FROM pay_as_you_drive WHERE slug = ?s AND active = 1", $slug);

$payAsYouDriveRow     = mysqli_fetch_assoc( $payAsYouDriveResult );


$carTitle = $payAsYouDriveRow['carTitle'];
    ...
    <div class="container">
        ...
        <div class="row row-col-static row-col-mob-gap" id="sticky-parent" data-gutter="60">
            ...
            <div class="col-md-8 ">
                ...
                <form id="payAsYouDriveEnquiryForm" name="payAsYouDriveEnquiryForm" method="post" enctype="multipart/form-data">
                    ...
                    <div class="theme-payment-page-sections-item">
                        ...
                        <div class="theme-payment-page-booking">
                            ...
                            <input type="submit" class="btn _tt-uc btn-primary-inverse btn-lg btn-block" id="payAsYouDriveEnquiry-btn" name="corporateLeasing-btn" value="Submit" />
