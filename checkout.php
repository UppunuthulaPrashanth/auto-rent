...
if ( isset( $_POST['leaseTerm4'] ) ) {
	$leaseTerm4 = $_POST['leaseTerm4'];
}
if ( isset( $_POST['payonline'] ) ) {
	$payonline = $_POST['payonline'];
}
if ( isset( $_POST['payoffline'] ) ) {
	$payoffline = $_POST['payoffline'];
}
if ( isset( $_POST['leasehd'] ) ) {
	$leasehd = $_POST['leasehd'];
}
...
//if ( isset( $_POST["geolocation36"] ) )
//{
//	$geolocation36 = filter_var( $_POST['geolocation36'], FILTER_SANITIZE_STRING );
//}
if ( isset( $_POST["totalDays2"] ) ) {
	$totalDays = filter_var( $_POST['totalDays2'], FILTER_SANITIZE_STRING );
}
if ( isset( $_POST["vrf"] ) ) {
	$vrf = filter_var( $_POST['vrf'], FILTER_SANITIZE_STRING );
}
if ( isset( $_POST["scdw"] ) ) {
			...
			<div class="col-md-8 ">
				<div class="theme-payment-page-sections">
						...
						<div class="theme-search-results-item-preview">
							...
							<table class="table">
								...
								<tr>
									...
									<td class="table-content-right"><?php echo $_SESSION[ CURRENT_CURRENCY ] . ' ' . number_format( (int) $fullRentalPrice ); ?></td>
								</tr>
								<?php
								if ( isset( $_POST["phase1OrangeCard"] ) ) {
									...
									<tr>
										<td>Orange Card</td>
										<td></td>
										<td class="table-content-right"><?php echo $_SESSION[ CURRENT_CURRENCY ] . ' ' . number_format( (int) $phase1OrangeCard ); ?></td>
									</tr>
								<?php } ?>
								...
								if ( isset( $_POST["phase1GPS"] ) ) {
									...
									<tr>
										<td>GPS</td>
										<td></td>
										<td class="table-content-right"><?php echo $_SESSION[ CURRENT_CURRENCY ] . ' ' . number_format( (int) $phase1GPS ); ?></td>
									</tr>
								<?php } ?>
								...
								if ( isset( $_POST["phase1DeliveryCharges"] ) ) {
									...
									<tr>
										<td>Delivery</td>
										<td></td>
										<td class="table-content-right"><?php echo $_SESSION[ CURRENT_CURRENCY ] . ' ' . number_format( (int) $phase1DeliveryCharges ); ?></td>
									</tr>
								<?php } ?>
								...
								if ( isset( $_POST["phase1CollectionCharges"] ) ) {
									...
									<tr>
										<td>Collection</td>
										<td></td>
										<td class="table-content-right"><?php echo $_SESSION[ CURRENT_CURRENCY ] . ' ' . number_format( (int) $phase1CollectionCharges ); ?></td>
									</tr>
								<?php } ?>
								...
								if ( isset( $_POST["scdw"] ) ) {
									...
									<tr>
										<td>SCDW</td>
										<td></td>
										<td><?php echo $_SESSION[ CURRENT_CURRENCY ] . ' ' . number_format( (int) $scdw ); ?></td>
									</tr>
								<?php } ?>
								...
								if ( isset( $_POST["cdw"] ) ) {
									...
									<tr>
										<td>CDW</td>
										<td></td>
										<td><?php echo $_SESSION[ CURRENT_CURRENCY ] . ' ' . number_format( (int) $cdw ); ?></td>
									</tr>
								<?php } ?>
								<?php
								if ( isset( $_POST["pai"] ) ) {
									...
									<tr>
										<td>PAI</td>
										<td></td>
										<td><?php echo $_SESSION[ CURRENT_CURRENCY ] . ' ' . number_format( (int) $pai ); ?></td>
									</tr>
								<?php } ?>
								<?php
								if ( isset( $_POST["gps"] ) ) {
									...
									<tr>
										<td>GPS</td>
										<td></td>
										<td><?php echo $_SESSION[ CURRENT_CURRENCY ] . ' ' . number_format( (int) $gps ); ?></td>
									</tr>
								<?php } ?>
								<?php
								if ( isset( $_POST["additionalDriver"] ) ) {
									...
									<tr>
										...
										<td></td>
										<td><?php echo $_SESSION[ CURRENT_CURRENCY ] . ' ' . number_format( (int) $additionalDriver ); ?></td>
									</tr>
								<?php } ?>
								<?php
								if ( isset( $_POST["babySafetySeat"] ) ) {
									...
									<tr>
										...
										<td></td>
										<td><?php echo $_SESSION[ CURRENT_CURRENCY ] . ' ' . number_format( (int) $babySafetySeat ); ?></td>
									</tr>
								<?php } ?>
								<?php
								if ( isset( $_POST["addBabySafetySeat"] ) ) {
									...
									<tr>
										...
										<td></td>
										<td><?php echo $_SESSION[ CURRENT_CURRENCY ] . ' ' . number_format( (int) $addBabySafetySeat ); ?></td>
									</tr>
								<?php } ?>
								<tr class="checkout-table-2">
									<td><strong>Total (Without Vat)</strong></td>
									<td></td>
									<td class="table-content-right"><strong><?php echo $_SESSION[ CURRENT_CURRENCY ] . " " . number_format( (int) $totalcalculatelease ); ?></strong></td>
								</tr>
								<tr class="checkout-table-2">
									<td><strong>VAT @5%</strong></td>
									<!--									<td>5%</td>-->
									<td></td>
									<td class="table-content-right"><strong><?php echo $_SESSION[ CURRENT_CURRENCY ] . " " . number_format( (int) $vatcal ); ?></strong></td>
								</tr>
								<tr class="checkout-table-2">
									...
									<?php
									?>
									<td class="table-content-right"><strong><?php echo $_SESSION[ CURRENT_CURRENCY ] . " " . number_format( (int) $vttre ); ?></strong></td>
								</tr>
							</table>
							<!--                            --><?php
							//                            echo "<pre>";
					...
					if ( isset( $_SESSION[ LOGGED_IN ] ) && $_SESSION[ LOGGED_IN ] == true ) {
						...
						<form action="#"
						      method="post"
						      name="booking_confirmation_form"
						      id="booking_confirmation_form">
							<input type="hidden"
							       value=""> <input type="hidden"
							                        name="carTitle"
							                        value="<?php echo filter_var( $_POST['carTitle'], FILTER_SANITIZE_STRING ); ?>"/> <input name="bookingTerm"
							                                                                                                                 type="hidden"
							                                                                                                                 value="<?php echo filter_var( $_POST['bookingTerm'], FILTER_SANITIZE_STRING ); ?>"/> <input type="hidden"
							                                                                                                                                                                                                             name="fullRentalPrice"
							                                                                                                                                                                                                             value="<?php echo filter_var( $_POST['fullRentalPrice'], FILTER_SANITIZE_STRING ); ?>"/> <input type="hidden"
							                                                                                                                                                                                                                                                                                                             name="totalcalculate1"
							                                                                                                                                                                                                                                                                                                             value="<?php echo filter_var( $_POST['totalcalculate1'], FILTER_SANITIZE_STRING ); ?>"/> <input type="hidden"
							                                                                                                                                                                                                                                                                                                                                                                                                             name="pickupLocation2"
							                                                                                                                                                                                                                                                                                                                                                                                                             value="<?php echo filter_var( $_POST['pickupLocation2'], FILTER_SANITIZE_STRING ); ?>"/>
							<input type="hidden"
							       name="dropLocation2"
							       value="<?php echo filter_var( $_POST['dropLocation2'], FILTER_SANITIZE_STRING ); ?>"/> <input type="hidden"
							                                                                                                     name="pickupDate2"
							                                                                                                     value="<?php echo filter_var( $_POST['pickupDate2'], FILTER_SANITIZE_STRING ); ?>"/> <input type="hidden"
							                                                                                                                                                                                                 name="dropDate2"
							                                                                                                                                                                                                 value="<?php echo filter_var( $_POST['dropDate2'], FILTER_SANITIZE_STRING ); ?>"/> <input type="hidden"
							                                                                                                                                                                                                                                                                                           name="slug2"
							                                                                                                                                                                                                                                                                                           value="<?php echo filter_var( $_POST['slug2'], FILTER_SANITIZE_STRING ); ?>"/> <input type="hidden"
							                                                                                                                                                                                                                                                                                                                                                                                 name="totalDays2"
							                                                                                                                                                                                                                                                                                                                                                                                 value="<?php echo filter_var( $_POST['totalDays2'], FILTER_SANITIZE_STRING ); ?>"/>
							<input type="hidden"
							       name="phase1OrangeCard"
							       value="<?php echo filter_var( $_POST['phase1OrangeCard'], FILTER_SANITIZE_STRING ); ?>"/> <input type="hidden"
							                                                                                                        name="phase1GPS"
							                                                                                                        value="<?php echo filter_var( $_POST['phase1GPS'], FILTER_SANITIZE_STRING ); ?>"/> <input type="hidden"
							                                                                                                                                                                                                  name="phase1DeliveryCharges"
							                                                                                                                                                                                                  value="<?php echo filter_var( $_POST['phase1DeliveryCharges'], FILTER_SANITIZE_STRING ); ?>"/> <input type="hidden"
							                                                                                                                                                                                                                                                                                                        name="phase1CollectionCharges"
							                                                                                                                                                                                                                                                                                                        value="<?php echo filter_var( $_POST['phase1CollectionCharges'], FILTER_SANITIZE_STRING ); ?>"/> <input type="hidden"
							                                                                                                                                                                                                                                                                                                                                                                                                                name="grandTotal"
							                                                                                                                                                                                                                                                                                                                                                                                                                value="<?php echo $vttre; ?>"/> <input type="hidden"
							                                                                                                                                                                                                                                                                                                                                                                                                                                                       name="vatAmount"
							                                                                                                                                                                                                                                                                                                                                                                                                                                                       value="<?php echo $vatcal; ?>"/>
							<!--Payment stuffs Starts-->
							<div>
								<input type="radio"
								       name="paymentMethod"
								       id="onlinePaymentMethodRadio"
								       checked
								       value="online"> <label for="onlinePaymentMethodRadio">Pay Online</label>
						...
						<form method="post"
							...
							<input type="text"
							       name="merchant_id"
							       value="<?php echo PG_MERCHANTDATA ?>"/>
							<input type="text"
                                  name="order_id"
                                  id="order_id"
                                  value=""/>
							...
							<input type="text"
							       name="amount"
							       value="<?php echo $vttre; ?>"/>
							<input type="text"
                                  name="currency"
                                  value="AED"/>
							<input type="text"
                                   name="redirect_url"
                                   value="<?php echo $FULL_HOST_NAME ?>booking-confirmation/"/>
							<input type="text"
                                name="cancel_url"
                                   value="<?php echo $FULL_HOST_NAME ?>booking-confirmation/"/>
							<input type="text"
...
<?php
						...
						?>
						<!--                        --><?php //echo number_format( $vttre, 2 );
						?>
						<!--                        --><?php //echo number_format( $vttre);
						?>
						<div class="theme-account-notifications">
							<div class="row">
								...
								<div class="col-md-3 ">
									<input type="radio"
									       ...
									       id="yes"
									       checked/> <label class="theme-search-results-item-title theme-search-results-item-title-sm disclaimer-txt loc-icons"
									                        for="yes"> Yes</label>
								</div>
								<div class="col-md-3 ">
									<input type="radio"
									       name="flight-option-1"
									       id="no"/> <label class="theme-search-results-item-title theme-search-results-item-title-sm disclaimer-txt loc-icons"
									                        for="no"> No</label>
								</div>
							</div>
							<hr>
							<form id="checkoutLoginForm"
							      name="checkoutLoginForm"
							      method="post"
							      enctype="multipart/form-data">
								<div class="theme-payment-page-sections-item"
								     id="autorent-customer">
									<div class="theme-payment-page-form">
										<div class="row row-col-gap"
										     data-gutter="20">
											<div class="col-md-6 ">
												<div class="theme-payment-page-form-item form-group">
													<label>E-Mail ID*</label> <input class="form-control"
													                                 id="email"
													                                 name="email"
													                                 type="text"
									...
									<br/>
									<img id="ajaxLoader"
									     src="uploads/pages/ajax-loader.gif"
							...
							<div id="register-error-message-div"
							     class="result sc_infobox sc_infobox_style_error"
							     style="display: none"></div>
						</div>                        <!--              <hr>-->                    <!--            <button id="confirm" class="btn btn-primary-invert btn-shadow text-upcase theme-footer-subscribe-btn" type="submit" disabled>Confirm Booking</button>-->
						<?php
					}
					?>
				</div>
...
<script>
    ...
    $("form#booking_confirmation_form").submit(function (e) {
        ...
        $.ajax({
            type: "POST", url: "ajax_book_rental.php", data: formData, cache: false, contentType: false, processData: false, success: function (data) {
                ...
                if (statusmessage.toString().trim() === "SUCCESS") {
                    ...
                    if (paymentMethod == 'offline') {
                        window.location.href = "/booking-confirmation/" + message;
                    } else {
                        $("#order_id").val(message);
                        // $("#paymentDataForm").show();
    ...
    $("form#checkoutLoginForm").submit(function (e) {
        ...
        $.ajax({
            type: "POST", url: "ajax_checkout_login.php", data: formData, cache: false, contentType: false, processData: false,
