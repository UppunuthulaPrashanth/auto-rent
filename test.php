                        ...
                        <div class="theme-hero-text theme-hero-text-white">
                            ...
                            <div class="breadcrumb-margins">
                                ...
                                if(!empty($locSlug)){
                                    ...
                                    <h2 class="theme-hero-text-title _mb-20 theme-hero-text-title-sm">Car Rental in <?php echo $locSlug; ?> </h2>
                ...
                <div class="sticky-col">
                    ...
                    <div class="row clickme-div collapsible">
                        <div class="col-md-6 col-sm-12" style="float: right">
                                ...
                                <a class="btn btn-primary-invert btn-shadow text-upcase book-btn-right clickme-btn">
                                    Click Me
                                </a>
