...
//    echo "SUCCESS|" ."Verified";
    if ($_SERVER['REQUEST_METHOD'] == 'POST')
    {
        ...
        $result = $db->query("INSERT INTO inb_contactus (fullname, subject, email, phone, address, message)
                                VALUES(?s,?s,?s,?s,?s,?s)", $name, $subject, $email, $phone, $address, $message);
        ...
        $message = file_get_contents('emailTemplates/contact-us.html', true);
...
//        if ($debug) echo "Client Sub: " . $sql;
        ...
        $recipientFormData = "Name: " . $name . "<br/>" .
            ...
            "Phone: " . $phone . "<br/>" .
            "Address: " . $address . "<br/>" .
            "Message: " . $message ."<br/><br/><br/><br/><br/><br/>" .
