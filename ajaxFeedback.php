...
//    echo "SUCCESS|" ."Verified";
    if ($_SERVER['REQUEST_METHOD'] == 'POST')
    {
        ...
        $result = $db->query("INSERT INTO inb_feedbacks (firstName, lastName, emailAddress, phoneNumber,feedback)
                                VALUES(?s,?s,?s,?s,?s)", $name, $lastname, $email, $phone, $feedback);
        ...
        $notificationType = 7; // this is for Feedback Form
        ...
        $message = file_get_contents('emailTemplates/feedback.html', true);
...
//        if ($debug) echo "Client Sub: " . $sql;
        ...
        $recipientFormData = "First Name: " . $name . "<br/>" .
            "Last Name: " . $lastname . "<br/>" .
            "Email: " . $email . "<br/>" .
            "Phone: " . $phone . "<br/>" .
            "Feedback: " . $feedback ."<br/><br/><br/><br/><br/><br/>" .
