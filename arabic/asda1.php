...
$selected_url=$options->get_sitemap_url("asda1"); 
 ...
 <section class="services-sec service-bgg" >
            ...
            <div class="container" style="position: relative; z-index: 10;">
                ...
                <div class="service-bg">
                        <h1 class=" key-heading wow fadeInDown  service-box" data-wow-duration="2s">الخدمات الرئيسية</h1>
                        ...
                        <div class="service-boxes">
                           ...
                           <?php 
                                ...
                                {?>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12 wow fadeInDown service-box" data-wow-duration="2s">
                                        <div class="circle car-rental">
                                            <img src="../images/car-rental-icon.png"  alt="">
                                        </div>
                                        <h2>أعرف أكثر</h2>
 ...
 new WOW().init();
      ...
      $(".bxslider11").bxSlider({
        ...
        $("#lease_form").click(function()
        {
          ...
          else
          {
              ...
              success: function(response)
              {
                ...
                {
                    $("#lease_error").html("بريد إلكتروني خاطئ");
                }
               else if (response=="4") 
                {
                    $("#lease_error").html("الوحيدة أرقام يسمح للهاتف.");
                }
                else if (response=="5") 
                {
                ...
                $("#buy_car_form").click(function()
        {
          ...
          if(name =="" || subject == "" || email == "" || cell == "" || msg == "")
          {
            $("#buy_car_error").html("الرجاء إدخال جميع الحقول المطلوبة.");
          }
          else
          {
              $.ajax({
              ...
              success: function(response)
              {
                ...
                if (response=="1") 
                {
                    $("#buy_car_error").html("فقط رسائل يسمح للاسم.");
                }
                else if (response=="2") 
                {
                    $("#buy_car_error").html("رسائل وأرقام فقط مسموح للموضوع.");
                }
                else if (response=="3") 
                {
                    $("#buy_car_error").html("بريد إلكتروني خاطئ");
                }
               else if (response=="4") 
                {
                    $("#buy_car_error").html("الوحيدة أرقام يسمح للهاتف.");
                }
                else if (response=="5") 
                {
        ...
        if(pd=="")
          ...
          {
            alert("حدد تاريخ قطرة");
            return false;
          }
          else if(country=="")
          {
            alert("حدد التقاط الموقع");
            return false;
          }
          else
          {
