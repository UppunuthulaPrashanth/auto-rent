...
<body>
    ...
    <?php echo  $forgetpass_model; ?>
        ...
        <div class="search-cover">
            <div class="container">
                <div class="row">
                <div class="col-md-11 text"><h1 class="tagline pull-right"><span>خريطة الموقع</span></h1> </div>
...
<?php 
$options = options::getInstance();
$urls = $options->filtered_sitemap_urls(5,2);
foreach($urls as $url)
{?>
...
<?php 
$options = options::getInstance();
$urls = $options->filtered_sitemap_urls(6,2);
foreach($urls as $url)
{?>
...
<?php 
$options = options::getInstance();
$urls = $options->filtered_sitemap_urls(7,2);
foreach($urls as $url)
{?>
