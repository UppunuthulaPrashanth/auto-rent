...
if(!empty($country))
{
               ...
               $response.='<fieldset class="country">
                  <legend><div class="col-md-5 legend-bx nopad-lr"><h1>'.$country["ar_name"].'</h1></div> <div class="clearfix"></div></legend>';
                  
                     foreach ($cities as $city) {
                  $response.='<div class="content">
                     <div class="city">
                        <h3 class="city-name">'.$city['ar_city'] .'</h3>
                              ...
                              <div class="col-md-12">
                                 <div class="col-md-6 nopad-l">
                                    <ul class="list-unstyled complete-add" style="display:inline-block;">
                                       <li>
                                          <p class="office-name">'.$loc['ar_name'] .'</p>
                                       </li>
                                       <li>
                                          <p class="address">'.$loc['ar_address'].'</p>
                                       </li>
                                       <li>
