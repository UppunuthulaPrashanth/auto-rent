...
<body>
    ...
    <?php echo  $forgetpass_model; ?>
        ...
        <div class="search-cover">
            <div class="container">
                <div class="row">
                    <div class="col-md-11 text"><h1 class="tagline pull-right" style="font-size: 30px;"><span>إشعار قانوني</span></h1> </div>
    ...
    <td style="width: 120px;"><?php echo $new["create_date"]; ?></td>
        <td style="text-align: right;direction: rtl;"> 
            <div class="col-md-12 nopad-lr">
                ...
                <a href="<?php echo $path; ?>"><?php echo $new["ar_title"]; ?></a>
                <?php
                if (strlen($new['ar_content']) > 250) {

                                // truncate string
                                $stringCut = substr($new['ar_content'], 0, 250);
                            ...
                            {
                                $string=$new['ar_content'];
                            }
                ?>
                            
                <p><?php echo $string; ?></p>
                <a href="<?php echo $path; ?>" style="font-size: 14px;color: #C01732;" >اقرأ المزيد</a>
            </div>
        </td>
