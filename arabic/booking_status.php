      ...
      <div class="search-cover">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-11 text"><h1 class="tagline pull-right"><span>مركز الحجز</span></h1> </div>
    ...
    <section class="" id="thanks" style="padding-top: 40px;">
        ...
        <div class="container">
            <div class="col-md-12" style="text-align:center">
                <h1 class="heading" style="direction:rtl">
                    <?php 
                        if(isset($_GET['status']) && $_GET['status']=="Aborted")
                        {
                            ?>
                               تم رفض معاملتك من قبل التاجر لسبب ما.
                            <?php
                        }
                        ...
                        elseif(isset($_GET['status']) && $_GET['status']=="Security_Error")
                        {
                            ?>
                                خطآ امني. الكشف عن الوصول غير المشروع
                            <?php
                        }
                    ?>                
                </h1>
                <p class="description" style="direction:rtl">محجوز الحجز والحجز غير معرف<span class="booking-id"><?php echo "AR" . $booking['id']; ?> </br>يرجى الاتصال بالدعم ايجار السيارات لتأكيد هذا الحجز.</span></p>
            </div>
            <div class="clearfix"></div>
        </div>
    </section>
