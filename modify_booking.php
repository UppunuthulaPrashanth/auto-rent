            ...
            <div class="col-md-9 ">
              <div class="_mob-h">
                <div class="theme-hero-text theme-hero-text-white">
                  <div class="">
                    <h2 class="theme-hero-text-title _mb-20 theme-hero-text-title-sm">Modify Booking</h2>
                  </div>
                </div>
          ...
          <div class="col-md-12 ">
            <div class="theme-payment-page-sections">
              ...
              <div class="theme-search-results-item theme-search-results-item-">
                ...
                <h5 class="theme-search-results-item-title theme-search-results-item-title-lg">Pickup Information</h5>
                <div class="theme-payment-page-form">
                  <div class="row row-col-gap" data-gutter="20">
                    ...
                    <div class="col-md-6 ">
                      <div class="theme-search-area-section theme-search-area-section-curved theme-search-area-section-fade-white theme-search-area-section">
                            <div class="theme-search-area-section-inner">
                              <i class="theme-search-area-section-icon lin lin-calendar"></i>
                              <input class="theme-search-area-section-input datePickerEnd _mob-h" type="text" placeholder="Drop Off Date"/>
                              <input class="theme-search-area-section-input _desk-h mobile-picker"  type="date"/>
                            </div>
                          </div>
                    </div>
...
-->
                    ...
                    <div class="theme-payment-page-sections-item">
                <h5 class="theme-search-results-item-title theme-search-results-item-title-lg">Dropoff Information</h5>
                      <div class="checkbox theme-search-results-sidebar-section-checkbox-list-item">
                          <label class="icheck-label">
                            <input class="icheck" type="checkbox"/>
                            <span class="icheck-title">Return Car to different location</span>
...
-->
                   ...
                   <div class="theme-payment-page-sections-item">
                <h5 class="theme-search-results-item-title theme-search-results-item-title-lg">Car Type</h5>
                      <br>
                <div class="theme-payment-page-form">
                  <div class="row row-col-gap" data-gutter="20">
                    <div class="col-md-6 ">
                    ...
                    <div class="col-md-6 ">
                      <button class="theme-search-area-submit _mt-0 _fw-n _ls-0 _tt-uc theme-search-area-submit-primary theme-search-area-submit-no-border theme-search-area-submit-curved">Modify</button>
                    </div>
