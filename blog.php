        ...
        <div class="search-cover">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-1 icon"><img class="pull-right" src="images/choose-icon.png" alt="icon"></div>
                     <div class="col-md-11 text"><h1 class="tagline pull-left"><span>Blog</span></h1> </div>
 ...
 <section class="blog-sec">
     <div class="container">
         ...
         ?>
          ...
          <div class="col-md-12 blog-post1 clearfix" style="background:#F9F9F9;padding: 15px;margin-bottom:15px">
