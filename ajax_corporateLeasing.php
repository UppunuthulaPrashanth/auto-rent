...
//    echo "SUCCESS|" ."Verified";
    if ($_SERVER['REQUEST_METHOD'] == 'POST')
    {
        ...
        $vehicleInterested      = filter_var($_POST['vehicleInterested'],FILTER_SANITIZE_STRING);
        $noOfVehicles           = filter_var($_POST['noOfVehicles'],FILTER_SANITIZE_STRING);
        $specialRequirement     = filter_var($_POST['specialRequirement'],FILTER_SANITIZE_STRING);


        $bodyTypeResult = $db->query("SELECT COUNT(*) as bodyTypeCount FROM mtr_bodytype  ");
        $bodyTypeRow = mysqli_fetch_assoc($bodyTypeResult);

        $bodyTypeArray = array();

        for($i=0;$i<=$bodyTypeRow['bodyTypeCount'];$i++)
        {
            $bodyTypeValue = "bodyType".$i;
            if($_POST[$bodyTypeValue] != null)
            {
                array_push($bodyTypeArray,$_POST[$bodyTypeValue]);
            }
        }
        $vehicleCategory =  implode(",",$bodyTypeArray);

//  echo $bodyTypeArray[0];
//  echo $bodyTypeArray[1];
//  echo $bodyTypeArray[2];
//  echo $bodyTypeRow['bodyTypeCount'];
// echo $vehicleCategory;
//        exit();

        $result = $db->query("INSERT INTO inb_corporate_leasing (fullName, companyName, email, phone, vehicleInterestedIn, noOfVehicles,  vehicleCategory, specificRequirement)
                                VALUES(?s,?s,?s,?s,?s,?s,?s,?s)", $name, $companyName, $email, $phone, $vehicleInterested, $noOfVehicles, $vehicleCategory, $specialRequirement);
        ...
        $notificationType = 8; // this is for Feedback Form
        ...
        $message = file_get_contents('emailTemplates/corporate-leasing.html', true);
...
//        if ($debug) echo "Client Sub: " . $sql;
        ...
        $formData = "Full Name: " . $name . "<br/>" .
            "Company Name: " . $companyName . "<br/>" .
            "Email: " . $email . "<br/>" .
            "Phone: " . $phone . "<br/>" .
            "Vehicle Interested In: " . $vehicleInterested . "<br/>" .
            "No of Vehicles: " . $noOfVehicles . "<br/>" .
            "Special Requirement: " . $specialRequirement  ;


        $recipientFormData = "Full Name: " . $name . "<br/>" .
            "Company Name: " . $companyName . "<br/>" .
            "Email: " . $email . "<br/>" .
            "Phone: " . $phone . "<br/>" .
            "Vehicle Interested In: " . $vehicleInterested . "<br/>" .
